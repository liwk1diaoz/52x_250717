#!/bin/bash
# global settings
KEEP_SENSOR_LIST=(sen_imx415)
KEEP_LCD_LIST=(disp_ifdsi_lcd1_st7701 disp_if8b_lcd1_st7789)
...
#	cp ${APP_DIR}/source/cardv/output/appfs/sensor/${n}.cfg ${SENSOR_CFG_DIR}
    cp ${APP_DIR}/source/cardv/output/appfs/sensor/sen_imx415_SJ10.cfg ${SENSOR_CFG_DIR}
