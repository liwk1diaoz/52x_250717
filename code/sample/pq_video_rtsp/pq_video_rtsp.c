...
static HD_RESULT set_cap_cfg(HD_PATH_ID *p_video_cap_ctrl)
{
	...
	} else if (sensor_sel_1 == SEN_SEL_GC4663) {
		snprintf(cap_cfg.sen_cfg.sen_dev.driver_name, HD_VIDEOCAP_SEN_NAME_LEN-1, "nvt_sen_gc4663");
...
static HD_RESULT set_cap_cfg2(HD_PATH_ID *p_video_cap_ctrl)
{
	...
	if (sensor_sel_2 == SEN_SEL_IMX290) {
		...
		snprintf(cap_cfg.sen_cfg.sen_dev.driver_name, HD_VIDEOCAP_SEN_NAME_LEN-1, "nvt_sen_imx415");
	}else if (sensor_sel_2 == SEN_SEL_GC4663) {
		snprintf(cap_cfg.sen_cfg.sen_dev.driver_name, HD_VIDEOCAP_SEN_NAME_LEN-1, "nvt_sen_gc4663");
	} else {
		snprintf(cap_cfg.sen_cfg.sen_dev.driver_name, HD_VIDEOCAP_SEN_NAME_LEN-1, "NULL");
	}
...
MAIN(argc, argv)
{
	...
	if (argc == 1 || argc > 7) {
		...
		printf("\033[1;32;40m                    12(f35),   13(imx415), 14(gc4663), 99(patgen)                          \033[0m\r\n");
	...
	if (vendor_isp_init() != HD_ERR_NG) {
		if (sensor_sel_1 != SEN_SEL_NONE) {
			...
			} else if ((sensor_sel_1 == SEN_SEL_GC4663) && (sensor_shdr_1 == 0) && (is_nt98528 == 0)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_52x.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_1 == SEN_SEL_GC4663) && (sensor_shdr_1 == 1) && (is_nt98528 == 0)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_hdr_52x.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_1 == SEN_SEL_GC4663) && (sensor_shdr_1 == 0) && (is_nt98528 == 1)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_528.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_1 == SEN_SEL_GC4663) && (sensor_shdr_1 == 1) && (is_nt98528 == 1)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_hdr_528.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_1 == SEN_SEL_IMX415) && (sensor_shdr_1 == 0) && (is_nt98528 == 0)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_imx415_0.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_1 == SEN_SEL_IMX415) && (sensor_shdr_1 == 0) && (is_nt98528 == 1)) {
		...
		if (sensor_sel_2 != SEN_SEL_NONE) {
			...
			if ((sensor_sel_2 == SEN_SEL_IMX290) && (sensor_shdr_1 == 0)) {
				...
				strncpy(cfg_info.path, "/mnt/app/isp/isp_sc4210_0_hdr_528.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_2 == SEN_SEL_GC4663) && (sensor_shdr_1 == 0) && (is_nt98528 == 0)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_52x.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_2 == SEN_SEL_GC4663) && (sensor_shdr_1 == 1) && (is_nt98528 == 0)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_hdr_52x.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_2 == SEN_SEL_GC4663) && (sensor_shdr_1 == 0) && (is_nt98528 == 1)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_528.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_2 == SEN_SEL_GC4663) && (sensor_shdr_1 == 1) && (is_nt98528 == 1)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_gc4663_0_hdr_528.cfg", CFG_NAME_LENGTH);	
			} else if ((sensor_sel_2 == SEN_SEL_IMX415) && (sensor_shdr_2 == 0) && (is_nt98528 == 0)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_imx415_0.cfg", CFG_NAME_LENGTH);
			} else if ((sensor_sel_2 == SEN_SEL_IMX415) && (sensor_shdr_2 == 0) && (is_nt98528 == 1)) {
				strncpy(cfg_info.path, "/mnt/app/isp/isp_imx415_0_528.cfg", CFG_NAME_LENGTH);
	...
	} else if ((sensor_sel_1 == SEN_SEL_SC4210)||(sensor_sel_1 == SEN_SEL_GC4663)) {
	...
	} else if ((sensor_sel_2 == SEN_SEL_SC4210)||(sensor_sel_2 == SEN_SEL_GC4663)){
