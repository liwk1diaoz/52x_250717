...
typedef enum {
	UIFlowPlay_Flash_ICON_FLASH_AUTO,
	UIFlowPlay_Flash_ICON_FLASH_ON,
	UIFlowPlay_Flash_ICON_FLASH_RED_EYE,
	UIFlowPlay_Flash_ICON_FLASH_OFF,
	UIFlowPlay_Flash_MAX
} UIFlowPlay_Flash_Setting;


typedef enum {
	UIFlowPlay_EV_ICON_EV_M2P0,
	UIFlowPlay_EV_ICON_EV_M1P6,
	UIFlowPlay_EV_ICON_EV_M1P3,
	UIFlowPlay_EV_ICON_EV_M1P0,
	UIFlowPlay_EV_ICON_EV_M0P6,
	UIFlowPlay_EV_ICON_EV_M0P3,
	UIFlowPlay_EV_ICON_EV_P0P0,
	UIFlowPlay_EV_ICON_EV_P0P3,
	UIFlowPlay_EV_ICON_EV_P0P6,
	UIFlowPlay_EV_ICON_EV_P1P0,
	UIFlowPlay_EV_ICON_EV_P1P3,
	UIFlowPlay_EV_ICON_EV_P1P6,
	UIFlowPlay_EV_ICON_EV_P2P0,
	UIFlowPlay_EV_MAX
} UIFlowPlay_EV_Setting;


typedef enum {
	UIFlowPlay_WB_ICON_WB_AUTO,
	UIFlowPlay_WB_ICON_WB_DAYLIGHT,
	UIFlowPlay_WB_ICON_WB_CLOUDY,
	UIFlowPlay_WB_ICON_WB_TUNGSTEN,
	UIFlowPlay_WB_ICON_WB_FLUORESCENT,
	UIFlowPlay_WB_MAX
} UIFlowPlay_WB_Setting;
