...
SHOW_ITEM_GROUP(CMD_Group,Normal2,537,595,676,684)
...
SHOW_ITEM_GROUP(CMD_Group,Focused6,537,595,676,684)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable10,537,595,676,684)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable14,537,595,676,684)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon21, 27, 13, 112,78, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Pressed18)
SHOW_MAP_BODY(Skin19)
SHOW_MAP_BODY(Icon21)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Pressed18,537,595,676,684)
...
CREATE_LIST_CTRL(MenuCommonConfirm_List,MenuCommonConfirm_List,0,537,595,676,684)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text27,0,0,315,49,STRID_NULL,0,0,0,0,1,1,1,256,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal24)
SHOW_MAP_BODY(Skin25)
SHOW_MAP_BODY(Text27)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal24,582,30,897,79)
...
CREATE_STATIC_CTRL(MenuCommonConfirm_Title,0,582,30,897,79)
...
SHOW_ITEM_GROUP(CMD_Group,Normal30,553,735,678,764)
...
SHOW_ITEM_GROUP(CMD_Group,Normal35,677,736,800,765)
...
SHOW_ITEM_GROUP(CMD_Group,Normal40,522,736,549,763)
...
SHOW_ITEM_GROUP(CMD_Group,Normal44,805,736,832,763)
...
CREATE_CTRL(MenuCommConfirm_Panel,MenuCommConfirm_Panel,CTRL_WND,NULL,0 ,517,736,837,765)
SHOW_ITEM_IMAGE(CMD_Image,Image50, 1, 1, 109,88, ICON_BTN_EMBOSS,0,0,0,0,0,0,17,0)
SHOW_ITEM_RECT(CMD_Rectangle,Skin49Rect,0,0,109,89,0,0,159,159,0,0,0)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon51, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text53,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal48,605,95,714,184)

SHOW_ITEM_IMAGE(CMD_Image,Image56, 1, 1, 109,88, ICON_ACT_RELEASE_BTN,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Skin55)
SHOW_MAP_BODY(Image56)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin55,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon57, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text59,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Focused54,605,95,714,184)

SHOW_ITEM_IMAGE(CMD_Image,Image62, 1, 1, 109,89, ICON_BTN_EMBOSS,83886080,0,0,0,0,0,17,0)
...
SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon63, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text65,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable60,605,95,714,184)

SHOW_ITEM_IMAGE(CMD_Image,Image68, 1, 1, 110,88, ICON_BTN_EMBOSS,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Skin67)
SHOW_MAP_BODY(Image68)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin67,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon69, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text71,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
SHOW_MAP_BEGIN(Focused_Disable66)
SHOW_MAP_BODY(Skin67)
SHOW_MAP_BODY(Icon69)
SHOW_MAP_BODY(Text71)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Focused_Disable66,605,95,714,184)

SHOW_ITEM_IMAGE(CMD_Image,Image74, -1, 0, 108,89, ICON_ACT_PUSH_BTN,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_RECT(CMD_Rectangle,Skin73Rect,0,0,109,89,0,0,159,159,0,0,0)
SHOW_MAP_BEGIN(Skin73)
SHOW_MAP_BODY(Skin73Rect)
SHOW_MAP_BODY(Image74)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin73,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon75, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text77,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed72,605,95,714,184)

CREATE_BUTTON_ITEM_DATA(STRID_NULL_78,STRID_NULL_,ICON_YES_M,STATUS_ENABLE,NULL) 
SHOW_MAP_BEGIN(MenuCommonConfirm_BTN_Yes)
SHOW_MAP_BODY(Normal48)
SHOW_MAP_BODY(Focused54)
SHOW_MAP_BODY(Normal_Disable60)
SHOW_MAP_BODY(Focused_Disable66)
SHOW_MAP_BODY(Pressed72)
SHOW_MAP_END

DECLARE_EVENT(MenuCommonConfirm_BTN_Yes)
BUTTON_LIST_BEGIN(MenuCommonConfirm_BTN_Yes)
BUTTON_LIST_ITEM(STRID_NULL_78)
BUTTON_LIST_END

CREATE_BUTTON_DATA(MenuCommonConfirm_BTN_Yes,BTN_DRAW_IMAGE)

CREATE_BUTTON_CTRL(MenuCommonConfirm_BTN_Yes,MenuCommonConfirm_BTN_Yes,0,605,95,714,184)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_IMAGE(CMD_Image,Image81, 1, 1, 109,88, ICON_BTN_EMBOSS,0,0,0,0,0,0,17,0)
SHOW_ITEM_RECT(CMD_Rectangle,Skin80Rect,0,0,109,89,0,0,159,159,0,0,0)
SHOW_MAP_BEGIN(Skin80)
SHOW_MAP_BODY(Skin80Rect)
SHOW_MAP_BODY(Image81)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin80,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon82, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text84,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal79,760,95,869,184)

SHOW_ITEM_IMAGE(CMD_Image,Image87, 1, 1, 109,88, ICON_ACT_RELEASE_BTN,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Skin86)
SHOW_MAP_BODY(Image87)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin86,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon88, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text90,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Focused85,760,95,869,184)

SHOW_ITEM_IMAGE(CMD_Image,Image93, 1, 1, 109,89, ICON_BTN_EMBOSS,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Skin92)
SHOW_MAP_BODY(Image93)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin92,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon94, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text96,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable91,760,95,869,184)

SHOW_ITEM_IMAGE(CMD_Image,Image99, 1, 1, 110,88, ICON_BTN_EMBOSS,83886080,0,0,0,0,0,17,0)
SHOW_MAP_BEGIN(Skin98)
SHOW_MAP_BODY(Image99)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin98,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon100, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text102,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable97,760,95,869,184)

SHOW_ITEM_IMAGE(CMD_Image,Image105, -1, 0, 108,89, ICON_ACT_PUSH_BTN,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_RECT(CMD_Rectangle,Skin104Rect,0,0,109,89,0,0,159,159,0,0,0)
SHOW_MAP_BEGIN(Skin104)
SHOW_MAP_BODY(Skin104Rect)
SHOW_MAP_BODY(Image105)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin104,0,0,109,89)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon106, 0, 0, 109,89, ICONID_NULL,83886080,0,0,0,0,0,17,0)
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text108,0,99,109,128,STRID_NULL,0,0,0,0,1,1,1,256,0,1,0,0,0,0)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed103,760,95,869,184)

CREATE_BUTTON_ITEM_DATA(STRID_NULL_109,STRID_NULL_,ICON_YES_M,STATUS_ENABLE,NULL) 
...
BUTTON_LIST_ITEM(STRID_NULL_109)
BUTTON_LIST_END

CREATE_BUTTON_DATA(MenuCommonConfirm_BTN_No,BTN_DRAW_IMAGE)

CREATE_BUTTON_CTRL(MenuCommonConfirm_BTN_No,MenuCommonConfirm_BTN_No,0,760,95,869,184)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
CREATE_CTRL(MenuCommonConfirm,MenuCommonConfirm,CTRL_WND,NULL,0 ,0,0,1479,319)
#endif
