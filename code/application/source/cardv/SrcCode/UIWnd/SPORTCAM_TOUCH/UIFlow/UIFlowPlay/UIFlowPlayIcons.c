...
#else
	UxCtrl_SetShow(&UIFlowWndPlay_StatusICN_BatteryCtrl, bShow);
#endif	
}
...
void FlowPB_ShowAllThumbIcon(void)
{
	...
	for (i = 0; i < loopcnts; i++) {
		...
		switch (i) {
			//Playback fileIndex starts from 1.
			case 0:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel0Ctrl, TRUE);
				break;
			case 1:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel1Ctrl, TRUE);
				break;
			case 2:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel2Ctrl, TRUE);
				break;
			case 3:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel3Ctrl, TRUE);
				break;
			case 4:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel4Ctrl, TRUE);
				break;
			case 5:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel5Ctrl, TRUE);
				break;
			case 6:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel6Ctrl, TRUE);
				break;
			case 7:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel7Ctrl, TRUE);
				break;
			case 8:
				UxCtrl_SetShow(&UIFlowWndPlayThumb_Panel8Ctrl, TRUE);
				break;
		}
	}
}
