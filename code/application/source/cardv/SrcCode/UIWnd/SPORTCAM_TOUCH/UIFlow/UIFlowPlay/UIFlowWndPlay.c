...
#include "UIWnd/SPORTCAM_TOUCH/UIFlow/UIFlowPlay/UIFlowWndPlayRes.c"
...
CTRL_LIST_ITEM(UIFlowWndPlay_TOUCH)
CTRL_LIST_END
...
//---------------------UIFlowWndPlay_TOUCHCtrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlay_TOUCH)
CTRL_LIST_ITEM(UIFlowWndPlay_Touch_PNL_Control)
CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Return)
//CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Mode)
CTRL_LIST_END

//----------------------UIFlowWndPlay_TOUCHCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndPlay_TOUCH)
EVENT_END

//---------------------UIFlowWndPlay_Touch_PNL_ControlCtrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlay_Touch_PNL_Control)
//CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Delete)
CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Left)
CTRL_LIST_ITEM(UIFlowWndPlay_Touch_PlayPause)
CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Right)
CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Stop)
//CTRL_LIST_ITEM(UIFlowWndPlay_Touch_Lock)
CTRL_LIST_END

//----------------------UIFlowWndPlay_Touch_PNL_ControlCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndPlay_Touch_PNL_Control)
EVENT_END

//----------------------UIFlowWndPlay_Touch_DeleteCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Delete_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Delete)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Delete_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Delete_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
//----------------------UIFlowWndPlay_Touch_LeftCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Left_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Left)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Left_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Left_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch(g_PlbData.State){
		case PLB_ST_PLAY_MOV:
		...
		case PLB_ST_PAUSE_MOV:
			...
			UxButton_SetItemData(&UIFlowWndPlay_Touch_PlayPauseCtrl, 0, BTNITM_ICONID,ICON_PLAY_PLAY);
		case PLB_ST_FULL:
			UIPlay_PlaySingle(PB_SINGLE_PREV);
			FlowPB_UpdateIcons(1);
			UIFlowWndPlay_CheckStatus();
...
//----------------------UIFlowWndPlay_Touch_PlayPauseCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_PlayPause_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_PlayPause)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_PlayPause_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_PlayPause_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
#if 1//_TODO
	char   pFilePath[FULL_FILE_PATH_LEN] = {0};
	...
	switch (g_PlbData.State) {
		...
		case PLB_ST_PAUSE_MOV:
			...
			g_PlbData.State = PLB_ST_PLAY_MOV;
			//FlowPB_IconDrawRightBtn(TRUE);
			UxButton_SetItemData(&UIFlowWndPlay_Touch_PlayPauseCtrl, 0, BTNITM_ICONID,ICON_PLAY_PAUSE);
		#endif
			break;
		case PLB_ST_FULL:
#if 1//_TODO
...
//----------------------UIFlowWndPlay_Touch_RightCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Right_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Right)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Right_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Right_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch(g_PlbData.State){
		case PLB_ST_PLAY_MOV:
...
//----------------------UIFlowWndPlay_Touch_StopCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Stop_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Stop)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Stop_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Stop_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch(g_PlbData.State){
		case PLB_ST_PLAY_MOV:
...
//----------------------UIFlowWndPlay_Touch_LockCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Lock_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Lock)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Lock_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Lock_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
//----------------------UIFlowWndPlay_Touch_ReturnCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Return_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Return)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Return_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Return_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch (g_PlbData.State) {
		case PLB_ST_FULL:
...
//----------------------UIFlowWndPlay_Touch_ModeCtrl Event---------------------------
INT32 UIFlowWndPlay_Touch_Mode_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlay_Touch_Mode)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlay_Touch_Mode_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlay_Touch_Mode_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch(g_PlbData.State) {
		case PLB_ST_FULL:
