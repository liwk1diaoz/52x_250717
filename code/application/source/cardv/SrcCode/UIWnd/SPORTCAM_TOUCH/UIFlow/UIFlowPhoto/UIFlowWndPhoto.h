...
extern VControl UIFlowWndPhoto_BTN_CaptureCtrl;//Button type 

extern VControl UIFlowWndPhoto_BTN_DscModeCtrl;//Button type 

extern VControl UIFlowWndPhoto_BTN_SetupCtrl;//Button type 
