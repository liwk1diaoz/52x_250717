...
//CTRL_LIST_ITEM(UIFlowWndMovie_Reverse_Display)
CTRL_LIST_END
...
INT32 UIFlowWndMovie_OnExeRecord(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	...
	case NVTEVT_KEY_PRESS:
		...
		case MOV_ST_VIEW:
			...
			UxButton_SetItemData(&UIFlowWndMovie_BTN_RecCtrl, 0, BTNITM_ICONID,ICON_PLAY_PAUSE);
			break;
		...
		case MOV_ST_REC | MOV_ST_ZOOM:
			...
			UxButton_SetItemData(&UIFlowWndMovie_BTN_RecCtrl, 0, BTNITM_ICONID,ICON_PLAY_PLAY);
...
CTRL_LIST_ITEM(UIFlowWndMovie_BTN_SnapeShot)
CTRL_LIST_ITEM(UIFlowWndMovie_Touch_Audio)
CTRL_LIST_ITEM(UIFlowWndMovie_Touch_Rec)
CTRL_LIST_ITEM(UIFlowWndMovie_Touch_Emr)
CTRL_LIST_ITEM(UIFlowWndMovie_Static_Msg)
//CTRL_LIST_ITEM(UIFlowWndMovie_Status_Light)
CTRL_LIST_ITEM(UIFlowWndMovie_StatusIcon_WB)
CTRL_LIST_END
...
//----------------------UIFlowWndMovie_Status_G_SensorCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndMovie_Status_G_Sensor)
EVENT_END

//----------------------UIFlowWndMovie_Status_File_LockCtrl Event---------------------------
...
INT32 UIFlowWndMovie_BTN_Setup_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	switch (gMovData.State) {
		...
		case MOV_ST_VIEW|MOV_ST_ZOOM:
			...
			// Open common mix (Item + Option) menu
			Ux_OpenWindow((VControl *)(&MenuCommonItemCtrl), 1, &gMovieMenu);
			gMovData.State = MOV_ST_MENU;
			break;
	}
...
//----------------------UIFlowWndMovie_BTN_SnapeShotCtrl Event---------------------------
INT32 UIFlowWndMovie_BTN_SnapeShot_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndMovie_BTN_SnapeShot)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndMovie_BTN_SnapeShot_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndMovie_BTN_SnapeShot_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch (gMovData.State) {
	case MOV_ST_REC:
...
//----------------------UIFlowWndMovie_Touch_AudioCtrl Event---------------------------
INT32 UIFlowWndMovie_Touch_Audio_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndMovie_Touch_Audio)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndMovie_Touch_Audio_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndMovie_Touch_Audio_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
//----------------------UIFlowWndMovie_Touch_RecCtrl Event---------------------------
INT32 UIFlowWndMovie_Touch_Rec_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndMovie_Touch_Rec)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndMovie_Touch_Rec_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndMovie_Touch_Rec_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
//----------------------UIFlowWndMovie_Touch_EmrCtrl Event---------------------------
INT32 UIFlowWndMovie_Touch_Emr_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndMovie_Touch_Emr)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndMovie_Touch_Emr_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndMovie_Touch_Emr_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
//----------------------UIFlowWndMovie_Static_MsgCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndMovie_Static_Msg)
EVENT_END

//----------------------UIFlowWndMovie_Status_LightCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndMovie_Status_Light)
EVENT_END

//----------------------UIFlowWndMovie_StatusIcon_WBCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndMovie_StatusIcon_WB)
EVENT_END
...
//---------------------UIFlowWndMovie_Reverse_DisplayCtrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndMovie_Reverse_Display)
CTRL_LIST_ITEM(UIFlowWndMovie_Reverse)
CTRL_LIST_END

//----------------------UIFlowWndMovie_Reverse_DisplayCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndMovie_Reverse_Display)
EVENT_END

//----------------------UIFlowWndMovie_ReverseCtrl Event---------------------------
EVENT_BEGIN(UIFlowWndMovie_Reverse)
EVENT_END
