...
//----------------------UIFlowWndPhoto_BTN_CaptureCtrl Event---------------------------
INT32 UIFlowWndPhoto_BTN_Capture_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPhoto_BTN_Capture)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPhoto_BTN_Capture_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPhoto_BTN_Capture_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
//----------------------UIFlowWndPhoto_BTN_DscModeCtrl Event---------------------------
INT32 UIFlowWndPhoto_BTN_DscMode_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPhoto_BTN_DscMode)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPhoto_BTN_DscMode_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPhoto_BTN_DscMode_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	CHKPNT;
	switch (gPhotoData.State) {
		case PHOTO_ST_VIEW:
...
//----------------------UIFlowWndPhoto_BTN_SetupCtrl Event---------------------------
INT32 UIFlowWndPhoto_BTN_Setup_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPhoto_BTN_Setup)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPhoto_BTN_Setup_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPhoto_BTN_Setup_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
	switch (gPhotoData.State) {
		case PHOTO_ST_VIEW:
		case PHOTO_ST_VIEW|PHOTO_ST_ZOOM:
			// Open common mix (Item + Option) menu
			Ux_OpenWindow((VControl *)(&MenuCommonItemCtrl), 1, &gPhotoMenu);
