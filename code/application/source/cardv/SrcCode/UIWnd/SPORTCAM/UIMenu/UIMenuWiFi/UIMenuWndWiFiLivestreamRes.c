...
CREATE_STATIC_DATA(UIMenuWndWiFiLivestream_StaticICN_WiFi,ICONID_NULL)
...
CREATE_BUTTON_ITEM_DATA(STRID_EXIT32,STRID_EXIT,ICONID_NULL,STATUS_ENABLE,NULL)
SHOW_MAP_BEGIN(Button_LivestreamExit)
...
DECLARE_EVENT(Button_LivestreamExit)
BUTTON_LIST_BEGIN(Button_LivestreamExit)
BUTTON_LIST_ITEM(STRID_EXIT32)
BUTTON_LIST_END

CREATE_BUTTON_DATA(Button_LivestreamExit,BTN_DRAW_IMAGE)

CREATE_BUTTON_CTRL(Button_LivestreamExit,Button_LivestreamExit,0,0,0,38,23)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndWiFiLivestream_Tab_Exit)
SHOW_MAP_BODY(Skin11)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndWiFiLivestream_Tab_Exit)
CTRL_LIST_BEGIN(UIMenuWndWiFiLivestream_Tab_Exit)
CTRL_LIST_ITEM(Button_LivestreamExit)
CTRL_LIST_END

CREATE_TAB_DATA(UIMenuWndWiFiLivestream_Tab_Exit,0)

CREATE_TAB_CTRL(UIMenuWndWiFiLivestream_Tab_Exit,UIMenuWndWiFiLivestream_Tab_Exit,0,143,212,182,235)
