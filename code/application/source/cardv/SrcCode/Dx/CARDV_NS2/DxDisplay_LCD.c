...
#define LCD_ASPECT_W                    7
#define LCD_ASPECT_H                    30
#elif defined(_disp_ifdsi_lcd1_st7701s_t30p115_)
//#define LCD_MAX_W                       ALIGN_CEIL_16(480)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
//#define LCD_MAX_H                       ALIGN_CEIL_16(1920)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    3
#define LCD_ASPECT_H                    4
#elif defined(_disp_ifdsi_lcd1_wtl098802g01_ota7290b_)
//#define LCD_MAX_W                       ALIGN_CEIL_16(480)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
//#define LCD_MAX_H                       ALIGN_CEIL_16(1920)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    1
#define LCD_ASPECT_H                    4
#elif defined(_disp_ifdsi_lcd1_tb118_)
#define LCD_MAX_W                      ALIGN_CEIL_16(320)  // ALIGN_CEIL_16(480)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                      ALIGN_CEIL_16(1488) // ALIGN_CEIL_16(1920)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                   9//20
#define LCD_ASPECT_H                    32//93
#elif defined(_disp_ifdsi_lcd1_wtl096602g02_24m_)
//#define LCD_MAX_W                       ALIGN_CEIL_16(480)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
//#define LCD_MAX_H                       ALIGN_CEIL_16(1920)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    1
#define LCD_ASPECT_H                    4
#elif defined(_disp_if8b_lcd1_pw35p00_)
...
#elif defined(_disp_if8b_lcd1_psd300_ili8961_)
#define LCD_MAX_W                       ALIGN_CEIL_16(960)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(240)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
//static INT32    g_LCDBacklightPeriodrLvl = DRVLCD_BRT_PERIOD_INIT;
...
static void GPIOMap_TurnOnLCDPower(void)
{
    ...
    #endif
    #if defined(GPIO_LCD_STBYB)
    gpio_setDir(GPIO_LCD_STBYB, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_LCD_STBYB);
    #endif
   // User_LcdPwm_Init();
}
...
//#YouQing#2020/12/09 13:42:33#Cy#	-start
//#YouQing#
...
//#YouQing#2020/12/09 13:42:33#Cy#	-end
