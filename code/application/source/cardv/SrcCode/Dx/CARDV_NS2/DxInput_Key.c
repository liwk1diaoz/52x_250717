...
static UINT32 VolDet_GetKey1Level(void)
{
	...
	//printf("\033[34m [cxm:%s,%s:%d]:BEGIN \033[0m\r\n",__FILE__,__func__,__LINE__);
...
UINT32 DrvKey_DetNormalKey(void)
{
	...
	*/
	key_ConditionPresMode(FLGKEY_LEFT, uiKeyCode, powerKeyNvtevt);
...
{
	UINT32 uiKeyCode = 0;
//#YouQing#2020/12/05 11:53:25#Cy#	-start
//#YouQing#
#if 0//Short press
...
#endif
//#YouQing#2020/12/05 11:53:25#Cy#	-end
	return uiKeyCode;
}
