...
#endif
#endif /* 0 */
#define GPIO_LCD_RESET             L_GPIO_10
#define GPIO_LCD_POWER              L_GPIO_8
#define GPIO_LCD_STBYB              L_GPIO_13
#define GPIO_LCD_EN             L_GPIO_24
// LCD backlight
#define LCD_BACKLIGHT_DUMMY         0
#define LCD_BACKLIGHT_BY_GPIO       1
#define LCD_BACKLIGHT_BY_PWM        2
#define LCD_BACKLIGHT_BY_PWRIC      3
#define LCD_BACKLIGHT_CTRL         LCD_BACKLIGHT_BY_GPIO//LCD_BACKLIGHT_BY_PWM//LCD_BACKLIGHT_DUMMY //FPGA
#if (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_PWM)
#define GPIO_PWM_LCD_BLG_PCTL       L_GPIO_9
#define PWMID_LCD_BLG_PCTL          PWMID_9
#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
#define GPIO_LCD_BLG_PCTL          L_GPIO_9// L_GPIO_24
#endif
...
// CARD
// card power
#define GPIO_CARD_POWER             C_GPIO_22
...
#define GPIO_BLUE_LED              x_GPIO_x  //FPGA
//#define PAD_BLUE_LED               PAD_PIN_xGPIOx
...
#define GPIO_SENSOR1_POWER             L_GPIO_2
#define GPIO_SENSOR1_PWND              S_GPIO_4
#define GPIO_SENSOR1_RESET 			   S_GPIO_5
//#define GPIO_SENSOR2_POWER             D_GPIO_0
//#define GPIO_SENSOR_AHD_POWER             P_GPIO_6
//#define GPIO_SENSOR_AHD_POWER2             P_GPIO_2
...
#define GPIO_BAT_POWER 	L_GPIO_6//Cy


#define GPIO_MCU_STATUS 	L_GPIO_4//Cy

#define GPIO_GPS_EN 		P_GPIO_5//Cy


// ACC Det
#define GPIO_ACC_PLUG               D_GPIO_10
#define PAD_ACC_PLUG                PAD_PIN_DGPIO10

extern BOOL GPIOMap_IsAccPlugIn(void);


// Reserve Det
#define GPIO_RESERVE_DET               D_GPIO_0
#define PAD_RESERVE_DET                PAD_PIN_DGPIO0

extern BOOL GPIOMap_ReserveDet(void);
