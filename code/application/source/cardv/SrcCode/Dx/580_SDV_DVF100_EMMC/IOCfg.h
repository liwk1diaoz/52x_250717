...
// PWM common
//--------------------------------------------------------------------
#define GPIO_NULL		S_GPIO_12
#define PAD_NULL		PAD_PIN_SGPIO12
...
#define GPIO_LCD_RESET             P_GPIO_9// //FPGA not support
...
// SD card detect
#define GPIO_CARD_DETECT            GPIO_NULL
#define PAD_CARD_DETECT             PAD_NULL
...
#define GPIO_AMP_POWER				D_GPIO_10
//#define PAD_AMP_POWER				PAD_PIN_DGPIO9



#define GPIO_MIC_DETECT            GPIO_NULL
#define PAD_MIC_DETECT             PAD_NULL

#define GPIO_CHARGEFULL_DET      P_GPIO_16
#define PAD_GPIO_CHARGEFULL_DET      PAD_PIN_PGPIO16



#define GPIO_REC_LED               D_GPIO_8   //blue    low active  

#define GPIO_WIFI_LED                GPIO_NULL  //green    low active 
#define PAD_WIFI_LED                 PAD_NULL

#define GPIO_PHO_LED                GPIO_NULL  //red    low active
#define PAD_PHO_LED               PAD_NULL

#define GPIO_RF_EN               L_GPIO_13
#define PAD_RF_EN                 PAD_PIN_LGPIO13


#define GPIO_CHARGE_LOW               L_GPIO_12  // high : small current
#define PAD_CHARGE_LOW                 PAD_PIN_LGPIO12

#define GPIO_WIFI_EN              GPIO_NULL

#if 1//def __FUN_encryption_KEY__  //lim20150226
#define GPIO_encryption_5            GPIO_NULL  
#define GPIO_encryption_6            P_GPIO_10    //P0   JSDA  PWM15
#define GPIO_encryption_7            P_GPIO_11   //P1    JSCL  PWM16
#define HJT_GPS_CS 					GPIO_encryption_5


#define HJT_GPS_SCL 			GPIO_encryption_6
#define HJT_GPS_SDA 			 GPIO_encryption_7 //mode
...
#define GPIO_PWM_MOTOR                P_GPIO_5 //motor
#define PAD_PWM_MOTOR               PAD_PIN_PGPIO5


#define GPIO_BINK_LED                P_GPIO_6            //LED2  LOW LIANG 
#define PAD_BINK_LED                 PAD_PIN_PGPIO6
