...
#define GPIO_LCD_RESET              L_GPIO_13 //FPGA not support
...
#define GPIO_LCD_BLG_PCTL           L_GPIO_2
#define PAD_LCD_BLG_PCTL            PAD_PIN_LGPIO2
#endif
...
// CARD
// card power
#define GPIO_CARD_POWER             L_GPIO_20
#define PAD_CARD_POWER              PAD_PIN_LGPIO20
// SD card detect
#define GPIO_CARD_DETECT            P_GPIO_11
#define PAD_CARD_DETECT             PAD_PIN_PGPIO11
...
#define GPIO_TP_INT_DET              L_GPIO_18 //HW TS_PENIRQ =DGPIO-12
#define PAD_TP_INT_DET             PAD_PIN_LGPIO18
#define GPIO_TP_RESET              L_GPIO_21 //HW TS_PENIRQ =DGPIO-12
...
#define GPIO_RED_LED                (1 | GPIO_IS_DGPIO)  //FPGA
...
#define GPIO_ALEXA_BGM13P_RST          L_GPIO_24     
#define GPIO_ALEXA_BGM13P_PWR          L_GPIO_23    
#define GPIO_ALEXA_BGM13P_INT          GPIO_INT_28     

#define GPIO_WIFI_REG_ON          P_GPIO_19     
#define GPIO_WIFI_POWER          L_GPIO_19     

#define GPIO_BT_WAKE          (0 | GPIO_IS_DGPIO)     
#define GPIO_BT_RST          L_GPIO_17     

#define GPIO_TVI_12EN          L_GPIO_15  
#define GPIO_TVI_RESET          S_GPIO_5    
#define GPIO_TVI_POWER_ON1          L_GPIO_3    
#define GPIO_TVI_POWER_ON2          L_GPIO_5    

#define GPIO_TVI_DET1          L_GPIO_1     
#define PAD_TVI_DET1          PAD_PIN_LGPIO1  
#define GPIO_TVI_DET2          L_GPIO_14     
#define PAD_TVI_DET2          PAD_PIN_LGPIO14  
#define GPIO_TVI_IRQ          GPIO_INT_31    


#define GPIO_SPK_MUTE		L_GPIO_12

#define GPIO_SN1_12EN		L_GPIO_10
#define GPIO_SN1_18EN		L_GPIO_9
#define GPIO_SN1_29EN		L_GPIO_8
#define GPIO_SN1_RESET		S_GPIO_6

#define GPIO_GSENSOR_INT		GPIO_INT_27

extern void GPIOMap_TurnOnSysLed(void);
extern void GPIOMap_TurnOffSysLed(void);
extern BOOL GPIOMap_DetAHD1(void);
extern BOOL GPIOMap_DetAHD2(void);
extern BOOL GPIOMap_DetTpInt(void);
extern void GPIOMap_TurnOnTVI(void);
extern void GPIOMap_TurnOffTVI(void);
extern void GPIOMap_TurnOnBt(void);
extern void GPIOMap_TurnOffBt(void);
extern void GPIOMap_TurnOffWifi(void);
extern void GPIOMap_TurnOnSpkMute(void);
extern void GPIOMap_TurnOffSpkMute(void);
extern BOOL GPIOMap_GetLCDBacklighState(void);
#endif
