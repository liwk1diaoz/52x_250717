...
#define LCD_MAX_W                       ALIGN_CEIL_16(440)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(1920)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    11
#define LCD_ASPECT_H                    48
