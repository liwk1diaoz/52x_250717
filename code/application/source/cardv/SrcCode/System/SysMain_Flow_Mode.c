...
UINT32 g_IsSysModeChgClose = 0;
UINT32 g_IsSysModeChgOpen = 0;
UINT32 g_IsSysModeChging = 0;
...
#endif
UINT32 System_IsModeChging(void)
{
	return g_IsSysModeChging;
}
UINT32 System_IsModeChgClose(void)
{
	return g_IsSysModeChgClose;
}
UINT32 System_IsModeChgOpen(void)
{
	return g_IsSysModeChgOpen;
}
