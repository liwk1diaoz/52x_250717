...
#define VOS_FLAG_IOCMD_INFO             _VOS_IOWR(VOS_IOCTL_MAGIC, 6, VOS_FLAG_IOARG_INFO)
...
#define VOS_SEM_IOCMD_INFO              _VOS_IOW(VOS_IOCTL_MAGIC, 14, VOS_SEM_IOARG_INFO)
...
#define VOS_TASK_IOCMD_INFO             _VOS_IOW(VOS_IOCTL_MAGIC, 28, VOS_TASK_IOARG_INFO)
...
int _IOFUNC_FLAG_IOCMD_INFO(unsigned long arg);
...
int _IOFUNC_SEM_IOCMD_INFO(unsigned long arg);
...
int _IOFUNC_TASK_IOCMD_INFO(unsigned long arg);
