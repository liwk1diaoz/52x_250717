...
static long _dev_fops_ioctl(struct file *file,  unsigned int cmd, unsigned long arg)
{
	...
	case VOS_FLAG_IOCMD_DESTROY:
		...
		break;
	case VOS_FLAG_IOCMD_INFO:
		ret = _IOFUNC_FLAG_IOCMD_INFO(arg);
		break;
	...
	case VOS_SEM_IOCMD_DESTROY:
		...
		break;
	case VOS_SEM_IOCMD_INFO:
		ret = _IOFUNC_SEM_IOCMD_INFO(arg);
		break;
	...
	case VOS_TASK_IOCMD_CONVERT_HDL:
		...
		break;
	case VOS_TASK_IOCMD_INFO:
		ret = _IOFUNC_TASK_IOCMD_INFO(arg);
		break;
