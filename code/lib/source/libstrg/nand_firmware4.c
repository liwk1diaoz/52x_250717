...
STORAGE_OBJ gNandFWObj4 = {STORAGE_DETACH, STRG_TYPE_NAND, nand_lock, nand_unlock, nandfw_open, nandfw_writeReservedBlock, nandfw_readReservedBlock, nandfw_close, nandfw_open, nandfw_close, nandfw_setParam, nandfw_getParam, nandfw_extIOCtrl};