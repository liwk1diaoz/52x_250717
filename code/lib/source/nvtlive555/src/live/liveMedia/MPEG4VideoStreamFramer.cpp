...
private:
  ...
  Boolean getNextFrameBits(unsigned numBits, u_int8_t& result);
...
private:
  ...
  u_int8_t vop_time_increment_resolution;
  unsigned fNumVTIRBits;
      // # of bits needed to count to "vop_time_increment_resolution"
  u_int8_t fixed_vop_rate;
  u_int8_t fixed_vop_time_increment; // used if 'fixed_vop_rate' is set
