...
public:
  ...
  void NotifyRtcpReceive(void); //NVT_MODIFIED, client timeout mechanism
  Boolean IsRtcpReceiveTimeout(long timeout_sec); //NVT_MODIFIED, client timeout mechanism
...
private:
  ...
  struct timeval m_tv_last_rtcp_receive; //NVT_MODIFIED, client timeout mechanism
