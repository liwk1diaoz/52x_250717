...
//=============================================================================
#ifdef DEBUG
unsigned int msdcnvt_custom_si_debug_level = NVT_DBG_WRN;//(NVT_DBG_INFO | NVT_DBG_WARN | NVT_DBG_ERR);
module_param_named(msdcnvt_custom_si_debug_level, msdcnvt_custom_si_debug_level, int, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(msdcnvt_custom_si_debug_level, "Debug message level");
#endif
...
MODULE_DESCRIPTION("msdcnvt_custom_si driver");
MODULE_LICENSE("GPL");
