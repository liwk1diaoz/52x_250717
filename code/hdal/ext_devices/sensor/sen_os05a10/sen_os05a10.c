...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os05a10, 1, 56, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_OS05A10_MODULE_NAME     "sen_os05a10"
#define SEN_MAX_MODE               15
...
static CTL_SENDRV_GET_MODE_BASIC_PARAM mode_basic_param[SEN_MAX_MODE] = {
	...
	},
	{
		...
		CTL_SEN_FMT_POGRESSIVE,
		{2672, 1948},
		{{3, 3, 2688, 1944}, {3, 3, 2688, 1944}, {0, 0, 0, 0}, {0, 0, 0, 0}},
		{2688, 1944},
		{0, 720, 0, 2500},
		CTL_SEN_RATIO(4, 3),
		{2000, 992000},
...
static CTL_SEN_CMD os05a10_mode_13[] = {
	//@@ Res 2672X1948 4lane MIPI1488bps HDRVC12 30fps MCLK24M
	{0x0100, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0303, 1, {0x01, 0x0}},
	{0x0305, 1, {0x5d, 0x0}},//;5e;5d;45
	{0x0306, 1, {0x00, 0x0}},
	{0x0307, 1, {0x00, 0x0}},
	{0x0308, 1, {0x03, 0x0}},
	{0x0309, 1, {0x04, 0x0}},
	...
	{0x3807, 1, {0x6f, 0x0}},
	{0x3808, 1, {0x0a, 0x0}},
	{0x3809, 1, {0x84, 0x0}},//;00;80
	{0x380a, 1, {0x07, 0x0}},//;07
	{0x380b, 1, {0x9c, 0x0}},//;80;98
	{0x380c, 1, {0x02, 0x0}},
	{0x380d, 1, {0xd0, 0x0}},
	{0x380e, 1, {0x09, 0x0}},
	{0x380f, 1, {0xc0, 0x0}},
	...
	{0x380e, 1, {0x09, 0x0}},
	{0x380f, 1, {0xc4, 0x0}},
	{0x3501, 1, {0x09, 0x0}},//;05
	{0x3502, 1, {0xba, 0x0}},//;c4
	{0x3511, 1, {0x00, 0x0}},
	{0x3512, 1, {0x20, 0x0}},
	{0x4028, 1, {0x6f, 0x0}}, 
	{0x4029, 1, {0x0f, 0x0}}, 
...
static CTL_SEN_CMD os05a10_mode_14[] = {
	//@@ 0 1 Res 2692X1948 2lane MIPI1440Mbps Linear10 20fps MCLK24M
	{0x0100, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0303, 1, {0x01, 0x0}},
	{0x0305, 1, {0x5e, 0x0}},
...
static CTL_SEN_CMD os05a10_mode_15[] = {
	{0x0100, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0303, 1, {0x01, 0x0}},
	{0x0305, 1, {0x4b, 0x0}},//;5e
...
static UINT32 sen_get_cmd_tab_os05a10(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_13:
		*cmd_tab = os05a10_mode_13;
		return sizeof(os05a10_mode_13) / sizeof(CTL_SEN_CMD);	

	case CTL_SEN_MODE_14:
		*cmd_tab = os05a10_mode_14;
		return sizeof(os05a10_mode_14) / sizeof(CTL_SEN_CMD);	

	case CTL_SEN_MODE_15:
		*cmd_tab = os05a10_mode_15;
		return sizeof(os05a10_mode_15) / sizeof(CTL_SEN_CMD);	
...
static void sen_set_gain_os05a10(CTL_SEN_ID id, void *param)
{
	...
	static UINT32 blc_trig_count[CTL_SEN_ID_MAX] = {0};
	ER rt = E_OK;
	...
	if (data3[0]) {
		...
		trigger_value = 0x78;
		if (sen_get_cur_fps_os05a10(id)) {
			blc_trig_count[id] += 100000000 / sen_get_cur_fps_os05a10(id) / 1000;
			if (blc_trig_count[id] >= 60000) { //1 min
				trigger_value = 0x7C;
				if (blc_trig_count[id] >= (60000 + (2 * (100000000 / sen_get_cur_fps_os05a10(id) / 1000)))) {
					blc_trig_count[id] = 0;
				}
			}
		}
