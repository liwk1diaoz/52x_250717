...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc450ai, 1, 55, 000, 00);
...
#define MAX_SHORT_EXPOSURE_LINE     188//0x3e23 0x3e24
...
static CTL_SEN_CMD sc450ai_mode_2[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static CTL_SEN_CMD sc450ai_mode_3[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static CTL_SEN_CMD sc450ai_mode_4[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static CTL_SEN_CMD sc450ai_mode_5[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static UINT32 sen_get_cmd_tab_sc450ai(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_2:
		*cmd_tab = sc450ai_mode_2;
		return sizeof(sc450ai_mode_2) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_3:
		*cmd_tab = sc450ai_mode_3;
		return sizeof(sc450ai_mode_3) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_4:
		*cmd_tab = sc450ai_mode_4;
		return sizeof(sc450ai_mode_4) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_5:
		*cmd_tab = sc450ai_mode_5;
		return sizeof(sc450ai_mode_5) / sizeof(CTL_SEN_CMD);
...
static void sen_set_gain_sc450ai(CTL_SEN_ID id, void *param)
{
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {	
		...
		cmd = sen_set_cmd_info_sc450ai(0x3E08, 1, data1[0] & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E12, 1, data1[1] & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E09, 1, data2[0] & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E13, 1, data2[1] & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		//Set digital high gain
		cmd = sen_set_cmd_info_sc450ai(0x3E06, 1, (data3[0] >> 16) & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E10, 1, (data3[1] >> 16) & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		//Set digiral low gain
		cmd = sen_set_cmd_info_sc450ai(0x3E07, 1, data3[0] & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E11, 1, data3[1] & 0xFF, 0x0);
		rt |= sen_write_reg_sc450ai(id, &cmd);			
	}	
...
static void sen_set_expt_sc450ai(CTL_SEN_ID id, void *param)
{
    ...
    //DBG_ERR("sensor_vd=%d, line[0]=%d, line[1]=%d, max_short_expline=%d, t_row=%d, cur_fps=%d\n", sensor_vd, line[0], line[1], max_short_expline, t_row, cur_fps);
		...
		cmd = sen_set_cmd_info_sc450ai(0x3E02, 1, (line[0] & 0x0F) << 4, 0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E22, 1, (line[1] >> 12) & 0x0F, 0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E04, 1, (line[1] >> 4) & 0xFF , 0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E05, 1, (line[1] & 0x0F) << 4, 0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		//set max short exposure line
		cmd = sen_set_cmd_info_sc450ai(0x3E23, 1, (max_short_expline >> 8) & 0xFF , 0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
		cmd = sen_set_cmd_info_sc450ai(0x3E24, 1, max_short_expline & 0xFF, 0);
		rt |= sen_write_reg_sc450ai(id, &cmd);
	}
