...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc3336, 1, 48, 000, 00);
...
static CTL_SEN_CMD sc3336_mode_1[] = {
	...
	{0x5aed, 1, {0x2c, 0x0}},
	//2304X1298
	{0x3208, 1, {0x09, 0x0}},//2304
	{0x3209, 1, {0x00, 0x0}},
	{0x320a, 1, {0x05, 0x0}},//1298
	{0x320b, 1, {0x12, 0x0}},
	{0x3210, 1, {0x00, 0x0}},
	{0x3211, 1, {0x05, 0x0}},
	{0x3212, 1, {0x00, 0x0}},
...
static CTL_SEN_CMD sc3336_mode_2[] = {
 	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
	{0x37f9, 1, {0x80, 0x0}},
	...
	{0x3209, 1, {0x40, 0x0}},
	{0x320a, 1, {0x00, 0x0}},
	{0x320b, 1, {0xf2, 0x0}},//0xf0
	{0x320e, 1, {0x01, 0x0}},
	{0x320f, 1, {0x2c, 0x0}},
	{0x3210, 1, {0x01, 0x0}},
	{0x3211, 1, {0xa1, 0x0}},//0xa2
	{0x3212, 1, {0x00, 0x0}},
	{0x3213, 1, {0x01, 0x0}},//0x02
	{0x3215, 1, {0x31, 0x0}},
	{0x3220, 1, {0x01, 0x0}},
	{0x3253, 1, {0x10, 0x0}},
	{0x325f, 1, {0x20, 0x0}},
...
static UINT32 sen_get_cmd_tab_sc3336(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_2:
		*cmd_tab = sc3336_mode_2;
		return sizeof(sc3336_mode_2) / sizeof(CTL_SEN_CMD);
...
static void sen_get_modesel_sc3336(CTL_SENDRV_GET_MODESEL_PARAM *data)
{
	...
	if (data->frame_num == 1) {
		if ((data->size.w <= 2312) && (data->size.h <= 1304)) {
			if ((data->size.w <= 320) && (data->size.h <= 240)) {
