...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_imx415, 1, 50, 000, 00);
...
static void sen_get_attr_basic_imx415(CTL_SEN_ID id, CTL_SENDRV_GET_ATTR_BASIC_PARAM *data);
...
static ER sen_get_min_shr_imx415(CTL_SEN_MODE mode, UINT32 *min_shr, UINT32 *min_exp);
//=============================================================================
// global variable
//=============================================================================
...
static ER sen_get_info_imx415(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_ATTR_BASIC:
		sen_get_attr_basic_imx415(id, (CTL_SENDRV_GET_ATTR_BASIC_PARAM *)(data));
		break;
...
static void sen_set_expt_imx415(CTL_SEN_ID id, void *param)
{
	...
	UINT32 shr0 = 0, rhs1 = 0, shr1 = 0, brl = 0, fcs = 0;
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		sen_get_min_shr_imx415(cur_sen_mode[id], &min_shr, &min_exp_line);
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		...
		if ((mode_basic_param[cur_sen_mode[id]].frame_num) == 2) {
			...
			if (rhs1 < (9 + 8)) {//min rhs1 = shr1+8 and should be 4n+1,so min rhs1 = 17
				rhs1 = 9 + 8;//min shr1 = 9, min rhs1 = shr1 + 8;
			}
