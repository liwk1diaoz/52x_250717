...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os02d10, 1, 43, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_OS02D10_MODULE_NAME     "sen_os02d10"
...
#define SEN_I2C_COMPATIBLE "nvt,sen_os02d10"
...
//=============================================================================
static CTL_SEN_DRV_TAB *sen_get_drv_tab_os02d10(void);
static void sen_pwr_ctrl_os02d10(CTL_SEN_ID id, CTL_SEN_PWR_CTRL_FLAG flag, CTL_SEN_CLK_CB clk_cb);
static ER sen_open_os02d10(CTL_SEN_ID id);
static ER sen_close_os02d10(CTL_SEN_ID id);
static ER sen_sleep_os02d10(CTL_SEN_ID id);
static ER sen_wakeup_os02d10(CTL_SEN_ID id);
static ER sen_write_reg_os02d10(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_read_reg_os02d10(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_chg_mode_os02d10(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj);
static ER sen_chg_fps_os02d10(CTL_SEN_ID id, UINT32 fps);
static ER sen_set_info_os02d10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static ER sen_get_info_os02d10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static UINT32 sen_calc_chgmode_vd_os02d10(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_calc_exp_vd_os02d10(CTL_SEN_ID id, UINT32 fps);
static void sen_set_gain_os02d10(CTL_SEN_ID id, void *param);
static void sen_set_expt_os02d10(CTL_SEN_ID id, void *param);
static void sen_set_preset_os02d10(CTL_SEN_ID id, ISP_SENSOR_PRESET_CTRL *ctrl);
static void sen_set_flip_os02d10(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
static ER sen_get_flip_os02d10(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
#if defined(__FREERTOS)
void sen_get_gain_os02d10(CTL_SEN_ID id, void *param);
void sen_get_expt_os02d10(CTL_SEN_ID id, void *param);
#else
static void sen_get_gain_os02d10(CTL_SEN_ID id, void *param);
static void sen_get_expt_os02d10(CTL_SEN_ID id, void *param);
#endif
static void sen_get_min_expt_os02d10(CTL_SEN_ID id, void *param);
static void sen_get_mode_basic_os02d10(CTL_SENDRV_GET_MODE_BASIC_PARAM *mode_basic);
static void sen_get_attr_basic_os02d10(CTL_SENDRV_GET_ATTR_BASIC_PARAM *data);
static void sen_get_attr_signal_os02d10(CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *data);
static ER sen_get_attr_cmdif_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_ATTR_CMDIF_PARAM *data);
static ER sen_get_attr_if_os02d10(CTL_SENDRV_GET_ATTR_IF_PARAM *data);
static void sen_get_fps_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data);
static void sen_get_speed_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_SPEED_PARAM *data);
static void sen_get_mode_mipi_os02d10(CTL_SENDRV_GET_MODE_MIPI_PARAM *data);
static void sen_get_modesel_os02d10(CTL_SENDRV_GET_MODESEL_PARAM *data);
static UINT32 sen_calc_rowtime_os02d10(CTL_SEN_ID id, CTL_SEN_MODE mode);
static UINT32 sen_calc_rowtime_step_os02d10(CTL_SEN_ID id, CTL_SEN_MODE mode);
static void sen_get_rowtime_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data);
static void sen_set_cur_fps_os02d10(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_cur_fps_os02d10(CTL_SEN_ID id);
static void sen_set_chgmode_fps_os02d10(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_chgmode_fps_os02d10(CTL_SEN_ID id);
static void sen_get_lane_control_method_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_MIPI_CLANE_CMETHOD *data);
//=============================================================================
// global variable
//=============================================================================
...
static CTL_SEN_CMD os02d10_mode_1[] = {
	//1928x1088 mclk=24M pclk=84M hts=1161 vts=1205 fps=84M/(1161*2*1205)=30.021
	{0xfd, 1, {0x00, 0x0}},
	{0x41, 1, {0x05, 0x0}},
	{0xfd, 1, {0x01, 0x0}},
	{0x03, 1, {0x01, 0x0}},
...
static CTL_SEN_CSI_EN_CB os02d10_csi_en_cb = NULL;

static CTL_SEN_DRV_TAB os02d10_sen_drv_tab = {
	sen_open_os02d10,
	sen_close_os02d10,
	sen_sleep_os02d10,
	sen_wakeup_os02d10,
	sen_write_reg_os02d10,
	sen_read_reg_os02d10,
	sen_chg_mode_os02d10,
	sen_chg_fps_os02d10,
	sen_set_info_os02d10,
	sen_get_info_os02d10,
};

static CTL_SEN_DRV_TAB *sen_get_drv_tab_os02d10(void)
{
	return &os02d10_sen_drv_tab;
}
...
static CTL_SEN_CMD sen_set_cmd_info_os02d10(UINT32 addr, UINT32 data_length, UINT32 data0, UINT32 data1)
{
	CTL_SEN_CMD cmd;
...
#if defined(__KERNEL__)
static void sen_load_cfg_from_compatible_os02d10(struct device_node *of_node)
{
...
static ER sen_open_os02d10(CTL_SEN_ID id)
{
	...
	#if defined(__KERNEL__)
	sen_i2c_reg_cb(sen_load_cfg_from_compatible_os02d10);
	#endif
...
static ER sen_sleep_os02d10(CTL_SEN_ID id)
{
	...
	DBG_IND("sen_sleep_os02d10 \r\n");

	os02d10_csi_en_cb(id, FALSE);
	cmd = sen_set_cmd_info_os02d10(0xFD, 1, 0x00, 0x00);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x36, 1, 0x01, 0x00);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x37, 1, 0x01, 0x00);
	rt |= sen_write_reg_os02d10(id, &cmd);
...
static ER sen_wakeup_os02d10(CTL_SEN_ID id)
{
	...
	DBG_IND("sen_wakeup_os02d10 \r\n");

	cmd = sen_set_cmd_info_os02d10(0xFD, 1, 0x00, 0x00);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x37, 1, 0x00, 0x00);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x36, 1, 0x00, 0x00);
	rt |= sen_write_reg_os02d10(id, &cmd);
	vos_util_delay_ms(100);
	os02d10_csi_en_cb(id, TRUE);
	return E_OK;
}

static UINT32 sen_get_cmd_tab_os02d10(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	switch (mode) {
	case CTL_SEN_MODE_1:
		*cmd_tab = os02d10_mode_1;
		return sizeof(os02d10_mode_1) / sizeof(CTL_SEN_CMD);
...
static ER sen_chg_mode_os02d10(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	if (is_fastboot[id]) {
		...
		sen_set_chgmode_fps_os02d10(id, isp_builtin_get_chgmode_fps(id));
		sen_set_cur_fps_os02d10(id, isp_builtin_get_chgmode_fps(id));
		sen_set_gain_os02d10(id, &sensor_ctrl);
		sen_set_expt_os02d10(id, &sensor_ctrl);
		#endif
	...
	cmd_num = sen_get_cmd_tab_os02d10(chgmode_obj.mode, &p_cmd_list);
	if (p_cmd_list == NULL) {
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os02d10(id, chgmode_obj.frame_rate);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os02d10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os02d10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
	...
	for (idx = 0; idx < cmd_num; idx++) {
		if (p_cmd_list[idx].addr == SEN_CMD_DELAY) {
			...
			cmd = sen_set_cmd_info_os02d10(0xFD, 1, 0x01, 0x00);
			rt |= sen_write_reg_os02d10(id, &cmd);
			cmd = sen_set_cmd_info_os02d10(0x0D, 1, 0x10, 0x00);
			rt |= sen_write_reg_os02d10(id, &cmd);
			cmd = sen_set_cmd_info_os02d10(0x0E, 1, (sensor_vd >> 8) & 0xFF, 0x00);
			rt |= sen_write_reg_os02d10(id, &cmd);
			cmd = sen_set_cmd_info_os02d10(0x0F, 1, sensor_vd & 0xFF, 0x00);
			rt |= sen_write_reg_os02d10(id, &cmd);
			cmd = sen_set_cmd_info_os02d10(0x01, 1, 0x01, 0x00);
			rt |= sen_write_reg_os02d10(id, &cmd);
			...
			sen_set_flip_os02d10(id, &flip);
		} else {
			cmd = sen_set_cmd_info_os02d10(p_cmd_list[idx].addr, p_cmd_list[idx].data_len, p_cmd_list[idx].data[0], p_cmd_list[idx].data[1]);
			rt |= sen_write_reg_os02d10(id, &cmd);
		}
	}
...
static ER sen_chg_fps_os02d10(CTL_SEN_ID id, UINT32 fps)
{
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os02d10(id, fps);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os02d10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os02d10(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
...
static ER sen_set_info_os02d10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_SET_EXPT:
		sen_set_expt_os02d10(id, data);
		break;
	case CTL_SENDRV_CFGID_SET_GAIN:
		sen_set_gain_os02d10(id, data);
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		sen_set_flip_os02d10(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE1:
		sen_set_preset_os02d10(id, (ISP_SENSOR_PRESET_CTRL *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI_EN_USER:
		mipi_en_user = *(CTL_SENDRV_GET_MODE_MIPI_EN_USER *)data;
		os02d10_csi_en_cb = mipi_en_user.csi_en_cb;
		break;		
	default:
		return E_NOSPT;
	}
...
static ER sen_get_info_os02d10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_EXPT:
		sen_get_expt_os02d10(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_GAIN:
		sen_get_gain_os02d10(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_BASIC:
		sen_get_attr_basic_os02d10((CTL_SENDRV_GET_ATTR_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_SIGNAL:
		sen_get_attr_signal_os02d10((CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_CMDIF:
		rt = sen_get_attr_cmdif_os02d10(id, (CTL_SENDRV_GET_ATTR_CMDIF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_IF:
		rt = sen_get_attr_if_os02d10((CTL_SENDRV_GET_ATTR_IF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_FPS:
		sen_get_fps_os02d10(id, (CTL_SENDRV_GET_FPS_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_SPEED:
		sen_get_speed_os02d10(id, (CTL_SENDRV_GET_SPEED_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_BASIC:
		sen_get_mode_basic_os02d10((CTL_SENDRV_GET_MODE_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI:
		sen_get_mode_mipi_os02d10((CTL_SENDRV_GET_MODE_MIPI_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODESEL:
		sen_get_modesel_os02d10((CTL_SENDRV_GET_MODESEL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_ROWTIME:
		sen_get_rowtime_os02d10(id, (CTL_SENDRV_GET_MODE_ROWTIME_PARAM *)(data));
		break;	
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		rt = sen_get_flip_os02d10(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE2:
		sen_get_min_expt_os02d10(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI_CLANE_CMETHOD:
		sen_get_lane_control_method_os02d10(id, (CTL_SENDRV_GET_MODE_MIPI_CLANE_CMETHOD *)(data));
		break;			
	default:
		rt = E_NOSPT;
	}
...
static UINT32 sen_calc_chgmode_vd_os02d10(CTL_SEN_ID id, UINT32 fps)
{
	...
	sen_set_chgmode_fps_os02d10(id, fps);
	sen_set_cur_fps_os02d10(id, fps);
...
static void sen_set_gain_os02d10(CTL_SEN_ID id, void *param)
{
	...
	cmd = sen_set_cmd_info_os02d10(0xFD, 1, 0x01, 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x24, 1, data1[0], 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x38, 1, ((data1[0] >> 8) & 0x01), 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x39, 1, data2[0], 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x01, 1, 0x01, 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);
...
static void sen_set_expt_os02d10(CTL_SEN_ID id, void *param)
{
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		t_row = sen_calc_rowtime_os02d10(id, cur_sen_mode[id]);
	...
	// Write exposure line
	// Get fps
	chgmode_fps = sen_get_chgmode_fps_os02d10(id);
	...
	sen_set_cur_fps_os02d10(id, cur_fps);

	// Calculate new vd
	sensor_vd = sen_calc_exp_vd_os02d10(id, cur_fps);
	...
	cmd = sen_set_cmd_info_os02d10(0xFD, 1, 0x01, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x0E, 1, (sensor_vd >> 8) & 0xFF, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x0F, 1, sensor_vd & 0xFF, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	...
	rt |= sen_write_reg_os02d10(id, &cmd);
	// vts
	cmd = sen_set_cmd_info_os02d10(0x0D, 1, 0x10, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x0E, 1, ((sensor_vd) >> 8 ) & 0xFF, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x0F, 1, (sensor_vd) & 0xFF, 0);
	...
	// set exposure line to sensor
	cmd = sen_set_cmd_info_os02d10(0x03, 1, ( line[0] >> 8 ) & 0xFF, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x04, 1, line[0] & 0xFF , 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
	cmd = sen_set_cmd_info_os02d10(0x01, 1, 0x01, 0);
	rt |= sen_write_reg_os02d10(id, &cmd);
...
static void sen_set_flip_os02d10(CTL_SEN_ID id, CTL_SEN_FLIP *flip)
{
	...
	cmd = sen_set_cmd_info_os02d10(0xFD, 1, 0x1, 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);

	cmd = sen_set_cmd_info_os02d10(0x3F, 1, 0x0, 0x0);
	rt |= sen_read_reg_os02d10(id, &cmd);
	...
	cmd = sen_set_cmd_info_os02d10(0x01, 1, 0x1, 0x0);
	rt |= sen_write_reg_os02d10(id, &cmd);
...
static void sen_get_lane_control_method_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_MIPI_CLANE_CMETHOD *data)
{
	...
	if (CTL_SEN_MODE_1 == mode) {
		data->clane_ctl_mode = 1; ///< [out] 1: force high speed , 0: normal.
	}
}

static void sen_get_fps_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data)
{
	data->cur_fps = sen_get_cur_fps_os02d10(id);
	data->chg_fps = sen_get_chgmode_fps_os02d10(id);
}
...
static void sen_get_rowtime_os02d10(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data)
{
	data->row_time_step = sen_calc_rowtime_step_os02d10(id, data->mode);
	data->row_time = sen_calc_rowtime_os02d10(id, data->mode) * (data->row_time_step);
}
...
#if defined(__FREERTOS)
void sen_get_i2c_id_os02d10(CTL_SEN_ID id, UINT32 *i2c_id)
{
	*i2c_id = sen_i2c[id].id;
}

void sen_get_i2c_addr_os02d10(CTL_SEN_ID id, UINT32 *i2c_addr)
{
	*i2c_addr = sen_i2c[id].addr;
}

int sen_init_os02d10(SENSOR_DTSI_INFO *info)
{
	...
	sprintf(compatible, "nvt,sen_os02d10");
	if (sen_common_check_compatible(compatible)) {
		...
		sprintf(node_path, "/sensor/sen_cfg/sen_os02d10");
	...
	reg_obj.pwr_ctrl = sen_pwr_ctrl_os02d10;
	reg_obj.det_plug_in = NULL;
	reg_obj.drv_tab = sen_get_drv_tab_os02d10();
	rt = ctl_sen_reg_sendrv("nvt_sen_os02d10", &reg_obj);
	if (rt != E_OK) {
...
void sen_exit_os02d10(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_os02d10");
}

#else
static int __init sen_init_os02d10(void)
{
...
static void __exit sen_exit_os02d10(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_os02d10");
}

module_init(sen_init_os02d10);
module_exit(sen_exit_os02d10);

MODULE_AUTHOR("Novatek Corp.");
MODULE_DESCRIPTION(SEN_OS02D10_MODULE_NAME);
MODULE_LICENSE("GPL");
#endif
