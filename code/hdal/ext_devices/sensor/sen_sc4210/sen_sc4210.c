...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_sc4210, 1, 47, 000, 00);
...
//2560x1442 30FPS 12bit linear mode 2lane 729Mbps
static CTL_SEN_CMD sc4210_mode_4[] = {
	//[paralist]
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x36e9, 1, {0x80, 0x0}},
...
static UINT32 sen_get_cmd_tab_sc4210(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_4:
		*cmd_tab = sc4210_mode_4;
		return sizeof(sc4210_mode_4) / sizeof(CTL_SEN_CMD);
