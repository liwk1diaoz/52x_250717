...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_s5k4h7, 1, 44, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_S5K4H7_MODULE_NAME     "sen_s5k4h7"
...
#define SEN_I2C_ADDR 0x5A >> 1
#define SEN_I2C_COMPATIBLE "nvt,sen_s5k4h7"
...
//=============================================================================
static CTL_SEN_DRV_TAB *sen_get_drv_tab_s5k4h7(void);
static void sen_pwr_ctrl_s5k4h7(CTL_SEN_ID id, CTL_SEN_PWR_CTRL_FLAG flag, CTL_SEN_CLK_CB clk_cb);
static ER sen_open_s5k4h7(CTL_SEN_ID id);
static ER sen_close_s5k4h7(CTL_SEN_ID id);
static ER sen_sleep_s5k4h7(CTL_SEN_ID id);
static ER sen_wakeup_s5k4h7(CTL_SEN_ID id);
static ER sen_write_reg_s5k4h7(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_read_reg_s5k4h7(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_chg_mode_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj);
static ER sen_chg_fps_s5k4h7(CTL_SEN_ID id, UINT32 fps);
static ER sen_set_info_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static ER sen_get_info_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static UINT32 sen_calc_chgmode_vd_s5k4h7(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_calc_exp_vd_s5k4h7(CTL_SEN_ID id, UINT32 fps);
static void sen_set_gain_s5k4h7(CTL_SEN_ID id, void *param);
static void sen_set_expt_s5k4h7(CTL_SEN_ID id, void *param);
static void sen_set_preset_s5k4h7(CTL_SEN_ID id, ISP_SENSOR_PRESET_CTRL *ctrl);
static void sen_set_flip_s5k4h7(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
static ER sen_get_flip_s5k4h7(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
#if defined(__FREERTOS)
void sen_get_gain_s5k4h7(CTL_SEN_ID id, void *param);
void sen_get_expt_s5k4h7(CTL_SEN_ID id, void *param);
#else
static void sen_get_gain_s5k4h7(CTL_SEN_ID id, void *param);
static void sen_get_expt_s5k4h7(CTL_SEN_ID id, void *param);
#endif
static void sen_get_min_expt_s5k4h7(CTL_SEN_ID id, void *param);
static void sen_get_mode_basic_s5k4h7(CTL_SENDRV_GET_MODE_BASIC_PARAM *mode_basic);
static void sen_get_attr_basic_s5k4h7(CTL_SENDRV_GET_ATTR_BASIC_PARAM *data);
static void sen_get_attr_signal_s5k4h7(CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *data);
static ER sen_get_attr_cmdif_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_GET_ATTR_CMDIF_PARAM *data);
static ER sen_get_attr_if_s5k4h7(CTL_SENDRV_GET_ATTR_IF_PARAM *data);
static void sen_get_fps_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data);
static void sen_get_speed_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_GET_SPEED_PARAM *data);
static void sen_get_mode_mipi_s5k4h7(CTL_SENDRV_GET_MODE_MIPI_PARAM *data);
static void sen_get_modesel_s5k4h7(CTL_SENDRV_GET_MODESEL_PARAM *data);
static UINT32 sen_calc_rowtime_s5k4h7(CTL_SEN_ID id, CTL_SEN_MODE mode);
static UINT32 sen_calc_rowtime_step_s5k4h7(CTL_SEN_ID id, CTL_SEN_MODE mode);
static void sen_get_rowtime_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data);
static void sen_set_cur_fps_s5k4h7(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_cur_fps_s5k4h7(CTL_SEN_ID id);
static void sen_set_chgmode_fps_s5k4h7(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_chgmode_fps_s5k4h7(CTL_SEN_ID id);
//=============================================================================
// global variable
//=============================================================================
...
static CTL_SEN_CMD s5k4h7_mode_1[] = {
	{0x0100, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0b05, 1, {0x01, 0x0}},
	{0x3074, 1, {0x06, 0x0}},
	...
	{0x0345, 1, {0x08, 0x0}},
	{0x0346, 1, {0x00, 0x0}},
	{0x0347, 1, {0x06, 0x0}},//0x08
	{0x0348, 1, {0x0c, 0x0}},
	{0x0349, 1, {0xc7, 0x0}},
	{0x034a, 1, {0x09, 0x0}},
	{0x034b, 1, {0x97, 0x0}},//0x97
	{0x034c, 1, {0x0c, 0x0}},
	{0x034d, 1, {0xc0, 0x0}},
	{0x034e, 1, {0x09, 0x0}},
	{0x034f, 1, {0x92, 0x0}},//0x90
	{0x0900, 1, {0x00, 0x0}},
	{0x0901, 1, {0x00, 0x0}},
	{0x0381, 1, {0x01, 0x0}},
	{0x0383, 1, {0x01, 0x0}},
...
static CTL_SEN_DRV_TAB s5k4h7_sen_drv_tab = {
	sen_open_s5k4h7,
	sen_close_s5k4h7,
	sen_sleep_s5k4h7,
	sen_wakeup_s5k4h7,
	sen_write_reg_s5k4h7,
	sen_read_reg_s5k4h7,
	sen_chg_mode_s5k4h7,
	sen_chg_fps_s5k4h7,
	sen_set_info_s5k4h7,
...
static CTL_SEN_CMD sen_set_cmd_info_s5k4h7(UINT32 addr, UINT32 data_length, UINT32 data0, UINT32 data1)
{
	CTL_SEN_CMD cmd;
...
#if defined(__KERNEL__)
static void sen_load_cfg_from_compatible_s5k4h7(struct device_node *of_node)
{
...
static ER sen_open_s5k4h7(CTL_SEN_ID id)
{
	...
	#if defined(__KERNEL__)
	sen_i2c_reg_cb(sen_load_cfg_from_compatible_s5k4h7);
	#endif
...
static UINT32 sen_get_cmd_tab_s5k4h7(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	switch (mode) {
	case CTL_SEN_MODE_1:
		*cmd_tab = s5k4h7_mode_1;
		return sizeof(s5k4h7_mode_1) / sizeof(CTL_SEN_CMD);
...
static ER sen_chg_mode_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	if (is_fastboot[id]) {
		...
		sen_set_chgmode_fps_s5k4h7(id, isp_builtin_get_chgmode_fps(id));
		sen_set_cur_fps_s5k4h7(id, isp_builtin_get_chgmode_fps(id));
		sen_set_gain_s5k4h7(id, &sensor_ctrl);
		sen_set_expt_s5k4h7(id, &sensor_ctrl);
		#endif
	...
	cmd_num = sen_get_cmd_tab_s5k4h7(chgmode_obj.mode, &p_cmd_list);
	if (p_cmd_list == NULL) {
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_s5k4h7(id, chgmode_obj.frame_rate);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_s5k4h7(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_s5k4h7(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
	...
	for (idx = 0; idx < cmd_num; idx++) {
		if (p_cmd_list[idx].addr == SEN_CMD_DELAY) {
			...
			cmd = sen_set_cmd_info_s5k4h7(0x0340, 1, (sensor_vd >> 8) & 0xFF, 0x00);
			rt |= sen_write_reg_s5k4h7(id, &cmd);
			cmd = sen_set_cmd_info_s5k4h7(0x0341, 1, sensor_vd & 0xFF, 0x00);
			rt |= sen_write_reg_s5k4h7(id, &cmd);
			//DBG_ERR("sensor_vd=%d\n", sensor_vd);
			...
			sen_set_flip_s5k4h7(id, &flip);
		} else {
			cmd = sen_set_cmd_info_s5k4h7(p_cmd_list[idx].addr, p_cmd_list[idx].data_len, p_cmd_list[idx].data[0], p_cmd_list[idx].data[1]);
			rt |= sen_write_reg_s5k4h7(id, &cmd); 
		}
	}
...
static ER sen_chg_fps_s5k4h7(CTL_SEN_ID id, UINT32 fps)
{
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_s5k4h7(id, fps);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_s5k4h7(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_s5k4h7(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
...
static ER sen_set_info_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_SET_EXPT:
		sen_set_expt_s5k4h7(id, data);
		break;
	case CTL_SENDRV_CFGID_SET_GAIN:
		sen_set_gain_s5k4h7(id, data);
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		sen_set_flip_s5k4h7(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE1:
		sen_set_preset_s5k4h7(id, (ISP_SENSOR_PRESET_CTRL *)(data));
		break;
	default:
		return E_NOSPT;
	}
...
static ER sen_get_info_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_EXPT:
		sen_get_expt_s5k4h7(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_GAIN:
		sen_get_gain_s5k4h7(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_BASIC:
		sen_get_attr_basic_s5k4h7((CTL_SENDRV_GET_ATTR_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_SIGNAL:
		sen_get_attr_signal_s5k4h7((CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_CMDIF:
		rt = sen_get_attr_cmdif_s5k4h7(id, (CTL_SENDRV_GET_ATTR_CMDIF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_IF:
		rt = sen_get_attr_if_s5k4h7((CTL_SENDRV_GET_ATTR_IF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_FPS:
		sen_get_fps_s5k4h7(id, (CTL_SENDRV_GET_FPS_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_SPEED:
		sen_get_speed_s5k4h7(id, (CTL_SENDRV_GET_SPEED_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_BASIC:
		sen_get_mode_basic_s5k4h7((CTL_SENDRV_GET_MODE_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI:
		sen_get_mode_mipi_s5k4h7((CTL_SENDRV_GET_MODE_MIPI_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODESEL:
		sen_get_modesel_s5k4h7((CTL_SENDRV_GET_MODESEL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_ROWTIME:
		sen_get_rowtime_s5k4h7(id, (CTL_SENDRV_GET_MODE_ROWTIME_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		rt = sen_get_flip_s5k4h7(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE2:
		sen_get_min_expt_s5k4h7(id, data);
		break;
	default:
		rt = E_NOSPT;
	}
...
static UINT32 sen_calc_chgmode_vd_s5k4h7(CTL_SEN_ID id, UINT32 fps)
{
	...
	sen_set_chgmode_fps_s5k4h7(id, fps);
	sen_set_cur_fps_s5k4h7(id, fps);
...
static void sen_set_gain_s5k4h7(CTL_SEN_ID id, void *param)
{
	...
	UINT32 analog_gain = 0, digital_gain = 0;
	CTL_SEN_CMD cmd;
	ER rt = E_OK;
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		if ((sensor_ctrl->gain_ratio[frame_cnt]) > 16000) {
			analog_gain = 0x200;
			digital_gain = (sensor_ctrl->gain_ratio[frame_cnt]) * 256 / 16 / 1000;
		} else {
		  analog_gain = (sensor_ctrl->gain_ratio[frame_cnt]) * 32 / 1000;
		  digital_gain = 0x100;
		}		
	...
	// Write sensor gain
	cmd = sen_set_cmd_info_s5k4h7(0x0204, 1, (data1[0] >> 8) & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0205, 1, data1[0] & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);

	cmd = sen_set_cmd_info_s5k4h7(0x020E, 1, (data2[0] >> 8) & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x020F, 1, data2[0] & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0210, 1, (data2[0] >> 8) & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0211, 1, data2[0] & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);	
	cmd = sen_set_cmd_info_s5k4h7(0x0212, 1, (data2[0] >> 8) & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0213, 1, data2[0] & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0214, 1, (data2[0] >> 8) & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0215, 1, data2[0] & 0xFF, 0x0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);	
...
static void sen_set_expt_s5k4h7(CTL_SEN_ID id, void *param)
{
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		t_row = sen_calc_rowtime_s5k4h7(id, cur_sen_mode[id]);
		if (0 == t_row) {
	...
	// Write exposure line
	// Get fps
	chgmode_fps = sen_get_chgmode_fps_s5k4h7(id);
	...
	sen_set_cur_fps_s5k4h7(id, cur_fps);

	// Calculate new vd
	sensor_vd = sen_calc_exp_vd_s5k4h7(id, cur_fps);
	...
	// Set Vmax to sensor
	cmd = sen_set_cmd_info_s5k4h7(0x0340, 1, (sensor_vd >> 8) & 0xFF, 0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);	
	cmd = sen_set_cmd_info_s5k4h7(0x0341, 1, sensor_vd & 0xFF, 0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	...
	cmd = sen_set_cmd_info_s5k4h7(0x0202, 1, (line[0] >> 8) & 0xFF , 0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
	cmd = sen_set_cmd_info_s5k4h7(0x0203, 1, line[0] & 0xFF, 0);
	rt |= sen_write_reg_s5k4h7(id, &cmd);
...
static void sen_set_flip_s5k4h7(CTL_SEN_ID id, CTL_SEN_FLIP *flip)
{
	...
	cmd = sen_set_cmd_info_s5k4h7(0x0101, 1, 0x0, 0x0);
	rt |= sen_read_reg_s5k4h7(id, &cmd);
...
static void sen_get_fps_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data)
{
	data->cur_fps = sen_get_cur_fps_s5k4h7(id);
	data->chg_fps = sen_get_chgmode_fps_s5k4h7(id);
}
...
static void sen_get_rowtime_s5k4h7(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data)
{
	data->row_time_step = sen_calc_rowtime_step_s5k4h7(id, data->mode);	
	data->row_time = sen_calc_rowtime_s5k4h7(id, data->mode) * (data->row_time_step);
}
...
#if defined(__FREERTOS)
void sen_get_i2c_id_s5k4h7(CTL_SEN_ID id, UINT32 *i2c_id)
{
	*i2c_id = sen_i2c[id].id;
}

void sen_get_i2c_addr_s5k4h7(CTL_SEN_ID id, UINT32 *i2c_addr)
{
	*i2c_addr = sen_i2c[id].addr;
}
int sen_init_s5k4h7(SENSOR_DTSI_INFO *info)
{
	...
	sprintf(compatible, "nvt,sen_s5k4h7");
	if (sen_common_check_compatible(compatible)) {
		...
		sprintf(node_path, "/sensor/sen_cfg/sen_s5k4h7");
	...
	reg_obj.pwr_ctrl = sen_pwr_ctrl_s5k4h7;
	reg_obj.det_plug_in = NULL;
	reg_obj.drv_tab = sen_get_drv_tab_s5k4h7();
	rt = ctl_sen_reg_sendrv("nvt_sen_s5k4h7", &reg_obj);
	if (rt != E_OK) {
...
void sen_exit_s5k4h7(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_s5k4h7");
}

#else
static int __init sen_init_s5k4h7(void)
{
...
static void __exit sen_exit_s5k4h7(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_s5k4h7");
}

module_init(sen_init_s5k4h7);
module_exit(sen_exit_s5k4h7);

MODULE_AUTHOR("Novatek Corp.");
MODULE_DESCRIPTION(SEN_S5K4H7_MODULE_NAME);
MODULE_LICENSE("GPL");
#endif
