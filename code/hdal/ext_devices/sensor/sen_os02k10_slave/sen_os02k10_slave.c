...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os02k10_slave, 1, 56, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_OS02K10_SLAVE_MODULE_NAME     "sen_os02k10_slave"
...
#define HD_SYNC                    8
#define VD_SYNC                    1249
#define SYNC_DISTANCE              26
#define HCG_ENABLE                 1

#define SEN_I2C_ADDR 0x6C>>1
#define SEN_I2C_COMPATIBLE "nvt,sen_os02k10_slave"
...
//=============================================================================
static CTL_SEN_DRV_TAB *sen_get_drv_tab_os02k10_slave(void);
static void sen_pwr_ctrl_os02k10_slave(CTL_SEN_ID id, CTL_SEN_PWR_CTRL_FLAG flag, CTL_SEN_CLK_CB clk_cb);
static ER sen_open_os02k10_slave(CTL_SEN_ID id);
static ER sen_close_os02k10_slave(CTL_SEN_ID id);
static ER sen_sleep_os02k10_slave(CTL_SEN_ID id);
static ER sen_wakeup_os02k10_slave(CTL_SEN_ID id);
static ER sen_write_reg_os02k10_slave(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_read_reg_os02k10_slave(CTL_SEN_ID id, CTL_SEN_CMD *cmd);
static ER sen_chg_mode_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj);
static ER sen_chg_fps_os02k10_slave(CTL_SEN_ID id, UINT32 fps);
static ER sen_set_info_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static ER sen_get_info_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data);
static UINT32 sen_calc_chgmode_vd_os02k10_slave(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_calc_exp_vd_os02k10_slave(CTL_SEN_ID id, UINT32 fps);
static void sen_set_gain_os02k10_slave(CTL_SEN_ID id, void *param);
static void sen_set_expt_os02k10_slave(CTL_SEN_ID id, void *param);
static void sen_set_preset_os02k10_slave(CTL_SEN_ID id, ISP_SENSOR_PRESET_CTRL *ctrl);
static void sen_set_flip_os02k10_slave(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
static ER sen_get_flip_os02k10_slave(CTL_SEN_ID id, CTL_SEN_FLIP *flip);
#if defined(__FREERTOS)
void sen_get_gain_os02k10_slave(CTL_SEN_ID id, void *param);
void sen_get_expt_os02k10_slave(CTL_SEN_ID id, void *param);
#else
static void sen_get_gain_os02k10_slave(CTL_SEN_ID id, void *param);
static void sen_get_expt_os02k10_slave(CTL_SEN_ID id, void *param);
#endif
static void sen_get_min_expt_os02k10_slave(CTL_SEN_ID id, void *param);
static void sen_get_mode_basic_os02k10_slave(CTL_SENDRV_GET_MODE_BASIC_PARAM *mode_basic);
static void sen_get_attr_basic_os02k10_slave(CTL_SENDRV_GET_ATTR_BASIC_PARAM *data);
static void sen_get_attr_signal_os02k10_slave(CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *data);
static ER sen_get_attr_cmdif_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_ATTR_CMDIF_PARAM *data);
static ER sen_get_attr_if_os02k10_slave(CTL_SENDRV_GET_ATTR_IF_PARAM *data);
static void sen_get_fps_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data);
static void sen_get_speed_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_SPEED_PARAM *data);
static void sen_get_mode_mipi_os02k10_slave(CTL_SENDRV_GET_MODE_MIPI_PARAM *data);
static void sen_ext_get_mode_tge_os02k10_slave(CTL_SENDRV_GET_MODE_TGE_PARAM *data);
static void sen_get_modesel_os02k10_slave(CTL_SENDRV_GET_MODESEL_PARAM *data);
static UINT32 sen_calc_rowtime_os02k10_slave(CTL_SEN_ID id, CTL_SEN_MODE mode);
static UINT32 sen_calc_rowtime_step_os02k10_slave(CTL_SEN_ID id, CTL_SEN_MODE mode);
static void sen_get_rowtime_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data);
static void sen_set_cur_fps_os02k10_slave(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_cur_fps_os02k10_slave(CTL_SEN_ID id);
static void sen_set_chgmode_fps_os02k10_slave(CTL_SEN_ID id, UINT32 fps);
static UINT32 sen_get_chgmode_fps_os02k10_slave(CTL_SEN_ID id);
static ER sen_get_otp_os02k10_slave(CTL_SEN_ID id);
//=============================================================================
// global variable
//=============================================================================
...
static CTL_SEN_CMD os02k10_slave_mode_1[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
	...
	{0x3823, 1, {0x50, 0x0}}, //; //[6] ext_vs_en; [3:0] ext_vsync_div, increase this to div vsync
	{0x383e, 1, {0x81, 0x0}}, //; //[7] disable vs_ext's reset of R counter and CS counter
	{0x3881, 1, {0x06, 0x0}}, //; //[2] enable ext_vsync for vts_adj
	//; //[1:0] vts_adj_threshold : if the difference is less than this
	//; //      this value, the FSIN will not adjust VTS, the unit is row
	//adjust these two registers to set the sync point : tc_vts - {r3882,r3883}
	{0x3882, 1, {0x00, 0x0}},
	{0x3883, 1, {0x08, 0x0}},
	//;adjust these two register to set the thereshold for decrease vts to much
	//;r_threshold_vts_sub = {r3835,r3836},when vts decreases more than this value
	//;the VTS will be doubled firstly and then subtract the adjust value
	{0x3835, 1, {0x00, 0x0}},
	{0x3836, 1, {0x08, 0x0}},
	//; FSIN input enable
	{0x3009, 1, {0x02, 0x0}}, //; fsin input enable
	//; the following is for the vsync output for the master sensor
	//;continuous mode
	//;6c 3823[6] = 1; ext_vs_en
	//; 3822[5]=1 ; fix_cnt_en
	{0x0100, 1, {0x01, 0x0}},
};
...
static CTL_SEN_DRV_TAB os02k10_slave_sen_drv_tab = {
	sen_open_os02k10_slave,
	sen_close_os02k10_slave,
	sen_sleep_os02k10_slave,
	sen_wakeup_os02k10_slave,
	sen_write_reg_os02k10_slave,
	sen_read_reg_os02k10_slave,
	sen_chg_mode_os02k10_slave,
	sen_chg_fps_os02k10_slave,
	sen_set_info_os02k10_slave,
	sen_get_info_os02k10_slave,
};

static CTL_SEN_DRV_TAB *sen_get_drv_tab_os02k10_slave(void)
{
	return &os02k10_slave_sen_drv_tab;
}
...
static CTL_SEN_CMD sen_set_cmd_info_os02k10_slave(UINT32 addr, UINT32 data_length, UINT32 data0, UINT32 data1)
{
	CTL_SEN_CMD cmd;
...
#if defined(__KERNEL__)
static void sen_load_cfg_from_compatible_os02k10_slave(struct device_node *of_node)
{
...
static ER sen_open_os02k10_slave(CTL_SEN_ID id)
{
	...
	#if defined(__KERNEL__)
	sen_i2c_reg_cb(sen_load_cfg_from_compatible_os02k10_slave);
	#endif
...
static UINT32 sen_get_cmd_tab_os02k10_slave(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	switch (mode) {
	case CTL_SEN_MODE_1:
		*cmd_tab = os02k10_slave_mode_1;
		return sizeof(os02k10_slave_mode_1) / sizeof(CTL_SEN_CMD);
...
static ER sen_chg_mode_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_CHGMODE_OBJ chgmode_obj)
{
	...
	if (is_fastboot[id]) {
		...
		sen_set_chgmode_fps_os02k10_slave(id, isp_builtin_get_chgmode_fps(id));
		sen_set_cur_fps_os02k10_slave(id, isp_builtin_get_chgmode_fps(id));
		sen_set_gain_os02k10_slave(id, &sensor_ctrl);
		sen_set_expt_os02k10_slave(id, &sensor_ctrl);
		#endif
	...
	cmd_num = sen_get_cmd_tab_os02k10_slave(chgmode_obj.mode, &p_cmd_list);
	if (p_cmd_list == NULL) {
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os02k10_slave(id, chgmode_obj.frame_rate);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os02k10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os02k10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
	...
	sen_ext_get_mode_tge_os02k10_slave(&tge_info);

	new_tge_vd_sync = (mode_basic_param[cur_sen_mode[id]].dft_fps) * (tge_info.signal.vd_period) / sen_get_chgmode_fps_os02k10_slave(id) + VD_SYNC - (tge_info.signal.vd_period);
	new_tge_vd =(mode_basic_param[cur_sen_mode[id]].dft_fps) * (tge_info.signal.vd_period) / sen_get_chgmode_fps_os02k10_slave(id);
	...
	for (idx = 0; idx < cmd_num; idx++) {
		if (p_cmd_list[idx].addr == SEN_CMD_DELAY) {
			...
			cmd = sen_set_cmd_info_os02k10_slave(0x380E, 1, (sensor_vd >> 8) & 0xFF, 0x00);
			rt |= sen_write_reg_os02k10_slave(id, &cmd);
			cmd = sen_set_cmd_info_os02k10_slave(0x380F, 1, sensor_vd & 0xFF, 0x00);
			rt |= sen_write_reg_os02k10_slave(id, &cmd);
			cmd = sen_set_cmd_info_os02k10_slave(0x3882, 1, ((sensor_vd - SYNC_DISTANCE) >> 8) & 0xFF, 0x00);
			rt |= sen_write_reg_os02k10_slave(id, &cmd);
			cmd = sen_set_cmd_info_os02k10_slave(0x3883, 1, (sensor_vd - SYNC_DISTANCE) & 0xFF, 0x00);
			rt |= sen_write_reg_os02k10_slave(id, &cmd);
			...
			sen_set_flip_os02k10_slave(id, &flip);
		} else {
			cmd = sen_set_cmd_info_os02k10_slave(p_cmd_list[idx].addr, p_cmd_list[idx].data_len, p_cmd_list[idx].data[0], p_cmd_list[idx].data[1]);
			rt |= sen_write_reg_os02k10_slave(id, &cmd);
		}
	}
	// get otp
	sen_get_otp_os02k10_slave(id);
...
static ER sen_chg_fps_os02k10_slave(CTL_SEN_ID id, UINT32 fps)
{
	...
	if (basic_param.property & CTL_SEN_SUPPORT_PROPERTY_CHGFPS) {
		sensor_vd = sen_calc_chgmode_vd_os02k10_slave(id, fps);
	} else {
		DBG_WRN(" not support fps adjust \r\n");
		sen_set_cur_fps_os02k10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
		sen_set_chgmode_fps_os02k10_slave(id, mode_basic_param[cur_sen_mode[id]].dft_fps);
...
static ER sen_set_info_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_SET_EXPT:
		sen_set_expt_os02k10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_SET_GAIN:
		sen_set_gain_os02k10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		sen_set_flip_os02k10_slave(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE1:
		sen_set_preset_os02k10_slave(id, (ISP_SENSOR_PRESET_CTRL *)(data));
		break;
	default:
		return E_NOSPT;
	}
...
static ER sen_get_info_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
	...
	case CTL_SENDRV_CFGID_GET_EXPT:
		sen_get_expt_os02k10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_GAIN:
		sen_get_gain_os02k10_slave(id, data);
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_BASIC:
		sen_get_attr_basic_os02k10_slave((CTL_SENDRV_GET_ATTR_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_SIGNAL:
		sen_get_attr_signal_os02k10_slave((CTL_SENDRV_GET_ATTR_SIGNAL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_CMDIF:
		rt = sen_get_attr_cmdif_os02k10_slave(id, (CTL_SENDRV_GET_ATTR_CMDIF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_ATTR_IF:
		rt = sen_get_attr_if_os02k10_slave((CTL_SENDRV_GET_ATTR_IF_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_FPS:
		sen_get_fps_os02k10_slave(id, (CTL_SENDRV_GET_FPS_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_SPEED:
		sen_get_speed_os02k10_slave(id, (CTL_SENDRV_GET_SPEED_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_BASIC:
		sen_get_mode_basic_os02k10_slave((CTL_SENDRV_GET_MODE_BASIC_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_MIPI:
		sen_get_mode_mipi_os02k10_slave((CTL_SENDRV_GET_MODE_MIPI_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODESEL:
		sen_get_modesel_os02k10_slave((CTL_SENDRV_GET_MODESEL_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_ROWTIME:
		sen_get_rowtime_os02k10_slave(id, (CTL_SENDRV_GET_MODE_ROWTIME_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_FLIP_TYPE:
		rt = sen_get_flip_os02k10_slave(id, (CTL_SEN_FLIP *)(data));
		break;
	case CTL_SENDRV_CFGID_GET_MODE_TGE:
		sen_ext_get_mode_tge_os02k10_slave((CTL_SENDRV_GET_MODE_TGE_PARAM *)(data));
		break;
	case CTL_SENDRV_CFGID_USER_DEFINE2:
		sen_get_min_expt_os02k10_slave(id, data);
		break;
	default:
		rt = E_NOSPT;
	}
...
static UINT32 sen_calc_chgmode_vd_os02k10_slave(CTL_SEN_ID id, UINT32 fps)
{
	...
	sen_set_chgmode_fps_os02k10_slave(id, fps);
	sen_set_cur_fps_os02k10_slave(id, fps);
...
static void sen_set_gain_os02k10_slave(CTL_SEN_ID id, void *param)
{
	...
	cmd = sen_set_cmd_info_os02k10_slave(0x376C, 1, 0x0, 0x0);
	rt |= sen_read_reg_os02k10_slave(id, &cmd);
	last_hcg_reg1[id] = cmd.data[0];
	cmd = sen_set_cmd_info_os02k10_slave(0x3C55, 1, 0x0, 0x0);
	rt |= sen_read_reg_os02k10_slave(id, &cmd);
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		if ((HCG_ENABLE) && (8000 <= (sensor_ctrl->gain_ratio[frame_cnt]))) {
			...
			temp_gain[frame_cnt] = sensor_ctrl->gain_ratio[frame_cnt] * 256 / hcg_mul;
			hcg_change_flag = 1;
		}
	...
	cmd = sen_set_cmd_info_os02k10_slave(0x320D, 1, 0x0C, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os02k10_slave(0x3208, 1, 0x00, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	// Write sensor gain
	//Set analog gain
	cmd = sen_set_cmd_info_os02k10_slave(0x3508, 1, (data1[0] >> 4) & 0x0F, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x3509, 1, (data1[0] & 0x0F) << 4, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	//Set Digital gain
	cmd = sen_set_cmd_info_os02k10_slave(0x350A, 1, (data2[0] >> 10) & 0x0F, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x350B, 1, (data2[0] >> 2) & 0xFF, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x350C, 1, (data2[0] & 0x03) << 6, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os02k10_slave(0x3208, 1, 0x10, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x3208, 1, 0x01, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os02k10_slave(0x376C, 1, hcg_reg1, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x3C55, 1, hcg_reg2, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os02k10_slave(0x3208, 1, 0x11, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	if ((last_hcg_reg1[id] != hcg_reg1) && (last_hcg_reg2[id] != hcg_reg2)) {
		cmd = sen_set_cmd_info_os02k10_slave(0x320D, 1, 0x05, 0x0);
		rt |= sen_write_reg_os02k10_slave(id, &cmd);
	}

	cmd = sen_set_cmd_info_os02k10_slave(0x3209, 1, 0x01, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x320A, 1, 0x01, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os02k10_slave(0x320E, 1, 0xA0, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
...
static void sen_set_expt_os02k10_slave(CTL_SEN_ID id, void *param)
{
	...
	for (frame_cnt = 0; frame_cnt < total_frame; frame_cnt++) {
		...
		t_row = sen_calc_rowtime_os02k10_slave(id, cur_sen_mode[id]);
		if (0 == t_row) {
	...
	// Write exposure line
	// Get fps
	chgmode_fps = sen_get_chgmode_fps_os02k10_slave(id);
	...
	sen_set_cur_fps_os02k10_slave(id, cur_fps);

	// Calculate new vd
	sensor_vd = sen_calc_exp_vd_os02k10_slave(id, cur_fps);
	...
	cmd = sen_set_cmd_info_os02k10_slave(0x380E, 1, (sensor_vd >> 8) & 0xFF, 0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x380F, 1, sensor_vd & 0xFF, 0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x3882, 1, ((sensor_vd - SYNC_DISTANCE) >> 8) & 0xFF, 0x00);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
	cmd = sen_set_cmd_info_os02k10_slave(0x3883, 1, (sensor_vd - SYNC_DISTANCE) & 0xFF, 0x00);
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		...
		//Avoid first frame over exposure
		cmd = sen_set_cmd_info_os02k10_slave(0x0100, 1, 0x0, 0x0);
		rt |= sen_read_reg_os02k10_slave(id, &cmd);
		...
		cmd = sen_set_cmd_info_os02k10_slave(0x3501, 1, (line[0] >> 8) & 0xFF, 0);
		rt |= sen_write_reg_os02k10_slave(id, &cmd);
		cmd = sen_set_cmd_info_os02k10_slave(0x3502, 1, line[0] & 0xFF , 0);
		rt |= sen_write_reg_os02k10_slave(id, &cmd);
	}
...
{
	CTL_SEN_CMD cmd;
	UINT32 temp_reg0 = 0, temp_reg1 = 0;
	ER rt = E_OK;

	cmd = sen_set_cmd_info_os02k10_slave(0x3820, 1, 0x0, 0x0);
	rt |= sen_read_reg_os02k10_slave(id, &cmd);
	...
	cmd = sen_set_cmd_info_os02k10_slave(0x3820, 1, temp_reg0, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);

	cmd = sen_set_cmd_info_os02k10_slave(0x3813, 1, temp_reg1, 0x0);
	rt |= sen_write_reg_os02k10_slave(id, &cmd);
...
static ER sen_get_otp_os02k10_slave(CTL_SEN_ID id)
{
	...
	cmd = sen_set_cmd_info_os02k10_slave(0x73fe, 1, 0x00, 0x0);
	rt |= sen_read_reg_os02k10_slave(id, &cmd);
	info[id].OTP = cmd.data[0] * 256;
	cmd = sen_set_cmd_info_os02k10_slave(0x73ff, 1, 0x00, 0x0);
	rt |= sen_read_reg_os02k10_slave(id, &cmd);
	info[id].OTP = info[id].OTP + cmd.data[0];
...
static void sen_get_fps_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_FPS_PARAM *data)
{
	data->cur_fps = sen_get_cur_fps_os02k10_slave(id);
	data->chg_fps = sen_get_chgmode_fps_os02k10_slave(id);
}
...
static void sen_ext_get_mode_tge_os02k10_slave(CTL_SENDRV_GET_MODE_TGE_PARAM *data)
{
	...
	data->signal.hd_period = 640;//711;
	data->signal.vd_sync = VD_SYNC;
	data->signal.vd_period = 1250;//1125;
}
...
static void sen_get_rowtime_os02k10_slave(CTL_SEN_ID id, CTL_SENDRV_GET_MODE_ROWTIME_PARAM *data)
{
	data->row_time_step = sen_calc_rowtime_step_os02k10_slave(id, data->mode);
	data->row_time = sen_calc_rowtime_os02k10_slave(id, data->mode) * (data->row_time_step);
}
...
#if defined(__FREERTOS)
void sen_get_i2c_id_os02k10_slave(CTL_SEN_ID id, UINT32 *i2c_id)
{
	*i2c_id = sen_i2c[id].id;
}

void sen_get_i2c_addr_os02k10_slave(CTL_SEN_ID id, UINT32 *i2c_addr)
{
	*i2c_addr = sen_i2c[id].addr;
}

int sen_init_os02k10_slave(SENSOR_DTSI_INFO *info)
{
	...
	sprintf(compatible, "nvt,sen_os02k10_slave");
	if (sen_common_check_compatible(compatible)) {
		...
		sprintf(node_path, "/sensor/sen_cfg/sen_os02k10_slave");
	...
	reg_obj.pwr_ctrl = sen_pwr_ctrl_os02k10_slave;
	reg_obj.det_plug_in = NULL;
	reg_obj.drv_tab = sen_get_drv_tab_os02k10_slave();
	rt = ctl_sen_reg_sendrv("nvt_sen_os02k10_slave", &reg_obj);
	if (rt != E_OK) {
...
void sen_exit_os02k10_slave(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_os02k10_slave");
}

#else
static int __init sen_init_os02k10_slave(void)
{
...
static void __exit sen_exit_os02k10_slave(void)
{
	ctl_sen_unreg_sendrv("nvt_sen_os02k10_slave");
}

module_init(sen_init_os02k10_slave);
module_exit(sen_exit_os02k10_slave);

MODULE_AUTHOR("Novatek Corp.");
MODULE_DESCRIPTION(SEN_OS02K10_SLAVE_MODULE_NAME);
MODULE_LICENSE("GPL");
#endif
