...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os02k10, 1, 51, 000, 00);

//=============================================================================
// information
//=============================================================================
#define SEN_OS02K10_MODULE_NAME     "sen_os02k10"
#define SEN_MAX_MODE               7
...
static ER sen_get_otp_os02k10(CTL_SEN_ID id);
//=============================================================================
// global variable
//=============================================================================
...
//1928x1084 30FPS 10bit hdr mode 2lane 1296Mbps
...
//1928x1084 30FPS 10bit hdr mode 4lane 648Mbps
...
static CTL_SEN_CMD os02k10_mode_6[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
	...
	{0x380a, 1, {0x04, 0x0}},
	{0x380b, 1, {0x38, 0x0}},
	{0x380c, 1, {0x09, 0x0}},//HTS
	{0x380d, 1, {0x90, 0x0}},
	{0x380e, 1, {0x05, 0x0}},//VTS
	{0x380f, 1, {0xb4, 0x0}},
	{0x3811, 1, {0x08, 0x0}},
	{0x3813, 1, {0x04, 0x0}},
	{0x3814, 1, {0x01, 0x0}},
...
//1928x1088_linearLCG_30fps_10b_504Mbps
static CTL_SEN_CMD os02k10_mode_7[] = {
	{0x302a, 1, {0x00, 0x0}},
	{0x0103, 1, {0x01, 0x0}},
	{0x0109, 1, {0x01, 0x0}},
	{0x0104, 1, {0x02, 0x0}},
	...
	{0x380a, 1, {0x04, 0x0}},
	{0x380b, 1, {0x38, 0x0}},
	{0x380c, 1, {0x0b, 0x0}},//;02
	{0x380d, 1, {0x40, 0x0}},//;d0
	{0x380e, 1, {0x04, 0x0}},
	{0x380f, 1, {0xe2, 0x0}},
	{0x3811, 1, {0x08, 0x0}},
	{0x3813, 1, {0x04, 0x0}},
	...
	//;;
	{0x3800, 1, {0x00, 0x0}},
	{0x3801, 1, {0x00, 0x0}},//;FC
	{0x3802, 1, {0x00, 0x0}},
	{0x3803, 1, {0x00, 0x0}},
	{0x3804, 1, {0x07, 0x0}},
	{0x3805, 1, {0x8f, 0x0}},//;93
	{0x3806, 1, {0x04, 0x0}},
	{0x3807, 1, {0x47, 0x0}},
	{0x3808, 1, {0x07, 0x0}},
	{0x3809, 1, {0x88, 0x0}},
...
static UINT32 sen_get_cmd_tab_os02k10(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_6:
		*cmd_tab = os02k10_mode_6;
		return sizeof(os02k10_mode_6) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_7:
		*cmd_tab = os02k10_mode_7;
		return sizeof(os02k10_mode_7) / sizeof(CTL_SEN_CMD);
...
static void sen_set_gain_os02k10(CTL_SEN_ID id, void *param)
{
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_BUILTIN_HDR) {
		...
		sensor_ctrl->gain_ratio[0] = sensor_ctrl->gain_ratio[0] * 4;
	...
	if (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) {
		...
		cmd = sen_set_cmd_info_os02k10(0x320D, 1, 0x0C, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		...
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0x01, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		...
		cmd = sen_set_cmd_info_os02k10(0x3208, 1, 0x11, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);

		if ((last_hcg_reg1[id] != hcg_reg1) && (last_hcg_reg2[id] != hcg_reg2)) {
			cmd = sen_set_cmd_info_os02k10(0x320D, 1, 0x05, 0x0);
			rt |= sen_write_reg_os02k10(id, &cmd);
		}

		cmd = sen_set_cmd_info_os02k10(0x3209, 1, 0x01, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
		cmd = sen_set_cmd_info_os02k10(0x320A, 1, 0x01, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);

		cmd = sen_set_cmd_info_os02k10(0x320E, 1, 0xA0, 0x0);
		rt |= sen_write_reg_os02k10(id, &cmd);
...
static void sen_set_expt_os02k10(CTL_SEN_ID id, void *param)
{
	...
	if ((mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_LINEAR) || (mode_basic_param[cur_sen_mode[id]].mode_type == CTL_SEN_MODE_BUILTIN_HDR)) {
		...
		cmd = sen_set_cmd_info_os02k10(0x0100, 1, 0x0, 0x0);
		rt |= sen_read_reg_os02k10(id, &cmd);
...
static ER sen_get_otp_os02k10(CTL_SEN_ID id)
{
	...
	cmd = sen_set_cmd_info_os02k10(0x73fe, 1, 0x00, 0x0);
	rt |= sen_read_reg_os02k10(id, &cmd);
	info[id].OTP = cmd.data[0] * 256;
	cmd = sen_set_cmd_info_os02k10(0x73ff, 1, 0x00, 0x0);
	rt |= sen_read_reg_os02k10(id, &cmd);
