...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_os08b10, 1, 53, 000, 00);
...
static CTL_SEN_CMD os08b10_mode_4[] = {
	//@@ 0 80 OS08B10 4lane 1924x1084 RGBBin2 LinearHCG 30fps 
	//100 99 1924 1084
	//100 98 1 0
	//102 3601 2ee0 ;Pather tool use only
	//102 3f00 0
	//102 999 1 ;vc en
	//102 96f 8 ; header offset
	//102 9fe 1 ;num vc
	//102 9c1 784  ;VC0 Hsize
	//102 9c5 43C  ;VC0 Vsize
	//102 9de 0 ; plugin en 0 off, 1 on
	//110 40 0
	//102 670 32
	//; Sensor revision: OS08B10
	//; Input clock frequency: 24MHz
	//; Image output size 1924 x 1084
	//; Image crop size: 1924 x 1084
	//; Pixel data format:  LINER 10BIT
	//; Frame timing and frame rate: 30fps
	//; System clock frequency: 48MHz
	//; Output interface and data rate: MIPI 4Lane, 1416Mbps
	//; HTS = 380c/d = 0x2D0
	//; VTS = 380e/f = 0x8A4
	//; Tline = 15 us
	{0x0100, 1, {0x00, 0x0}},
...
static CTL_SEN_CMD os08b10_mode_5[] = {
	//@@ 0 90 OS08B10 4lane 1924x1084 2Stagger HDR 30fps 
	//100 99 1924 1084
	//100 98 1 0
	...
	//102 9c1 784  ;VC0 Hsize
	//102 9c5 43c  ;VC0 Vsize
	//102 9c2 784  ;VC1 Hsize
	//102 9c6 43c  ;VC1 Vsize
	//102 9de 0 ; plugin en 0 off, 1 on
	//110 40 0
	//102 670 32
	//; Sensor revision: OS08B10
	...
	//; Image output size 1924 x 1084
	//; Image crop size: 1924 x 1084
	//; Pixel data format:  2 stagger HDR
	//; Frame timing and frame rate: 30fps
	//; System clock frequency: 48MHz
	//; Output interface and data rate: MIPI 4Lane, 1416Mbps
	//; HTS = 380c/d = 0x2D0
...
static UINT32 sen_get_cmd_tab_os08b10(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_4:
		*cmd_tab = os08b10_mode_4;
		return sizeof(os08b10_mode_4) / sizeof(CTL_SEN_CMD);

	case CTL_SEN_MODE_5:
		*cmd_tab = os08b10_mode_5;
		return sizeof(os08b10_mode_5) / sizeof(CTL_SEN_CMD);
