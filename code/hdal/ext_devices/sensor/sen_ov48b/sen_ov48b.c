...
// version
//=============================================================================
VOS_MODULE_VERSION(nvt_sen_ov48b, 1, 45, 000, 00);
...
static CTL_SENDRV_GET_MODE_BASIC_PARAM mode_basic_param[SEN_MAX_MODE] = {
	...
	},
	{
		...
		CTL_SEN_FMT_POGRESSIVE,
		{7680, 4322},
		{{0, 2, 7680, 4320}, {0, 0, 960, 1080}, {0, 0, 0, 0}, {0, 0, 0, 0}},
		{7680, 4320},
		{0, 8640, 0, 6666},
		CTL_SEN_RATIO(16, 9),
		{1000, 247845},
...
static CTL_SEN_CMD ov48b_mode_3[] = {
	//;INITIAL
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x0102, 1, {0x01, 0x0}},
	...
	{0x3827, 1, {0x04, 0x0}},
	//@@ FPS = 2
	{0x380c, 1, {0x21, 0x0}},//;04
	{0x380d, 1, {0xc0, 0x0}},//;80
	//@@ MIPI 1392Mbps
	{0x0304, 1, {0x01, 0x0}},  //; ;00;00
	{0x0305, 1, {0x22, 0x0}},  //; ;fa;7c
	{0x4837, 1, {0x0b, 0x0}},  //; ;0d;18
...
static CTL_SEN_CMD ov48b_mode_4[] = {
	//;INITIAL
	{0x0103, 1, {0x01, 0x0}},
	{0x0100, 1, {0x00, 0x0}},
	{0x0102, 1, {0x01, 0x0}},
...
static UINT32 sen_get_cmd_tab_ov48b(CTL_SEN_MODE mode, CTL_SEN_CMD **cmd_tab)
{
	...
	case CTL_SEN_MODE_3:
		*cmd_tab = ov48b_mode_3;
		return sizeof(ov48b_mode_3) / sizeof(CTL_SEN_CMD);		

	case CTL_SEN_MODE_4:
		*cmd_tab = ov48b_mode_4;
		return sizeof(ov48b_mode_4) / sizeof(CTL_SEN_CMD);	
...
static void sen_get_modesel_ov48b(CTL_SENDRV_GET_MODESEL_PARAM *data)
{
	...
	if (CTL_SEN_DATALANE_2 == (data->data_lane)) {   
		if (data->frame_num == 2) {
			if ((data->size.w <= 7680) && (data->size.h <= 4320)) {
				if (data->frame_rate <= 200) {
