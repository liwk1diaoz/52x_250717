...
static DISPDEV_OBJ     disp_dev_ifparal_obj = { dispdev_open_ifparal, dispdev_close_ifparal, dispdev_set_device_rotate, dispdev_write_lcd_reg, dispdev_read_lcd_reg, dispdev_get_lcd_size, dispdev_set_ifparal_ioctrl, {NULL, NULL} };
static volatile DISPDEV_IOCTRL  p_if_paral_io_control1;
#elif (DISPLCDSEL_IFPARAL_TYPE == DISPLCDSEL_IFPARAL_LCD2)
static DISPDEV_OBJ     disp_dev_ifparal_obj2 = { dispdev_open_ifparal, dispdev_close_ifparal, dispdev_set_device_rotate, dispdev_write_lcd_reg, dispdev_read_lcd_reg, dispdev_get_lcd_size, dispdev_set_ifparal_ioctrl, {NULL, NULL}};
	...
	if (lcd_mode == PINMUX_LCDMODE_CCIR656) {
		...
		*/
		...
		if (p_mode->ide.interlace == TRUE) {
			...
			ui_odd_start = p_mode->panel.ui_vsync_active_period + p_mode->panel.ui_vsync_back_porch_even + p_mode->panel.ui_vsync_total_period;
		}
		...
		if (p_mode->ide.interlace == TRUE) {
			...
			if (p_mode->panel.ui_hsync_back_porch == 0) { //special case
				...
				dev_io_ctrl.SEL.SET_CCIR656_SYNCCODE.ui_odd_end      = (p_mode->panel.ui_vsync_back_porch_odd) - 1; //=p_mode.panel.ui_vsync_back_porch_odd / 2
				dev_io_ctrl.SEL.SET_CCIR656_SYNCCODE.ui_even_start   = (p_mode->panel.ui_vsync_active_period) + (p_mode->panel.ui_vsync_back_porch_odd) - 1;   //=p_mode.panel.ui_vsync_active_period / 2 + p_mode.panel.ui_vsync_back_porch_odd / 2
