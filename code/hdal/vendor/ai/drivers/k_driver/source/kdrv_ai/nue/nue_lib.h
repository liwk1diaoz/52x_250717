...
#define NUE_INTE_ALL                    0x001f0311
#define NUE_INTE_RUNLL                  0x001e0300
//@}
...
/**
    NUE clamp parameters
*/
//@{
typedef struct _NUE_CLAMP_PARM {
	UINT32 clamp_th_0;
	UINT32 clamp_th_1;
} NUE_CLAMP_PARM;
//@}
