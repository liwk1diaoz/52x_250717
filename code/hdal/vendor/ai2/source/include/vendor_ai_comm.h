...
typedef struct _NN_MODEL_INFO {
    UINT64 nvt_mode_bin_filesize;
    UINT64 diff_bin_filesize;
} NN_MODEL_INFO;
...
typedef struct _VENDOR_AI_DIFF_MODEL_RESINFO {
    ...
    VENDOR_AI_NET_CFG_MODEL share_diff_model; ///< share different model bin
    VENDOR_AI_NET_CFG_MODEL output_info;      ///< output info to be updated
