...
/**
	@name struct of rbuf memory
*/
typedef struct _VENDOR_AI_NET_CFG_RONLYBUF {
	UINT32 pa;                              ///< physical address
	UINT32 va;                              ///< virtual address
	UINT32 size;                            ///< buffer size
} VENDOR_AI_NET_CFG_RONLYBUF;
...
typedef enum _VENDOR_AI_NET_PARAM_ID {
	...
	VENDOR_AI_NET_PARAM_CFG_RONLYBUF            = 40, ///< get	  , set read only memory, using VENDOR_AI_NET_CFG_RONLYBUF struct
    ...
    VENDOR_AI_NET_PARAM_BATCH_ID_IMM            = 49, ///< set/get, set batch number by id, using UINT32
    VENDOR_AI_NET_PARAM_BATCH_N_IMM             = 50, ///< set/get, set batch number, using UINT32
