...
#define NN_USER_HEAP            1
#define NET_DBG_HEAP			1  //set 1 => use global
#define NET_FD_HEAP				1  //set 1 => use global
#define NET_GEN_HEAP			1  //set 1 => merge to INFO_PROC struct
#define NET_GRP_HEAP			1  //set 1 => merge to INFO_PROC struct
#define NET_TASK_HEAP			1  //set 1 => merge toINFO_PROC struct

#define NET_OPEN_HEAP			1  //set 1 => INFO_PROC struct will be malloc at open, free at close

#define NET_TABLE_HEAP			1
