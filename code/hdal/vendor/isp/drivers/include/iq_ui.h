...
typedef enum _IQ_UI_ITEM {
	...
	IQ_UI_ITEM_GAMMA_LV,                ///<Gamma level, data type #IQ_UI_GAMMA_LV
	IQ_UI_ITEM_MAX_CNT,
	ENUM_DUMMY4WORD(IQ_UI_ITEM)
} IQ_UI_ITEM;
...
/**
	Gamma
*/
typedef enum _IQ_UI_GAMMA_LV {
	IQ_UI_GAMMA_LV_N1       = 25,     ///< GAMMA 25
	IQ_UI_GAMMA_LV_NORMAL   = 50,     ///< GAMMA 50
	IQ_UI_GAMMA_LV_P1       = 75,     ///< GAMMA 75
	IQ_UI_GAMMA_LV_MAX_CNT  = 101,
	ENUM_DUMMY4WORD(IQ_UI_GAMMA_LV)
} IQ_UI_GAMMA_LV;
