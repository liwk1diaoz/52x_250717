...
#define IQ_3DNR_F3_NUM 3
#define IQ_3DNR_F4_TH_NUM 4
...
typedef enum _IQ_COLOR_EXT2_ID {
	IQ_COLOR_EXT2_TEMPERATURE_0 = 0,
	IQ_COLOR_EXT2_TEMPERATURE_1,
	IQ_COLOR_EXT2_TEMPERATURE_2,
	IQ_COLOR_EXT2_TEMPERATURE_3,
	IQ_COLOR_EXT2_TEMPERATURE_4,
	IQ_COLOR_EXT2_ID_MAX_NUM,
	ENUM_DUMMY4WORD(IQ_COLOR_EXT2_ID)
} IQ_COLOR_EXT2_ID;
...
typedef enum _IQ_GAMMA_EXT_SEL {
	IQ_GAMMA_EXT_OFF = 0,
	IQ_GAMMA_EXT_BY_GAMMA_LV,
	IQ_GAMMA_EXT_BY_AE_LV,
	ENUM_DUMMY4WORD(IQ_GAMMA_EXT_SEL)
} IQ_GAMMA_EXT_SEL;

typedef enum _IQ_GAMMA_EXT_ID {
	IQ_GAMMA_EXT_SET0 = 0,
	IQ_GAMMA_EXT_SET1,
	IQ_GAMMA_EXT_SET2,
	IQ_GAMMA_EXT_SET3,
	IQ_GAMMA_EXT_SET4,
	IQ_GAMMA_EXT_ID_MAX_NUM,
	ENUM_DUMMY4WORD(IQ_GAMMA_EXT_ID)
} IQ_GAMMA_EXT_ID;
...
typedef struct _IQ_GAMMA_EXT_AUTO_PARAM {
	UINT32 lv;                                                        ///< range : 0~20
	UINT32 gamma_level;                                               ///< range : 0~100
} IQ_GAMMA_EXT_AUTO_PARAM;

typedef struct _IQ_GAMMA_EXT_PARAM {
	IQ_GAMMA_EXT_SEL ext_sel;
	UINT32 gamma_set0_lv;                                             ///< range : 0~100
	UINT32 gamma_set0_lut[IQ_GAMMA_GAMMA_LEN];                        ///< range : 0~1023, gamma input, table size: 129
	UINT32 gamma_set1_lv;                                             ///< range : 0~100
	UINT32 gamma_set1_lut[IQ_GAMMA_GAMMA_LEN];                        ///< range : 0~1023, gamma input, table size: 129
	UINT32 gamma_set2_lv;                                             ///< range : 0~100
	UINT32 gamma_set2_lut[IQ_GAMMA_GAMMA_LEN];                        ///< range : 0~1023, gamma input, table size: 129
	UINT32 gamma_set3_lv;                                             ///< range : 0~100
	UINT32 gamma_set3_lut[IQ_GAMMA_GAMMA_LEN];                        ///< range : 0~1023, gamma input, table size: 129
	UINT32 gamma_set4_lv;                                             ///< range : 0~100
	UINT32 gamma_set4_lut[IQ_GAMMA_GAMMA_LEN];                        ///< range : 0~1023, gamma input, table size: 129
	IQ_GAMMA_EXT_AUTO_PARAM auto_param[IQ_GAMMA_EXT_ID_MAX_NUM];
} IQ_GAMMA_EXT_PARAM;
...
typedef struct _IQ_CCM_EXT_MANUAL_PARAM {
	INT32 int_tab[IQ_CCM_INTTAB_LEN];           ///< range : -128~127, color control int adjust table, 0 : NO int adjust, -128 : Min int suppress, 127 : Max int enhance, table size: 24
} IQ_CCM_EXT_MANUAL_PARAM;

typedef struct _IQ_CCM_EXT_AUTO_PARAM {
	INT32 int_tab[IQ_CCM_INTTAB_LEN];           ///< range : -128~127, color control int adjust table, 0 : NO int adjust, -128 : Min int suppress, 127 : Max int enhance, table size: 24
} IQ_CCM_EXT_AUTO_PARAM;

typedef struct _IQ_CCM_EXT_PARAM {
	IQ_CCM_EXT_MANUAL_PARAM manual_param;
	IQ_CCM_EXT_AUTO_PARAM auto_param[IQ_COLOR_ID_MAX_NUM];
} IQ_CCM_EXT_PARAM;

typedef struct _IQ_CCM_EXT2_AUTO_PARAM {
	UINT32 ct;                                  ///< range : 1000~12000
	INT16 coef[IQ_CCM_LEN];                     ///< range : -1024~1023, 1X = 256, Color correction matrix [rr rg rb gr gg gb br bg bb], table size: 9
	UINT8 hue_tab[IQ_CCM_HUETAB_LEN];           ///< range : 0~255, color control hue adjust table, 128 : NO hue adjust, table size: 24
	INT32 sat_tab[IQ_CCM_SATTAB_LEN];           ///< range : -128~127, color control sat adjust table, 0 : NO sat adjust, -128 : Min sat suppress, 127 : Max sat enhance, table size: 24
	INT32 int_tab[IQ_CCM_INTTAB_LEN];           ///< range : -128~127, color control int adjust table, 0 : NO int adjust, -128 : Min int suppress, 127 : Max int enhance, table size: 24
} IQ_CCM_EXT2_AUTO_PARAM;

typedef struct _IQ_CCM_EXT2_PARAM {
	BOOL enable;                                ///< enable function
	IQ_CCM_EXT2_AUTO_PARAM auto_param[IQ_COLOR_EXT2_ID_MAX_NUM];
} IQ_CCM_EXT2_PARAM;
...
typedef struct _IQ_EDGE_TUNE_PARAM {
	...
	UINT32 th_flat;                             ///< range : 0~1023, the threshold for flat region
	UINT32 th_edge;                             ///< range : 0~1023, the threshold for edge region
...
typedef struct _IQ_EDGE_REGION_TUNE_PARAM {
	UINT8 str_flat;                             ///< range : 0~64, Strength for flat region, 64 = 1x
	UINT8 str_edge;                             ///< range : 64~255, Strength for edge region, 64 = 1x
	UINT32 th_flat_low;                         ///< range : 0~1023, the low threshold for flat region
	UINT32 th_edge_high;                        ///< range : 0~1023, the high threshold for edge region
} IQ_EDGE_REGION_TUNE_PARAM;

typedef struct _IQ_EDGE_REGION_PARAM {
	IQ_EDGE_REGION_TUNE_PARAM manual_param;
	IQ_EDGE_REGION_TUNE_PARAM auto_param[IQ_GAIN_ID_MAX_NUM];
...
typedef struct _IQ_3DNR_TUNE_PARAM {
	...
	UINT32 mix_ratio[IQ_3DNR_NODE_NUM];         ///< range : 0~255, Mix ratio in patch selection
	UINT32 ds_th;                               ///< range : 0~31, Threshold of motion status down-sampling
	UINT32 luma_residue_th;                     ///< range : 0~255, Protection threshold of luma channel
	UINT32 chroma_residue_th;                   ///< reserved, useless
	...
	UINT32 snr_str[IQ_3DNR_F3_NUM];             ///< range : 0~255, 1X = 64, Strength of spatial filter for still object
	UINT32 tnr_str[IQ_3DNR_F3_NUM];             ///< range : 0~255, 1X = 64, Strength of temporal filter for still object
	UINT32 luma_3d_th[IQ_3DNR_F4_TH_NUM];       ///< range : 0~63, Noise reduction threshold for luma channel
...
typedef struct _IQ_EXPAND_DPC_PARAM {
	...
	UINT32 table_phyaddr;                       ///< dpc physical address
} IQ_EXPAND_DPC_PARAM;
...
typedef struct _IQ_PFR_PARAM {
	BOOL enable;                                ///< enable function
	IQ_OP_TYPE mode;
	UINT32 luma_lut[IQ_PFR_LUMA_LEN];           ///< range : 0~255, PFR luminance level control table
...
typedef struct _IQ_SHDR_PARAM {
	...
	IQ_OP_TYPE mode;
	UINT8 fusion_ev_ratio;                                     ///< range : 16~255, 4EV=16, 3EV = 32, 2EV=64, 1EV=128;
...
typedef struct _IQ_POST_3DNR_TUNE_PARAM {
	UINT8 nr_3d_adp_th_p2p[IQ_POST_3DNR_TH_NUM];                       ///< range: 0 ~ 255, codec tnr p2p sad threshold
	UINT8 nr_3d_adp_weight_p2p[IQ_POST_3DNR_TH_NUM];                   ///< range: 0 ~ 16, codec tnr p2p weight
	UINT8 tnr_p2p_border_check_th;                                     ///< range: 0 ~ 255, codec tnr p2p border check threshold
	UINT8 cur_p2p_mctf_motion_th;                                      ///< range: 0 ~ 255, codec tnr p2p mctf current motion threshold
	UINT8 ref_p2p_mctf_motion_th;                                      ///< range: 0 ~ 255, codec tnr p2p mctf reference motion threshold
	UINT8 nr3d_temporal_spatial_y[IQ_POST_3DNR_FRAME_W_NUM];           ///< range: 0 ~ 7, codec tnr p2p reference luma spatial
	UINT8 nr3d_temporal_spatial_c[IQ_POST_3DNR_FRAME_W_NUM];           ///< range: 0 ~ 7, codec tnr p2p reference chroma spatial
	UINT8 nr3d_temporal_range_y[IQ_POST_3DNR_RANGE_W_NUM];             ///< range: 0 ~ 255, codec tnr p2p luma range
	UINT8 nr3d_temporal_range_c[IQ_POST_3DNR_RANGE_W_NUM];             ///< range: 0 ~ 255, codec tnr p2p chroma range
	UINT8 nr3d_temporal_spatial_y_mctf[IQ_POST_3DNR_FRAME_W_NUM];      ///< range: 0 ~ 7, codec tnr mctf reference luma spatial
	UINT8 nr3d_temporal_spatial_c_mctf[IQ_POST_3DNR_FRAME_W_NUM];      ///< range: 0 ~ 7, codec tnr mctf reference chroma spatial
	UINT8 nr3d_temporal_range_y_mctf[IQ_POST_3DNR_RANGE_W_NUM];        ///< range: 0 ~ 255, codec tnr mctf luma range
	UINT8 nr3d_temporal_range_c_mctf[IQ_POST_3DNR_RANGE_W_NUM];        ///< range: 0 ~ 255, codec tnr mctf chroma range
} IQ_POST_3DNR_TUNE_PARAM;

typedef struct _IQ_POST_3DNR_PARAM {
	BOOL enable;                                        ///< enable function
	IQ_OP_TYPE mode;
	BOOL mctf_p2p_pixel_blending;                       ///< codec tnr blending enable
	IQ_POST_3DNR_TUNE_PARAM manual_param;
	IQ_POST_3DNR_TUNE_PARAM auto_param[IQ_GAIN_ID_MAX_NUM];
} IQ_POST_3DNR_PARAM;
...
typedef struct _IQ_PARAM_PTR {
	...
	IQ_LDC_PARAM                     *ldc;
	IQ_EDGE_REGION_PARAM             *edge_region;
	IQ_CCM_EXT_PARAM                 *ccm_ext;
	IQ_GAMMA_EXT_PARAM               *gamma_ext;
