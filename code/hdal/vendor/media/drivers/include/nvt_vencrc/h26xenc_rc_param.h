...
typedef struct _H26XEncRCInitInfo
{
	...
	unsigned int br_tolerance;
    int      active_qp;
	unsigned int max_frame_size;
	int still_dqp;
	char evbr_state_char;	// 'm': motion state, 's': still state
