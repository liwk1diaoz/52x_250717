...
int nvt_ive_drv_ioctl(unsigned char ucIF, MODULE_INFO* pmodule_info, unsigned int uiCmd, unsigned long ulArg)
{
	...
	switch(uiCmd) {
		...
		// OPEN
		case IVE_IOC_OPEN:
			iRet = kdrv_ive_open(0, 0);
			break;
		// CLOSE
		case IVE_IOC_CLOSE:
			iRet = kdrv_ive_close(0, 0);
			break;
		// OPENCFG
		case IVE_IOC_OPENCFG:
			...
			iRet = kdrv_ive_set(0, KDRV_IVE_PARAM_IPL_OPENCFG, &ive_cfg_data);
			break;
		// INPUT IMG INFO
		case IVE_IOC_SET_IMG_INFO:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IPL_IN_IMG, &ive_imginfo_data);
			break;
		...
		case IVE_IOC_SET_IMG_DMA_IN:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IPL_IMG_DMA_IN, &ive_input_addr);
			break;
		...
		case IVE_IOC_SET_IMG_DMA_OUT:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IPL_IMG_DMA_OUT, &ive_output_addr);
			break;
		...
		case IVE_IOC_SET_GENERAL_FILTER:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_GENERAL_FILTER, &ive_general_filter_data);
			break;
		...
		case IVE_IOC_SET_MEDIAN_FILTER:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_MEDIAN_FILTER, &ive_median_filter_data);
			break;
		...
		case IVE_IOC_SET_EDGE_FILTER:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_EDGE_FILTER, &ive_edge_filter_data);
			break;
		...
		case IVE_IOC_SET_NON_MAX_SUP:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_NON_MAX_SUP, &ive_non_max_sup_data);
			break;
		...
		case IVE_IOC_SET_THRES_LUT:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_THRES_LUT, &ive_thres_lut_data);
			break;
		...
		case IVE_IOC_SET_MORPH_FILTER:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_MORPH_FILTER, &ive_morph_filter_data);
			break;
		...
		case IVE_IOC_SET_INTEGRAL_IMG:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_INTEGRAL_IMG, &ive_integral_img_data);
			break;
		...
		case IVE_IOC_TRIGGER:
			...
			iRet = kdrv_ive_trigger(id, &ive_trigger_param, NULL, NULL);
			break;
		// trigger engine
		...
		case IVE_IOC_SET_OUTSEL:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IQ_OUTSEL, &ive_outsel_data);
            break;
		...
		case IVE_IOC_SET_IRV:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_IRV, &ive_irv_data);
			break;
		...
		case IVE_IOC_SET_FLOWCT:
			...
			iRet = kdrv_ive_set(id, KDRV_IVE_PARAM_FLOWCT, &ive_flowct_data);
			break;
