...
UINT32 dis_freq_from_dtsi[MODULE_CLK_NUM];
//=============================================================================
// Global variable
//=============================================================================
...
static int nvt_dis_probe(struct platform_device *p_dev)
{
	...
	if(of_property_read_u32_array(p_dev->dev.of_node, "clock-frequency", dis_freq_from_dtsi, MODULE_CLK_NUM)){
...
MODULE_LICENSE("GPL");
VOS_MODULE_VERSION(kdrv_dis, major, minor, bugfix, ext);
