...
#define IVE_IOREMAP_IN_KERNEL 0
...
/*!
 * @fn INT32 kdrv_ive_trigger_with_hook(UINT32 id,	KDRV_IVE_TRIGGER_PARAM *p_param, KDRV_CALLBACK_FUNC *p_cb_func, VOID *p_user_data)
 * @brief trigger hardware engine (hook function is for verifying)
 * @param id	the id of hardware
 * @param p_param	the parameter for trigger
 * @param p_cb_func	the callback function
 * @param p_user_data	the private user data
