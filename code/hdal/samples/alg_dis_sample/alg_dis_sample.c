...
#define MAIN(argc, argv) 		EXAMFUNC_ENTRY(alg_dis_sample, argc, argv)
...
MAIN(argc, argv)
{
    ...
    //get dis version
    nvt_dis_get_alg_version(dis_version);
    printf("dis_alg_version: %s\n", dis_version);

	vendor_dis_get_vendor_version(dis_version);
	printf("dis_vendor_version: %s\n", dis_version);

	vendor_dis_get_kdrv_version(dis_version);
	printf("dis_kdrv_version: %s\n", dis_version);
