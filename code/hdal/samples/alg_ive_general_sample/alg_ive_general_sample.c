...
MAIN(argc, argv)
{
	...
	UINT32 general_filter_coef[VENDOR_IVE_GEN_FILT_NUM] ={ 15,12,9,5,4,2,0,0,0,0 }; //{c0,c1,c2,c3,c4,c5,c6,c7,c8,c9} NOTE:COEF range=0~15
	...
	ive_input_info.width = 176;
	ive_input_info.height = 144;
	ive_input_info.lineofst = 176;
	out_lofs = 176;
	out_selection =2;
