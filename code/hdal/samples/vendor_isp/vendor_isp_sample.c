...
int main(int argc, char *argv[])
{
	...
	while (trig) {
			...
			printf("  38. Get lv \n");
			printf("  39. Get ct \n");
			printf("  40. Get ca enable \n");
			printf("  41. Get la enable \n");
			...
			printf("  88. Set lv \n");
			printf("  89. Set ct \n");
			printf("  90. Set ca enable \n");
			printf("  91. Set la enable \n");
			printf("----------------------------------------\n");
			printf("- ONLY NT98528 -------------------------\n");
			printf("----------------------------------------\n");
		...
		case 40:
			printf("Set isp id (0, 1)>> \n");
			ca_enable.id = (UINT32)get_choose_int();
		...
		case 41:
			printf("Set isp id (0, 1)>> \n");
			la_enable.id = (UINT32)get_choose_int();
