...
typedef struct _HD_VIDEOENC_BS3 {
	...
	INT32 blk2;                         ///< [r]memory block 2
	UINT32 motion_ratio;                ///< [r]Encode motion ratio
	UINT32 *sha_chksum;                 ///< [r]Sha256 checksum array, user should alloc this buffer. Buffer size = sizeof(UINT32) * sha_chksum_num
	UINT32 sha_chksum_num;              ///< [w]Sha256 checksum array number, user provide how many number of UINT32 are valid in sha_chksum buffer.
} HD_VIDEOENC_BS3;
