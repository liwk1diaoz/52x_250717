...
#ifdef VDOENC_LL
typedef void (*MEDIAREC_OSDMASKCB)(UINT32 path_id, UINT32 isDo);
#endif
...
typedef KDRV_VDOENC_FRM_CROP_INFO MP_VDOENC_FRM_CROP_INFO;

typedef KDRV_VDOENC_MAQDIFF MP_VDOENC_MAQDIFF;
...
typedef KDRV_VDOENC_OSDMASKCB MP_VDOENC_OSDMASKCB;
#endif
/**
    Init structure
*/
