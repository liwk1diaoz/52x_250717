...
typedef struct _VDOPRC_OUT_QUEUE {
	...
	UINT32 force_twobuffer[ISF_VDOPRC_OUT_NUM];
#endif
#if _TODO
//for Notify
	UINT32 trigdata_id;
...
//output queue
	...
	UINT32 dis_addr_align[ISF_VDOPRC_PHY_OUT_NUM];
	UINT32 dis_compensation[ISF_VDOPRC_PHY_OUT_NUM];
	//tracking queue
...
#define VPRC_DIS_SUBSAMPLE_CFG          (0x10000000) // for distinguish set subsample 0
...
extern UINT32 _isf_vdoprc_meta_copy(VDO_FRAME *pframe_new,VDO_FRAME *pframe_old,UINT32 addr,UINT32 dir,IRECT* p_crop);
