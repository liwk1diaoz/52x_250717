...
//state
extern ISF_RV _isf_unit_set_bind(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 oport, ISF_UNIT *p_destunit, UINT32 iport);
extern ISF_RV _isf_unit_set_state(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 oport, ISF_PORT_CMD cmd);
extern ISF_RV _isf_unit_clear_bind(ISF_UNIT *p_unit, UINT32 oport);
extern ISF_RV _isf_unit_get_bind(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 nport, ISF_UNIT **pp_destunit, UINT32* p_nport);
extern ISF_RV _isf_unit_get_state(UINT32 h_isf, ISF_UNIT *p_unit, UINT32 oport, ISF_PORT_STATE* p_state);
