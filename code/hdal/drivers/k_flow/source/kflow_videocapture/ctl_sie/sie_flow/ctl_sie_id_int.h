...
#define CTL_SIE_FLG_CLOSE			FLGPTN_BIT(8)
#define CTL_SIE_FLG_UP_ITEM_END		FLGPTN_BIT(9)
#define CTL_SIE_FLG_ISP_PRC_END		FLGPTN_BIT(10)

#define CTL_SIE_FLG_OPEN		(CTL_SIE_FLG_UP_ITEM_END|CTL_SIE_FLG_KDRV_END|CTL_SIE_FLG_ISP_PRC_END|CTL_SIE_FLG_ISR_PRC_END)
#define CTL_SIE_FLG_INIT		(CTL_SIE_FLG_LOCK|CTL_SIE_FLG_END|CTL_SIE_FLG_CNT)
...
#define CTL_SIE_BUF_CB_OUT			  	FLGPTN_BIT(11)
#define CTL_SIE_BUF_TASK_LOCK			FLGPTN_BIT(12)

#define CTL_SIE_BUF_PROC_INIT       (CTL_SIE_BUF_TASK_PAUSE_END|CTL_SIE_BUF_TASK_LOCK)
...
#define CTL_SIE_ISP_TASK_CB_OUT         FLGPTN_BIT(14)
#define CTL_SIE_ISP_TASK_LOCK	  		FLGPTN_BIT(15)

#define CTL_SIE_ISP_PROC_INIT	(CTL_SIE_ISP_CFG_LOCK | CTL_SIE_ISP_GET_IMG_END|CTL_SIE_ISP_TASK_PAUSE_END|CTL_SIE_ISP_TASK_LOCK)
...
#if defined (__UITRON)
extern UINT32 _SECTION(".kercfg_data") g_ctl_sie_buf_tsk_id;
extern UINT32 _SECTION(".kercfg_data") g_ctl_sie_buf_flg_id;
extern UINT32 _SECTION(".kercfg_data") g_ctl_sie_isp_tsk_id;
extern UINT32 _SECTION(".kercfg_data") g_ctl_sie_isp_flg_id;
extern UINT32 _SECTION(".kercfg_data") g_ctl_sie_flg_id[CTL_SIE_MAX_SUPPORT_ID];
extern void ctl_sie_install_id(void) _SECTION(".kercfg_text");
extern void kdf_sie_install_id(void) _SECTION(".kercfg_text");
#else
