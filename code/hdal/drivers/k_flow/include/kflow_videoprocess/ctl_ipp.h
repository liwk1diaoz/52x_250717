...
/*
	...
	rule3: 2dlut best
	rule4: gdc best
	CTL_IPP_STRP_RULE_nSTRP: force set stripe number to n (to replace isp param stripe_type)
*/
typedef enum {
	...
	CTL_IPP_STRP_RULE_NSTRP_OFS,
	// CTL_IPP_STRP_RULE_1STRP, // not support force 1 stripe
	CTL_IPP_STRP_RULE_2STRP = CTL_IPP_STRP_RULE_NSTRP_OFS + 2,
	CTL_IPP_STRP_RULE_3STRP,
	CTL_IPP_STRP_RULE_4STRP,
	CTL_IPP_STRP_RULE_5STRP,
	CTL_IPP_STRP_RULE_6STRP,
	CTL_IPP_STRP_RULE_7STRP,
	CTL_IPP_STRP_RULE_8STRP,
	CTL_IPP_STRP_RULE_9STRP,
