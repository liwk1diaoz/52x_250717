...
typedef enum _WAVSTUD_CFG {
	...
	WAVSTUD_CFG_REC_GAIN_LEVEL,
	WAVSTUD_CFG_ALC_DECAY_TIME,
	WAVSTUD_CFG_ALC_ATTACK_TIME,
	WAVSTUD_CFG_ALC_MAXGAIN,
	WAVSTUD_CFG_ALC_MINGAIN,
	WAVSTUD_CFG_ALC_CFG_EN,
	WAVSTUD_CFG_EMPTY_ENTRY_NUM,
	WAVSTUD_CFG_MAX
} WAVSTUD_CFG;
...
*/
extern BOOL wavstudio_start(WAVSTUD_ACT act_type, PWAVSTUD_AUD_INFO info, UINT64 stopcount, BOOL (*data_cb)(PAUDIO_BUF_QUEUE, PAUDIO_BUF_QUEUE, UINT32, UINT64, UINT64));
...
extern void wavstudio_dump_module_info(WAVSTUD_ACT act_type);
