...
#if defined(CTL_SEN_NA51000) || defined(CTL_SEN_NA51055)
...
*/
typedef enum {
	CTL_SEN_ID_1 = 0,  ///< CTL of Sensor ID : output data to SIE1.
	CTL_SEN_ID_2,      ///< CTL of Sensor ID : output data to SIE2.
	CTL_SEN_ID_3,      ///< CTL of Sensor ID : output data to SIE3. 510 N.S.
	CTL_SEN_ID_4,      ///< CTL of Sensor ID : output data to SIE4. 510/520 N.S.
	CTL_SEN_ID_5,      ///< CTL of Sensor ID : output data to SIE5. 510/520 N.S.
	CTL_SEN_ID_6,      ///< CTL of Sensor ID : output data to SIE6. 510/520 N.S.
	CTL_SEN_ID_7,      ///< CTL of Sensor ID : output data to SIE7. 510/520 N.S.
	CTL_SEN_ID_8,      ///< CTL of Sensor ID : output data to SIE8. 510/520 N.S.
...
/**
    Sensor mode
*/
#define CTL_SEN_MODE_PWR 0x00000100
typedef enum {
...
typedef enum {
	...
	CTL_SEN_CMDIF_TYPE_VX1     = 1, ///< Vx1, 510/520 N.S.
...
typedef enum {
	...
	CTL_SEN_IF_TYPE_SLVSEC,     ///< SLVS-EC, 510/520 N.S.
...
typedef enum {
	...
	CTL_SEN_DATALANE_6 = 6, // 510/520 N.S.
	CTL_SEN_DATALANE_8 = 8, // 510/520 N.S.
...
#define CTL_SEN_MODETYPE_FRMIDX_BITMAP      (CTL_SEN_MODETYPE_FRM_OUTTYPE_BITMAP | CTL_SEN_MODETYPE_FRM_EXPTGAIN_BITMAP | CTL_SEN_MODETYPE_FRM_OUTCOMB_BITMAP | CTL_SEN_MODETYPE_FRM_RESV_BITMAP)

#define CTL_SEN_MODETYPE_FRMIDX0_OFS        0 * CTL_SEN_MODETYPE_FRMIDX_OFS // 0
#define CTL_SEN_MODETYPE_FRMIDX1_OFS        1 * CTL_SEN_MODETYPE_FRMIDX_OFS // 16
#define CTL_SEN_MODETYPE_FRMIDX2_OFS        2 * CTL_SEN_MODETYPE_FRMIDX_OFS // 32
#define CTL_SEN_MODETYPE_FRMIDX3_OFS        3 * CTL_SEN_MODETYPE_FRMIDX_OFS // 48

/* out_type_sel */
#define out_type_sel_unkn 0
#define out_type_sel_raw 1
#define out_type_sel_ccir_progres 2
#define out_type_sel_ccir_intlace 3
#define out_type_sel_pdaf 4
/* expt_gain_sel */
#define expt_gain_sel_unkn 0
#define expt_gain_sel_expt 1
#define expt_gain_sel_hcg 2
#define expt_gain_sel_dcg expt_gain_sel_hcg
#define expt_gain_sel_lcg 3
/* out_combine_sel */
#define out_combine_sel_unkn 0
#define out_combine_sel_linear 1
#define out_combine_sel_pwl 2
...
#define CTL_SEN_ENTITY_MODETYPE_FRM(modetype, frmidx) ((modetype >> (frmidx * CTL_SEN_MODETYPE_FRMIDX_OFS)) & CTL_SEN_MODETYPE_FRMIDX_BITMAP)
#define CTL_SEN_ENTITY_MODETYPE_OUTTYPE(modetype, frmidx)   ((CTL_SEN_ENTITY_MODETYPE_FRM(modetype, frmidx) & CTL_SEN_MODETYPE_FRM_OUTTYPE_BITMAP) >> CTL_SEN_MODETYPE_FRM_OUTTYPE_OFS)
#define CTL_SEN_ENTITY_MODETYPE_EXPTGAIN(modetype, frmidx)  ((CTL_SEN_ENTITY_MODETYPE_FRM(modetype, frmidx) & CTL_SEN_MODETYPE_FRM_EXPTGAIN_BITMAP) >> CTL_SEN_MODETYPE_FRM_EXPTGAIN_OFS)
#define CTL_SEN_ENTITY_MODETYPE_OUTCOMB(modetype, frmidx)   ((CTL_SEN_ENTITY_MODETYPE_FRM(modetype, frmidx) & CTL_SEN_MODETYPE_FRM_OUTCOMB_BITMAP) >> CTL_SEN_MODETYPE_FRM_OUTCOMB_OFS)
#define CTL_SEN_ENTITY_MODETYPE_RESV(modetype, frmidx)      ((CTL_SEN_ENTITY_MODETYPE_FRM(modetype, frmidx) & CTL_SEN_MODETYPE_FRM_RESV_BITMAP) >> CTL_SEN_MODETYPE_FRM_RESV_OFS)

typedef enum {
	CTL_SEN_MODE_TYPE_UNKNOWN = CTL_SEN_MODETYPE_FRM(out_type_sel_unkn, expt_gain_sel_unkn, out_combine_sel_unkn, 0),

	/* linear raw, frame_num = 1 */
	CTL_SEN_MODE_LINEAR = CTL_SEN_MODETYPE_FRM(out_type_sel_raw, expt_gain_sel_expt, out_combine_sel_linear, 0),

	/* bulid in HDR, frame_num = 1 */
	CTL_SEN_MODE_BUILTIN_HDR = CTL_SEN_MODETYPE_FRM(out_type_sel_raw, expt_gain_sel_expt, out_combine_sel_pwl, 0),

	/* ccir progressive, frame_num = 1 */
	CTL_SEN_MODE_CCIR = CTL_SEN_MODETYPE_FRM(out_type_sel_ccir_progres, expt_gain_sel_unkn, out_combine_sel_unkn, 0),

	/* ccir interlace, frame_num = 1 */
	CTL_SEN_MODE_CCIR_INTERLACE = CTL_SEN_MODETYPE_FRM(out_type_sel_ccir_intlace, expt_gain_sel_unkn, out_combine_sel_unkn, 0),

	/* stagger HDR, frame_num = 2 */
	CTL_SEN_MODE_STAGGER_HDR = (CTL_SEN_MODETYPE_FRM(out_type_sel_raw, expt_gain_sel_expt, out_combine_sel_linear, 0) | (CTL_SEN_MODETYPE_FRM(out_type_sel_raw, expt_gain_sel_expt, out_combine_sel_linear, 0) << CTL_SEN_MODETYPE_FRMIDX1_OFS)),

	/* linear raw + pdaf, frame_num = 2 */
	CTL_SEN_MODE_PDAF = (CTL_SEN_MODETYPE_FRM(out_type_sel_raw, expt_gain_sel_expt, out_combine_sel_linear, 0) | (CTL_SEN_MODETYPE_FRM(out_type_sel_pdaf, expt_gain_sel_expt, out_combine_sel_linear, 0) << CTL_SEN_MODETYPE_FRMIDX1_OFS)),
...
typedef enum {
	...
	CTL_SEN_INTE_VD3        = 0x00000004,   ///< Valid for LVDS/Vx1, 510/520 N.S.
	CTL_SEN_INTE_VD4        = 0x00000008,   ///< Valid for LVDS/Vx1, 510/520 N.S.
	CTL_SEN_INTE_FRAMEEND   = 0x00000010,   ///< Valid for CSI/LVDS/SLVSEC
	CTL_SEN_INTE_FRAMEEND2  = 0x00000020,   ///< Valid for CSI/LVDS/SLVSEC
	CTL_SEN_INTE_FRAMEEND3  = 0x00000040,   ///< Valid for CSI/LVDS, 510/520 N.S.
	CTL_SEN_INTE_FRAMEEND4  = 0x00000080,   ///< Valid for CSI/LVDS, 510/520 N.S.
	CTL_SEN_INTE_ABORT      = 0x80000000,   ///< Waiting event timeout abort.

	CTL_SEN_INTE_VD_TO_SIE0     = 0x00000100,   ///< Valid for CSI/LVDS, 528 support
	CTL_SEN_INTE_VD_TO_SIE1     = 0x00000200,   ///< Valid for CSI/LVDS, 528 support
	CTL_SEN_INTE_VD_TO_SIE3     = 0x00000400,   ///< Valid for CSI/LVDS, 510/520 N.S., 528 support
	CTL_SEN_INTE_VD_TO_SIE4     = 0x00000800,   ///< Valid for CSI/LVDS, 510/520 N.S., 528 support
	CTL_SEN_INTE_FMD_TO_SIE0    = 0x00001000,   ///< Valid for CSI/LVDS, 528 support
	CTL_SEN_INTE_FMD_TO_SIE1    = 0x00002000,   ///< Valid for CSI/LVDS, 528 support
	CTL_SEN_INTE_FMD_TO_SIE3    = 0x00004000,   ///< Valid for CSI/LVDS, 510/520 N.S., 528 support
	CTL_SEN_INTE_FMD_TO_SIE4    = 0x00008000,   ///< Valid for CSI/LVDS, 510/520 N.S., 528 support

	CTL_SEN_INTE_TGE_VD     = CTL_SEN_INTE_VD | CTL_SEN_TGE_TAG,    ///< Valid for TGE (CTL_SEN_INIT_CFG_OBJ/cfg_obj.if_cfg.tge.tge_en = ENABLE)
	CTL_SEN_INTE_VX1_VD     = CTL_SEN_INTE_VD | CTL_SEN_VX1_TAG,    ///< Valid for VX1 (sensor driver setting CTL_SEN_CMDIF_TYPE_VX1), 510/520 N.S.
	CTL_SEN_INTE_VX1_VD2     = CTL_SEN_INTE_VD2 | CTL_SEN_VX1_TAG,  ///< Valid for VX1 (sensor driver setting CTL_SEN_CMDIF_TYPE_VX1), 510/520 N.S.
	CTL_SEN_INTE_VX1_VD3     = CTL_SEN_INTE_VD3 | CTL_SEN_VX1_TAG,  ///< Valid for VX1 (sensor driver setting CTL_SEN_CMDIF_TYPE_VX1), 510/520 N.S.
	CTL_SEN_INTE_VX1_VD4     = CTL_SEN_INTE_VD4 | CTL_SEN_VX1_TAG,  ///< Valid for VX1 (sensor driver setting CTL_SEN_CMDIF_TYPE_VX1), 510/520 N.S.
...
typedef enum {
	...
	CTL_SEN_OUTPUT_DEST_SIE3    = (1 << CTL_SEN_ID_3), // 510/520 N.S.
	CTL_SEN_OUTPUT_DEST_SIE4    = (1 << CTL_SEN_ID_4), // 510/520 N.S.
	CTL_SEN_OUTPUT_DEST_SIE5    = (1 << CTL_SEN_ID_5), // 510/520 N.S.
	CTL_SEN_OUTPUT_DEST_SIE6    = (1 << CTL_SEN_ID_6), // 510/520 N.S.
	CTL_SEN_OUTPUT_DEST_SIE7    = (1 << CTL_SEN_ID_7), // 510/520 N.S.
	CTL_SEN_OUTPUT_DEST_SIE8    = (1 << CTL_SEN_ID_8), // 510/520 N.S.
...
typedef enum {
	...
	CTL_SEN_SIEMCLK_SRC_MCLK = 1,         ///< PLL_CLK_SIEMCLK
	CTL_SEN_SIEMCLK_SRC_MCLK2 = 2,        ///< PLL_CLK_SIEMCLK2
	CTL_SEN_SIEMCLK_SRC_MCLK3 = 3,        ///< PLL_CLK_SIEMCLK3

	CTL_SEN_SIEMCLK_SRC_MAX = 4,
...
typedef struct {
	...
	BOOL swap;      ///< swap CH1 & 5, or CH2 & 6, or CH3 & 7, or CH4 & 8, 510/520 N.S.
	CTL_SEN_TGE_SIE_VD_SRC sie_vd_src;  ///< SIE 1/3 VD/HD signal source (only in parallel mode + slave sensor), 510/520 N.S.
} CTL_SEN_IF_TGE;
...
typedef enum {
	...
	CTL_SEN_CLANE_SEL_CSI1_USE_C1,      ///< [520] MIPI CSI1 uses HSI_CK1 as clock lane.
	CTL_SEN_CLANE_SEL_LVDS1_USE_C1,     ///< [520] LVDS1 uses HSI_CK1 as clock lane in one clock lane sensor.
...
typedef enum {
	...
	CTL_SEN_DRVDEV_CSI_2       = 0x00000003,                // select CSI controller 2 [520/528 N.S.]
	CTL_SEN_DRVDEV_CSI_3       = 0x00000004,                // select CSI controller 3 [520/528 N.S.]
	CTL_SEN_DRVDEV_CSI_4       = 0x00000005,                // select CSI controller 4 [520/528 N.S.]
	CTL_SEN_DRVDEV_CSI_5       = 0x00000006,                // select CSI controller 5 [520/528 N.S.]
	CTL_SEN_DRVDEV_CSI_6       = 0x00000007,                // select CSI controller 6 [520/528 N.S.]
	CTL_SEN_DRVDEV_CSI_7       = 0x00000008,                // select CSI controller 7 [520/528 N.S.]
	...
	CTL_SEN_DRVDEV_LVDS_2      = 0x00000030,                // select LVDS controller 2 [520/528 N.S.]
	CTL_SEN_DRVDEV_LVDS_3      = 0x00000040,                // select LVDS controller 3 [520/528 N.S.]
	CTL_SEN_DRVDEV_LVDS_4      = 0x00000050,                // select LVDS controller 4 [520/528 N.S.]
	CTL_SEN_DRVDEV_LVDS_5      = 0x00000060,                // select LVDS controller 5 [520/528 N.S.]
	CTL_SEN_DRVDEV_LVDS_6      = 0x00000070,                // select LVDS controller 6 [520/528 N.S.]
	CTL_SEN_DRVDEV_LVDS_7      = 0x00000080,                // select LVDS controller 7 [520/528 N.S.]
	...
	CTL_SEN_DRVDEV_TGE_2       = 0x00000300,                // select TGE VD2/HD2 generator [520/528 N.S.]
	CTL_SEN_DRVDEV_TGE_3       = 0x00000400,                // select TGE VD3/HD3 generator [520/528 N.S.]
	CTL_SEN_DRVDEV_TGE_4       = 0x00000500,                // select TGE VD4/HD4 generator [520/528 N.S.]
	CTL_SEN_DRVDEV_TGE_5       = 0x00000600,                // select TGE VD5/HD5 generator [520/528 N.S.]
	CTL_SEN_DRVDEV_TGE_6       = 0x00000700,                // select TGE VD6/HD6 generator [520/528 N.S.]
	CTL_SEN_DRVDEV_TGE_7       = 0x00000800,                // select TGE VD7/HD7 generator [520/528 N.S.]
	CTL_SEN_DRVDEV_TGE_MAX     = CTL_SEN_DRVDEV_TGE_7,      // must <= 0x00000F00

	CTL_SEN_DRVDEV_VX1_BASE    = 0x00001000,
	CTL_SEN_DRVDEV_VX1_0       = CTL_SEN_DRVDEV_VX1_BASE,   // select vx1 controller 0, mapping to KDRV_SSENIF_ENGINE_VX1_0, NT96680 only support SIE 1~5 [520/528 N.S.]
	CTL_SEN_DRVDEV_VX1_1       = 0x00002000,                // select vx1 controller 1, mapping to KDRV_SSENIF_ENGINE_VX1_1, NT96680 only support SIE 4,6 [520/528 N.S.]
	CTL_SEN_DRVDEV_VX1_MAX     = CTL_SEN_DRVDEV_VX1_1,      // must <= 0x0000F000

	CTL_SEN_DRVDEV_SLVSEC_BASE = 0x00010000,
	CTL_SEN_DRVDEV_SLVSEC_0    = CTL_SEN_DRVDEV_SLVSEC_BASE,    // select SLVS-EC controller 0 [520/528 N.S.]
...
typedef struct {
	CTL_SEN_I2C_W_ADDR_SEL w_addr_sel;
	UINT8 w_addr;
} CTL_SEN_I2C_WADDR;

typedef struct {
	CTL_SEN_I2C_WADDR w_addr_info[CTL_SEN_I2C_W_ADDR_SEL_MAX_NUM];
...
typedef struct {
	...
	CTL_SENDRV_VX1 vx1;         ///< [out], 510/520 N.S.
...
typedef struct {
	...
	URECT act_size[CTL_SEN_MFRAME_MAX_NUM];     ///< [out]the number of sample data, for sie act, must <= valid_size
...
typedef struct {
	CTL_SEN_MODE mode;              ///< [in]
	UINT32 delay;                   ///< [out] high speed data output delay
...
typedef enum {
	...
	CTL_SENDRV_CFGID_GET_MODE_SLVSEC,   ///< CTL_SENDRV_GET_MODE_SLVSEC_PARAM, 510/520 N.S.
	...
	CTL_SENDRV_CFGID_GET_MODE_MIPI_HSDATAOUT_DLY,   ///< CTL_SENDRV_GET_MODE_MIPI_HSDATAOUT_DLY
	...
	CTL_SENDRV_CFGID_AD_UNINIT,         ///< BOOL
...
typedef struct {
	CTL_SEN_CMDIF_TYPE type;///< [out]
	CTL_SEN_VX1_INFO vx1;   ///< [out], 510/520 N.S.
...
typedef enum {
	...
	CTL_SEN_CLKSRC_PLL2,        ///< clock source as PLL2
	CTL_SEN_CLKSRC_PLL4,        ///< clock source as PLL4
	CTL_SEN_CLKSRC_PLL5,        ///< clock source as PLL5
	CTL_SEN_CLKSRC_PLL10,        ///< clock source as PLL10
	CTL_SEN_CLKSRC_PLL12,        ///< clock source as PLL12
	CTL_SEN_CLKSRC_PLL14,       ///< clock source as PLL14
	CTL_SEN_CLKSRC_PLL18,       ///< clock source as PLL18
	CTL_SEN_CLKSRC_MAX,
...
typedef enum {
	...
	CTL_SEN_CFGID_GET_SSENIF_ERR_CNT,   ///< [GET]UINT32, ssenif err count
	CTL_SEN_CFGID_GET_FRAME_NUMBER,     ///< [GET]UINT32, ssenif FS short packet frame number.
	...
	CTL_SEN_CFGID_AD_UNINIT,            ///< [SET] void
	CTL_SEN_CFGID_MAX,
	...
	/* for sensor driver control vx1 , 510/520 N.S. */
	CTL_SEN_CFGID_VX1_BASE = 0x05000000,///< 510/520 N.S.
...
typedef struct {
	...
	UINT32 mclksrc_sync;    // UINT32(1 << CTL_SEN_ID), default: 0, mclk will select same source (ex: MCLK1&MCLK2 used pll5 as source)
} CTL_SEN_INIT_IF_CFG;
...
typedef struct {
	CTL_SEN_CMDIF_VX1 vx1;          ///< vx1 information, 510/520 N.S.
...
typedef struct {
	...
	BOOL vx1_tx241_cko_pin;         ///< ENABLE / DISABLE the THCV241's CKO pin output. [limit]: For MIPI-CSI-HDR-Sensor/Tx-THCV241 only. 510/520 N.S.
	BOOL vx1_tx241_cfg_2lane_mode;  ///< set FALSE for 1 lane mode, set TRUE for 2 lanes mode. Only KDRV_SSENIFVX1_TXTYPE_THCV241 has 2 lanes mode. 510/520 N.S.
