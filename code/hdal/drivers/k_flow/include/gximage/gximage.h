...
*/
extern ER gximg_fill_data(PVDO_FRAME p_dst_img, IRECT *p_dst_region, UINT32 color, int usePA);

extern ER gximg_fill_data_no_flush(PVDO_FRAME p_dst_img, IRECT *p_dst_region, UINT32 color, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER gximg_fill_data_ex(PVDO_FRAME p_dst_img, IRECT *p_dst_region, UINT32 color, GXIMG_FILL_ENG engine, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER gximg_copy_data(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, GXIMG_CP_ENG engine, int usePA);

extern ER gximg_copy_data_no_flush(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, GXIMG_CP_ENG engine, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER gximg_copy_color_key_data(PVDO_FRAME p_src_img, IRECT *p_copy_region, PVDO_FRAME p_key_img, IPOINT *p_key_location, UINT32 color_key, BOOL is_copy_to_key_img, GXIMG_CP_ENG engine, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER gximg_copy_blend_data(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 alpha, GXIMG_CP_ENG engine, int usePA);

extern ER gximg_copy_blend_data_no_flush(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 alpha, GXIMG_CP_ENG engine, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER gximg_copy_blend_data_ex(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT8 *p_alpha_plane, int usePA);

extern ER gximg_copy_blend_data_ex_no_flush(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT8 *p_alpha_plane, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error.
*/
extern ER gximg_scale_data(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IRECT *p_dst_region, GXIMG_SCALE_METHOD method, int usePA);

extern ER gximg_scale_data_no_flush(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IRECT *p_dst_region, GXIMG_SCALE_METHOD method, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_PAR:   Input parameter error or destination buffer too small.
*/
extern ER gximg_rotate_paste_data(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 rotate_dir, GXIMG_RT_ENG engine, int usePA);

extern ER gximg_rotate_paste_data_no_flush(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 rotate_dir, GXIMG_RT_ENG engine, int usePA);
...
*/
extern ER gximg_color_transform(PVDO_FRAME p_src_img, PVDO_FRAME p_dst_img, UINT32 tmp_buff, UINT32 tmp_buf_size, int usePA);
...
*/
extern ER gximg_argb_to_yuv_blend(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 alpha, void *palette, int usePA);

extern ER gximg_argb_to_yuv_blend_no_flush(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 alpha, void *palette, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_SYS:   HW engine or system error
*/
extern ER gximg_rgb_to_yuv_color_key(PVDO_FRAME p_src_img, IRECT *p_src_region, PVDO_FRAME p_dst_img, IPOINT *p_dst_location, UINT32 alpha, UINT32 color_key, int usePA);
...
/**
     ...
     @return
         ...
         - @b E_SYS:   HW engine or system error
*/
extern ER gximg_quad_cover(GXIMG_COVER_DESC *p_cover, PVDO_FRAME p_dst_img, IRECT *p_dst_region, UINT32 hollow, UINT32 thickness, int usePA);
...
extern ER gximg_quad_cover_with_flush(GXIMG_COVER_DESC *p_cover, PVDO_FRAME p_dst_img, IRECT *p_dst_region, UINT32 hollow, UINT32 thickness, int no_flush, int usePA);
//------------------------------------------------------------------------------
...
extern int gximg_open_grph(UINT32 grph_id);

extern int gximg_close_grph(UINT32 grph_id);
