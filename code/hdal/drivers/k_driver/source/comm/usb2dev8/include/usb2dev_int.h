...
#if _EMULATION_
#define USB_FIFOMAP_FIFO4FIRST          1
#else
#define USB_FIFOMAP_FIFO4FIRST          1
#endif
...
#define USBPHY_SETREG(ofs, value)       OUTW((void *)(0xFD600000+(ofs)), (value))
...
#define USB_PutString1         		DBG_DUMP
#else
...
#define FLGUSB_SETUPTSK_STOP    FLGPTN_BIT(13)      //  USB setup task stop
#define FLGUSB_CTLTSK_STOP      FLGPTN_BIT(14)     //  USB control task stop
#define FLGUSB_USER_EVENT_SET   FLGPTN_BIT(15)     //  User Space Event Set
#define FLGUSB_USER_EVENT_DONE  FLGPTN_BIT(16)     //  User Space Event Done
...
extern UINT32  			gEPAssignedMap[USB_EP_MAX - 1];
