...
static void usb_ISR_RST(void)
{
	...
	T_USB_DEVFIFOBYTECNT2_REG       devFIFOByteCnt2;
	T_USB_DEVFIFOBYTECNT3_REG       devFIFOByteCnt3;
	...
	devFIFOByteCnt2.reg = USB_GETREG(USB_DEVFIFOBYTECNT2_REG_OFS);
	devFIFOByteCnt2.bit.FFRST4 = 1;
	devFIFOByteCnt2.bit.FFRST5 = 1;
	USB_SETREG(USB_DEVFIFOBYTECNT2_REG_OFS, devFIFOByteCnt2.reg);

	devFIFOByteCnt3.reg = USB_GETREG(USB_DEVFIFOBYTECNT3_REG_OFS);
	devFIFOByteCnt3.bit.FFRST6 = 1;
	devFIFOByteCnt3.bit.FFRST7 = 1;
	USB_SETREG(USB_DEVFIFOBYTECNT3_REG_OFS, devFIFOByteCnt3.reg);
...
static void usb_ISR_SUSPEND(void)
{
	T_USB_DEVFIFOBYTECNT0_REG   devFIFOByteCnt0;
	T_USB_DEVFIFOBYTECNT1_REG   devFIFOByteCnt1;
	T_USB_DEVFIFOBYTECNT2_REG   devFIFOByteCnt2;
	T_USB_DEVFIFOBYTECNT3_REG   devFIFOByteCnt3;
	T_USB_DEVMAINCTRL_REG       devMainCtl;
	...
	//Clear all USB FIFOs
	devFIFOByteCnt0.reg = USB_GETREG(USB_DEVFIFOBYTECNT0_REG_OFS);
	devFIFOByteCnt0.bit.FFRST0 = 1;
	devFIFOByteCnt0.bit.FFRST1 = 1;
	USB_SETREG(USB_DEVFIFOBYTECNT0_REG_OFS, devFIFOByteCnt0.reg);

	devFIFOByteCnt1.reg = USB_GETREG(USB_DEVFIFOBYTECNT1_REG_OFS);
	devFIFOByteCnt1.bit.FFRST2 = 1;
	devFIFOByteCnt1.bit.FFRST3 = 1;
	USB_SETREG(USB_DEVFIFOBYTECNT1_REG_OFS, devFIFOByteCnt1.reg);
