...
#define KDRV_SIE_ERR_INT_EN		(KDRV_SIE_INT_ERR_SIECLK | KDRV_SIE_INT_ERR_RAWENC | KDRV_SIE_INT_ERR_DPC)
#define KDRV_SIE_DFT_INT	(KDRV_SIE_INT_VD | KDRV_SIE_INT_CROPEND)

// funtion type in sie driver
typedef void (*KDRV_SIE_DRV_ISR_FP)(UINT32 ui_intp_status, SIE_ENGINE_STATUS_INFO_CB *info);
