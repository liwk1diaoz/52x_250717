...
static ID SEMID_LVDS2;
static ID FLG_ID_LVDS2;
#else
#include <kwrap/util.h>
#include <kwrap/spinlock.h>
...
#define LVDS_GETREG(ofs)            LVDS2_R_REGISTER((ofs))
#define LVDS_SETREG(ofs, value)      LVDS2_W_REGISTER((ofs), (value))

#ifndef __KERNEL__
#define MODULE_FLAG_ID              FLG_ID_LVDS2
#define MODULE_FLAG_PTN             FLGPTN_LVDS2
#define MODULE_CLK_ID				MIPI_LVDS2_CLK
#define MODULE_DRV_INT				INT_ID_LVDS2
#else
#define MODULE_CLK_ID				0
#endif
#define MODULE_SEM_ID               SEMID_LVDS2
//#define MODULE_RST_ID             MIPI_LVDS2_RSTN
#define MODULE_SENPHY               SENPHY_SEL_MIPILVDS2

#define LVDS_PHASE_INV
#define LVDS_ENABLE_INT             lvds2_set_int_enable
#define LVDS_DISABLE_INT            lvds2_set_int_disable
#define LVDS_SET_ENABLE             lvds2_set_enable
#define LVDS_GET_ENABLE             lvds2_get_enable
#define LVDS_WAIT_INTERR            lvds2_wait_interrupt
#define LVDS_FIFO_RESET             lvds2_set_fifo_reset
#define LVDS_OUT_REMAPORDER			lvds2_out_remap_order
#define LVDS_CHK_REG                lvds2_chk_register
#define LVDS_LOCK                   lvds2_lock
#define LVDS_UNLOCK                 lvds2_unlock
#define LVDS_DUMPINFO               lvds2_dump_debug_info
#ifndef __KERNEL__
#define LVDS_TIMEOUTCALLBACK		lvds2_timeout_timer_callback
#endif

#define LVDS_CK1_EN					ENABLE
#define LVDS_TWOCLK_SUPPORT         DISABLE
#define LVDS_CLK0_SEL               SENPHY_CLKMAP_CK1
#define LVDS_CLK0_ALT_SEL           SENPHY_CLKMAP_CK1
...
#define LVDS_MAX_DLAN_NUMBER        LVDS_DATLANE_2
#define LVDS_VALID_MASK             0x0C
#define LVDS_VALID_OFFSET           2
#define LVDS_DLANE_PATCH            0

#define LVDS_API_DEFINE(name)        (lvds2##_##name)

//REGDEF_SETIOBASE(IOADDR_LVDS2_REG_BASE);
...
void LVDS_API_DEFINE(trigger_relock)(void)
{
	T_LVDS_CTRL0_REG reg_ctrl0;
...
static void LVDS_API_DEFINE(timeout_timer_callback)(UINT32 event)
{
	unsigned long      flags;
...
//void lvds_init(void)
void LVDS_API_DEFINE(init)(void)
{
	vos_flag_create(&MODULE_FLAG_ID, NULL, "FLG_ID_LVDS2");
	vos_sem_create(&MODULE_SEM_ID, 1, "SEMID_LVDS2");
}

//void lvds_uninit(void)
void LVDS_API_DEFINE(uninit)(void)
{
...
ER LVDS_API_DEFINE(open)(void)
{
	...
	#endif
	senphy_set_config(SENPHY_CONFIG_LVDS2_MODE,	ENABLE);
	...
	// Enable interrupt
	request_irq(MODULE_DRV_INT, lvds2_isr ,IRQF_TRIGGER_HIGH, "lvds1", 0);
#endif
...
ER LVDS_API_DEFINE(close)(void)
{
	...
	#endif
	senphy_set_config(SENPHY_CONFIG_LVDS2_MODE, DISABLE);
...
ER LVDS_API_DEFINE(set_enable)(BOOL benable)
{
	...
	#ifdef __KERNEL__
	lvds_enable_errchk_timer(LVDS_ID_LVDS2, benable);
	#endif
