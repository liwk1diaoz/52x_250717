...
#include <stdio.h>
#include "kdrv_audioio/audlib_g711.h"
#define __MODULE__ rtos_g711
#define __DBGLVL__ 8 // 0=FATAL, 1=ERR, 2=WRN, 3=UNIT, 4=FUNC, 5=IND, 6=MSG, 7=VALUE, 8=USER
#define __DBGFLT__ "*"
#include "kwrap/debug.h"
#include "kwrap/error_no.h"
unsigned int rtos_g711_debug_level = NVT_DBG_WRN;
#endif

#include "kdrv_audioio/kdrv_audioio.h"

static KDRV_AUDIOLIB_FUNC g711_func =
{
	.g711.ulaw_encode			= g711_ulaw_encode,
	.g711.ulaw_decode			= g711_ulaw_decode,
	.g711.alaw_encode			= g711_alaw_encode,
	.g711.alaw_decode			= g711_alaw_decode,
};
...
int kdrv_audlib_g711_init(void) {
	...
	ret = kdrv_audioio_reg_audiolib(KDRV_AUDIOLIB_ID_G711, &g711_func);
