...
unsigned int rtos_adpcm_debug_level = NVT_DBG_WRN;

#endif

#include "kdrv_audioio/kdrv_audioio.h"

static KDRV_AUDIOLIB_FUNC adpcm_func =
{
	.adpcm.encode_mono			= audlib_adpcm_encode_mono,
	.adpcm.encode_stereo		= audlib_adpcm_encode_stereo,
	.adpcm.decode_mono			= audlib_adpcm_decode_mono,
	.adpcm.decode_stereo		= audlib_adpcm_decode_stereo,
	.adpcm.encode_packet_mono	= audlib_adpcm_encode_packet_mono,
	.adpcm.encode_packet_stereo	= audlib_adpcm_encode_packet_stereo,
	.adpcm.decode_packet_mono	= audlib_adpcm_decode_packet_mono,
	.adpcm.decode_packet_stereo	= audlib_adpcm_decode_packet_stereo,
};
...
int kdrv_audlib_adpcm_init(void) {
	...
	ret = kdrv_audioio_reg_audiolib(KDRV_AUDIOLIB_ID_ADPCM, &adpcm_func);
