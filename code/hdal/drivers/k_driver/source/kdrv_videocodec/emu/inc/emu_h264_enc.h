...
typedef struct _rdo_t_{
	...
	unsigned char rdo_cost_bias_I4;
	unsigned char rdo_cost_bias_I8;
	unsigned char rdo_cost_bias_I16;
	unsigned char rdo_cost_bias_P4;
	unsigned char rdo_cost_bias_P8;
	unsigned char rdo_cost_bias_SKIP;
...
typedef struct _osg_t_{
	...
	osg_win_t win[32];	//layer0 0~15, layer1 16~31
