...
#if defined(__cplusplus) || __STDC_VERSION__ >= 199901L  // If c99 or newer, use linux/types.h to determine arch size
...
// If c99 or newer,  use the definition of uintptr_t directly from <linux/types.h>
