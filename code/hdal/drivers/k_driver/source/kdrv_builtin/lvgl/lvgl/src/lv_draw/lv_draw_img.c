                ...
                for(x = 0; x < draw_area_w; x++, map_px += px_size_byte, px_i++) {
                    ...
                    if(transform) {
                        ...
                        if(ret == false) {
                           ...
                           c.ext_ch.alpha =  trans_dsc.res.color.ext_ch.alpha;
#endif
                        }
                    }
                    /*No transform*/
...
#elif LV_COLOR_DEPTH == 24
                        c.full =  map_px[0] + (map_px[1] << 8) + (map_px[1] << 16);
                        c.ext_ch.alpha = 0xFF;
#elif LV_COLOR_DEPTH == 32
...
#if LV_COLOR_DEPTH == 24
                    map2[px_i].ext_ch.alpha = c.ext_ch.alpha;
#endif
