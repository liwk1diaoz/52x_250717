 ...
 * DELAY INTERFACE
 *********************/
#define LV_DRV_DELAY_INCLUDE  <linux/types.h>            /*Dummy include by default*/
 ...
 *  Common
 *------------*/
#define LV_DRV_DISP_INCLUDE         <linux/types.h>           /*Dummy include by default*/
 ...
 *  Common
 *----------*/
#define LV_DRV_INDEV_INCLUDE     <linux/types.h>             /*Dummy include by default*/
