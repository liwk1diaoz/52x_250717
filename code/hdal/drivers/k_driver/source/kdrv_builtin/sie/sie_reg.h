...
/*
    LN16_CNT          :    [0x0, 0xff],           bits : 7_0
    PX_CNT            :    [0x0, 0xff],           bits : 15_8
...
REGDEF_BIT(LN16_CNT,        8)
REGDEF_BIT(PX_CNT,        8)
REGDEF_BIT(VSYNC,        1)
REGDEF_BIT(HSYNC,        1)
REGDEF_BIT(CCIR601_CURR_FIELD,        1)
REGDEF_BIT(,        4)
REGDEF_BIT(BUFF_RHE_OVFL,        1)
...
REGDEF_BIT(DRAM_OUT3_OVFL,        1)
REGDEF_BIT(DRAM_OUT4_OVFL,        1)
REGDEF_BIT(DRAM_OUT5_OVFL,        1)
...
*/
#define R44_ENGINE_DRAM_OFS 0x0044
REGDEF_BEGIN(R44_ENGINE_DRAM)
REGDEF_BIT(,         2)
REGDEF_BIT(DRAM_IN0_OFSO,        14)
REGDEF_BIT(DRAM_IN0_PACK_BUS,     2)
REGDEF_END(R44_ENGINE_DRAM)
...
*/
#define R1AC_BASIC_YOUT_OFS 0x01ac
REGDEF_BEGIN(R1AC_BASIC_YOUT)
REGDEF_BIT(YOUT_SMPL_X_SFACT,      16)
REGDEF_BIT(YOUT_SMPL_Y_SFACT,      16)
REGDEF_END(R1AC_BASIC_YOUT)
...
*/
#define R1B0_BASIC_YOUT_OFS 0x01b0
REGDEF_BEGIN(R1B0_BASIC_YOUT)
REGDEF_BIT(YOUT_WIN_SZX,        8)
REGDEF_BIT(YOUT_WIN_SZY,        8)
REGDEF_BIT(YOUT_ACCUM_SHIFT,        4)
REGDEF_BIT(YOUT_ACCUM_GAIN,        8)
REGDEF_END(R1B0_BASIC_YOUT)
...
/*
    YOUT_CGAIN_RGAIN:    [0x0, 0x3ff],            bits : 9_0
    YOUT_CGAIN_RGAIN:    [0x0, 0x3ff],            bits : 19_10
    YOUT_CGAIN_BGAIN:    [0x0, 0x3ff],            bits : 29_20
    YOUT_CGAIN_SEL  :    [0x0, 0x1],              bits : 30_30
*/
#define R1C4_BASIC_YOUT_OFS 0x01c4
REGDEF_BEGIN(R1C4_BASIC_YOUT)
REGDEF_BIT(YOUT_CGAIN_RGAIN, 10)
REGDEF_BIT(YOUT_CGAIN_GGAIN, 10)
REGDEF_BIT(YOUT_CGAIN_BGAIN, 10)
REGDEF_BIT(YOUT_CGAIN_SEL,    1)
REGDEF_END(R1C4_BASIC_YOUT)
...
*/
#define R1C8_BASIC_YOUT_OFS 0x01c8
REGDEF_BEGIN(R1C8_BASIC_YOUT)
REGDEF_BIT(YOUT_WIN_NUMX,        7)
REGDEF_BIT(,        1)
REGDEF_BIT(YOUT_WIN_NUMY,        7)
REGDEF_END(R1C8_BASIC_YOUT)


/*
    RESERVED:    [0x0, 0xffffffff],            bits : 31_0
*/
#define R1CC_RESERVED_OFS 0x01cc
REGDEF_BEGIN(R1CC_RESERVED)
REGDEF_BIT(RESERVED,        32)
REGDEF_END(R1CC_RESERVED)
...
/*
    RESERVED:    [0x0, 0xffffffff],            bits : 31_0
*/
#define R1E0_RESERVED_OFS 0x01e0
REGDEF_BEGIN(R1E0_RESERVED)
REGDEF_BIT(RESERVED,        32)
REGDEF_END(R1E0_RESERVED)


/*
    RESERVED:    [0x0, 0xffffffff],            bits : 31_0
*/
#define R1E4_RESERVED_OFS 0x01e4
REGDEF_BEGIN(R1E4_RESERVED)
REGDEF_BIT(RESERVED,        32)
REGDEF_END(R1E4_RESERVED)
...
/*
    VDETGH1A      :    [0x0, 0x1f],            bits : 4_0
    VDETGH1_BCD_OP:    [0x0, 0x1],            bits : 7
    VDETGH1B      :    [0x0, 0x1f],            bits : 12_8
    VDETGH1C      :    [0x0, 0xf],            bits : 19_16
    VDETGH1D      :    [0x0, 0xf],            bits : 23_20
    VDETGH1_FSIZE :    [0x0, 0x3],            bits : 25_24
    VDETGH1_EXTEND:    [0x0, 0x1],            bits : 26
    VDETGH1_DIV   :    [0x0, 0xf],            bits : 31_28
*/
#define R340_STCS_VA_OFS 0x0340
REGDEF_BEGIN(R340_STCS_VA)
REGDEF_BIT(VDETGH1A,        5)
REGDEF_BIT(,        2)
REGDEF_BIT(VDETGH1_BCD_OP,        1)
REGDEF_BIT(VDETGH1B,        5)
REGDEF_BIT(,        3)
REGDEF_BIT(VDETGH1C,        4)
REGDEF_BIT(VDETGH1D,        4)
REGDEF_BIT(VDETGH1_FSIZE,        2)
REGDEF_BIT(VDETGH1_EXTEND,        1)
REGDEF_BIT(,        1)
REGDEF_BIT(VDETGH1_DIV,        4)
REGDEF_END(R340_STCS_VA)
...
/*
    WIN0_VAEN:    [0x0, 0x1],            bits : 0
    WIN0_STX :    [0x0, 0xfff],            bits : 13_2
    WIN0_STY :    [0x0, 0xfff],            bits : 27_16
*/
#define R364_STCS_VA_OFS 0x0364
REGDEF_BEGIN(R364_STCS_VA)
REGDEF_BIT(WIN0_VAEN,        1)
REGDEF_BIT(,        1)
REGDEF_BIT(WIN0_STX,        12)
REGDEF_BIT(,        2)
REGDEF_BIT(WIN0_STY,        12)
REGDEF_END(R364_STCS_VA)
...
*/
#define R368_STCS_VA_OFS 0x0368
REGDEF_BEGIN(R368_STCS_VA)
