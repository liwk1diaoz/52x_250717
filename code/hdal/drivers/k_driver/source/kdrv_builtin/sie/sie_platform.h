...
#define SIE_MAX_CLK_FREQ        300000000
#define SIE_MAX_MCLK_FREQ       150000000
...
extern ER sie4_setPxClock(SIE_PXCLKSRC PxClkSel);
extern ER sie5_setPxClock(SIE_PXCLKSRC PxClkSel);
...
extern ER sie4_setClock(SIE_CLKSRC_SEL ClkSrc, UINT32 uiClkRate);
extern ER sie5_setClock(SIE_CLKSRC_SEL ClkSrc, UINT32 uiClkRate);
...
extern UINT32 sie_power_saving_clkrate;
