#ifndef _IME_REGISTER_H_
#define _IME_REGISTER_H_
...
#define IOADDR_IME_REG_BASE      _ime_reg_io_base
#define IME_REG_ADDR(ofs)        (IOADDR_IME_REG_BASE+(ofs))
#define IME_SETREG(ofs, value)   iowrite32(value, (void*)(IOADDR_IME_REG_BASE + ofs))
#define IME_GETREG(ofs)          ioread32((void*)(IOADDR_IME_REG_BASE + ofs))
...
/*
    ...
    ime_p4_flip_en         :    [0x0, 0x1],         bits : 14
    ime_stl_flip_en        :    [0x0, 0x1],         bits : 15
...
/*
    ...
    ime_outp4_dram_out_single_en      :    [0x0, 0x1],          bits : 9
    reserved                          :    [0x0, 0x1fffff],         bits : 30_10
...
*/
#define IME_LINKED_LIST_CONTROL_REGISTER_OFS 0x0010
REGDEF_BEGIN(IME_LINKED_LIST_CONTROL_REGISTER)
REGDEF_BIT(ime_ll_terminate,        1)
REGDEF_END(IME_LINKED_LIST_CONTROL_REGISTER)
...
/*
    ...
    reserved                   :    [0x0, 0x3ffff],         bits : 28_11
...
/*
    st_hn               :    [0x0, 0x3ff],          bits : 9_0
    st_hl               :    [0x0, 0x3ff],          bits : 21_12
...
*/
#define IME_RESERVED0_OFS 0x0050
REGDEF_BEGIN(IME_RESERVED0)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED0)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED1_OFS 0x0054
REGDEF_BEGIN(IME_RESERVED1)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED1)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED2_OFS 0x0058
REGDEF_BEGIN(IME_RESERVED2)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED2)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED3_OFS 0x005c
REGDEF_BEGIN(IME_RESERVED3)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED3)
...
/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED4_OFS 0x006c
REGDEF_BEGIN(IME_RESERVED4)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED4)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED5_OFS 0x0070
REGDEF_BEGIN(IME_RESERVED5)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED5)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED6_OFS 0x0074
REGDEF_BEGIN(IME_RESERVED6)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED6)


/*
    reserved:    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED7_OFS 0x0078
REGDEF_BEGIN(IME_RESERVED7)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED7)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED8_OFS 0x00a0
REGDEF_BEGIN(IME_RESERVED8)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED8)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED9_OFS 0x00a4
REGDEF_BEGIN(IME_RESERVED9)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED9)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED10_OFS 0x00a8
REGDEF_BEGIN(IME_RESERVED10)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED10)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED11_OFS 0x00ac
REGDEF_BEGIN(IME_RESERVED11)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED11)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED12_OFS 0x0124
REGDEF_BEGIN(IME_RESERVED12)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED12)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED13_OFS 0x0128
REGDEF_BEGIN(IME_RESERVED13)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED13)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED14_OFS 0x012c
REGDEF_BEGIN(IME_RESERVED14)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED14)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED15_OFS 0x01a4
REGDEF_BEGIN(IME_RESERVED15)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED15)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED16_OFS 0x01a8
REGDEF_BEGIN(IME_RESERVED16)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED16)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED17_OFS 0x01ac
REGDEF_BEGIN(IME_RESERVED17)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED17)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED20_OFS 0x01dc
REGDEF_BEGIN(IME_RESERVED20)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED20)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED21_OFS 0x0210
REGDEF_BEGIN(IME_RESERVED21)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED21)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED22_OFS 0x0214
REGDEF_BEGIN(IME_RESERVED22)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED22)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED23_OFS 0x0218
REGDEF_BEGIN(IME_RESERVED23)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED23)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED24_OFS 0x021c
REGDEF_BEGIN(IME_RESERVED24)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED24)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED25_OFS 0x024c
REGDEF_BEGIN(IME_RESERVED25)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED25)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED26_OFS 0x0274
REGDEF_BEGIN(IME_RESERVED26)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED26)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED27_OFS 0x0278
REGDEF_BEGIN(IME_RESERVED27)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED27)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED28_OFS 0x027c
REGDEF_BEGIN(IME_RESERVED28)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED28)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED29_OFS 0x029c
REGDEF_BEGIN(IME_RESERVED29)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED29)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED30_OFS 0x02a0
REGDEF_BEGIN(IME_RESERVED30)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED30)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED31_OFS 0x02a4
REGDEF_BEGIN(IME_RESERVED31)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED31)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED32_OFS 0x02a8
REGDEF_BEGIN(IME_RESERVED32)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED32)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED33_OFS 0x02ac
REGDEF_BEGIN(IME_RESERVED33)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED33)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED34_OFS 0x02b0
REGDEF_BEGIN(IME_RESERVED34)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED34)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED35_OFS 0x02b4
REGDEF_BEGIN(IME_RESERVED35)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED35)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED36_OFS 0x02b8
REGDEF_BEGIN(IME_RESERVED36)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED36)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED37_OFS 0x02bc
REGDEF_BEGIN(IME_RESERVED37)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED37)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED38_OFS 0x0364
REGDEF_BEGIN(IME_RESERVED38)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED38)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED39_OFS 0x0368
REGDEF_BEGIN(IME_RESERVED39)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED39)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED40_OFS 0x036c
REGDEF_BEGIN(IME_RESERVED40)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED40)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED41_OFS 0x03fc
REGDEF_BEGIN(IME_RESERVED41)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED41)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED42_OFS 0x0400
REGDEF_BEGIN(IME_RESERVED42)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED42)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED43_OFS 0x0404
REGDEF_BEGIN(IME_RESERVED43)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED43)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED44_OFS 0x0408
REGDEF_BEGIN(IME_RESERVED44)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED44)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED45_OFS 0x040c
REGDEF_BEGIN(IME_RESERVED45)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED45)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED46_OFS 0x0410
REGDEF_BEGIN(IME_RESERVED46)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED46)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED47_OFS 0x0414
REGDEF_BEGIN(IME_RESERVED47)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED47)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED48_OFS 0x0418
REGDEF_BEGIN(IME_RESERVED48)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED48)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED49_OFS 0x041c
REGDEF_BEGIN(IME_RESERVED49)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED49)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED53_OFS 0x0568
REGDEF_BEGIN(IME_RESERVED53)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED53)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED54_OFS 0x056c
REGDEF_BEGIN(IME_RESERVED54)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED54)
...
/*
    ...
    IME_OUT_MD_BST_EVT   :    [0x0, 0x1],           bits : 31
*/
...
REGDEF_BIT(ime_in_3dnr_bst_mo,        1)
REGDEF_BIT(ime_out_3dnr_bst_mo,        1)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED56_OFS 0x0578
REGDEF_BEGIN(IME_RESERVED56)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED56)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED57_OFS 0x057c
REGDEF_BEGIN(IME_RESERVED57)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED57)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED58_OFS 0x0590
REGDEF_BEGIN(IME_RESERVED58)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED58)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED59_OFS 0x0594
REGDEF_BEGIN(IME_RESERVED59)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED59)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED60_OFS 0x0598
REGDEF_BEGIN(IME_RESERVED60)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED60)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED61_OFS 0x059c
REGDEF_BEGIN(IME_RESERVED61)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED61)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED62_OFS 0x05a0
REGDEF_BEGIN(IME_RESERVED62)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED62)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED63_OFS 0x05a4
REGDEF_BEGIN(IME_RESERVED63)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED63)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED64_OFS 0x05a8
REGDEF_BEGIN(IME_RESERVED64)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED64)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED65_OFS 0x05ac
REGDEF_BEGIN(IME_RESERVED65)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED65)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED66_OFS 0x05b0
REGDEF_BEGIN(IME_RESERVED66)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED66)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED67_OFS 0x05b4
REGDEF_BEGIN(IME_RESERVED67)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED67)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED68_OFS 0x05b8
REGDEF_BEGIN(IME_RESERVED68)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED68)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED69_OFS 0x05bc
REGDEF_BEGIN(IME_RESERVED69)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED69)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED70_OFS 0x05c0
REGDEF_BEGIN(IME_RESERVED70)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED70)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED71_OFS 0x05c4
REGDEF_BEGIN(IME_RESERVED71)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED71)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED72_OFS 0x05c8
REGDEF_BEGIN(IME_RESERVED72)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED72)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED73_OFS 0x05cc
REGDEF_BEGIN(IME_RESERVED73)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED73)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED74_OFS 0x05d0
REGDEF_BEGIN(IME_RESERVED74)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED74)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED75_OFS 0x05d4
REGDEF_BEGIN(IME_RESERVED75)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED75)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED76_OFS 0x05d8
REGDEF_BEGIN(IME_RESERVED76)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED76)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED77_OFS 0x05dc
REGDEF_BEGIN(IME_RESERVED77)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED77)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED78_OFS 0x05e0
REGDEF_BEGIN(IME_RESERVED78)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED78)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED79_OFS 0x05e4
REGDEF_BEGIN(IME_RESERVED79)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED79)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED80_OFS 0x05e8
REGDEF_BEGIN(IME_RESERVED80)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED80)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED81_OFS 0x05ec
REGDEF_BEGIN(IME_RESERVED81)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED81)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED82_OFS 0x05f0
REGDEF_BEGIN(IME_RESERVED82)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED82)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED83_OFS 0x05f4
REGDEF_BEGIN(IME_RESERVED83)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED83)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED84_OFS 0x05f8
REGDEF_BEGIN(IME_RESERVED84)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED84)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED85_OFS 0x05fc
REGDEF_BEGIN(IME_RESERVED85)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED85)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED86_OFS 0x0608
REGDEF_BEGIN(IME_RESERVED86)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED86)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED87_OFS 0x060c
REGDEF_BEGIN(IME_RESERVED87)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED87)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED88_OFS 0x0610
REGDEF_BEGIN(IME_RESERVED88)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED88)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED89_OFS 0x0614
REGDEF_BEGIN(IME_RESERVED89)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED89)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED90_OFS 0x0618
REGDEF_BEGIN(IME_RESERVED90)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED90)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED91_OFS 0x0654
REGDEF_BEGIN(IME_RESERVED91)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED91)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED92_OFS 0x0658
REGDEF_BEGIN(IME_RESERVED92)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED92)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED93_OFS 0x065c
REGDEF_BEGIN(IME_RESERVED93)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED93)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED94_OFS 0x068c
REGDEF_BEGIN(IME_RESERVED94)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED94)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED95_OFS 0x0690
REGDEF_BEGIN(IME_RESERVED95)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED95)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED96_OFS 0x0694
REGDEF_BEGIN(IME_RESERVED96)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED96)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED97_OFS 0x0698
REGDEF_BEGIN(IME_RESERVED97)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED97)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED98_OFS 0x069c
REGDEF_BEGIN(IME_RESERVED98)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED98)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED99_OFS 0x06dc
REGDEF_BEGIN(IME_RESERVED99)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED99)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED100_OFS 0x06e0
REGDEF_BEGIN(IME_RESERVED100)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED100)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED101_OFS 0x06e4
REGDEF_BEGIN(IME_RESERVED101)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED101)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED102_OFS 0x06e8
REGDEF_BEGIN(IME_RESERVED102)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED102)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED103_OFS 0x06ec
REGDEF_BEGIN(IME_RESERVED103)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED103)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED104_OFS 0x06f4
REGDEF_BEGIN(IME_RESERVED104)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED104)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED105_OFS 0x06f8
REGDEF_BEGIN(IME_RESERVED105)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED105)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED106_OFS 0x06fc
REGDEF_BEGIN(IME_RESERVED106)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED106)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED107_OFS 0x0700
REGDEF_BEGIN(IME_RESERVED107)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED107)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED108_OFS 0x0704
REGDEF_BEGIN(IME_RESERVED108)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED108)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED109_OFS 0x0708
REGDEF_BEGIN(IME_RESERVED109)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED109)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED110_OFS 0x070c
REGDEF_BEGIN(IME_RESERVED110)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED110)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED111_OFS 0x0714
REGDEF_BEGIN(IME_RESERVED111)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED111)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED112_OFS 0x0718
REGDEF_BEGIN(IME_RESERVED112)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED112)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED113_OFS 0x071c
REGDEF_BEGIN(IME_RESERVED113)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED113)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED114_OFS 0x0720
REGDEF_BEGIN(IME_RESERVED114)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED114)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED115_OFS 0x0724
REGDEF_BEGIN(IME_RESERVED115)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED115)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED116_OFS 0x0728
REGDEF_BEGIN(IME_RESERVED116)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED116)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED117_OFS 0x072c
REGDEF_BEGIN(IME_RESERVED117)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED117)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED118_OFS 0x0740
REGDEF_BEGIN(IME_RESERVED118)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED118)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED119_OFS 0x0744
REGDEF_BEGIN(IME_RESERVED119)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED119)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED120_OFS 0x0748
REGDEF_BEGIN(IME_RESERVED120)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED120)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED121_OFS 0x074c
REGDEF_BEGIN(IME_RESERVED121)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED121)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED122_OFS 0x0750
REGDEF_BEGIN(IME_RESERVED122)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED122)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED123_OFS 0x0754
REGDEF_BEGIN(IME_RESERVED123)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED123)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED124_OFS 0x0758
REGDEF_BEGIN(IME_RESERVED124)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED124)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED125_OFS 0x075c
REGDEF_BEGIN(IME_RESERVED125)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED125)
...
/*
    ime_3dnr_nr_residue_th_y:    [0x0, 0xff],           bits : 7_0
    ime_3dnr_nr_residue_th_c:    [0x0, 0xff],           bits : 15_8
*/
#define IME_3DNR_NR_CONTROL_REGISTER0_OFS 0x076c
REGDEF_BEGIN(IME_3DNR_NR_CONTROL_REGISTER0)
REGDEF_BIT(ime_3dnr_nr_residue_th_y,        8)
REGDEF_BIT(ime_3dnr_nr_residue_th_c,        8)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED126_OFS 0x0774
REGDEF_BEGIN(IME_RESERVED126)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED126)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED127_OFS 0x0778
REGDEF_BEGIN(IME_RESERVED127)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED127)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED128_OFS 0x077c
REGDEF_BEGIN(IME_RESERVED128)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED128)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED129_OFS 0x0780
REGDEF_BEGIN(IME_RESERVED129)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED129)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED130_OFS 0x0784
REGDEF_BEGIN(IME_RESERVED130)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED130)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED131_OFS 0x0788
REGDEF_BEGIN(IME_RESERVED131)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED131)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED132_OFS 0x078c
REGDEF_BEGIN(IME_RESERVED132)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED132)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED133_OFS 0x0798
REGDEF_BEGIN(IME_RESERVED133)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED133)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED134_OFS 0x079c
REGDEF_BEGIN(IME_RESERVED134)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED134)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED135_OFS 0x07a0
REGDEF_BEGIN(IME_RESERVED135)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED135)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED136_OFS 0x07a4
REGDEF_BEGIN(IME_RESERVED136)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED136)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED137_OFS 0x07a8
REGDEF_BEGIN(IME_RESERVED137)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED137)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED138_OFS 0x07ac
REGDEF_BEGIN(IME_RESERVED138)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED138)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED139_OFS 0x07b4
REGDEF_BEGIN(IME_RESERVED139)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED139)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED140_OFS 0x07b8
REGDEF_BEGIN(IME_RESERVED140)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED140)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED141_OFS 0x07bc
REGDEF_BEGIN(IME_RESERVED141)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED141)
...
/*
    ime_3dnr_nr_y_3d_th0:    [0x0, 0x3f],           bits : 5_0
    ime_3dnr_nr_y_3d_th1:    [0x0, 0x3f],           bits : 13_8
    ime_3dnr_nr_y_3d_th2:    [0x0, 0x3f],           bits : 21_16
    ime_3dnr_nr_y_3d_th3:    [0x0, 0x3f],           bits : 29_24
*/
#define IME_3DNR_NR_CONTROL_REGISTER11_OFS 0x07cc
REGDEF_BEGIN(IME_3DNR_NR_CONTROL_REGISTER11)
REGDEF_BIT(ime_3dnr_nr_y_3d_th0,        6)
REGDEF_BIT(,        2)
REGDEF_BIT(ime_3dnr_nr_y_3d_th1,        6)
REGDEF_BIT(,        2)
REGDEF_BIT(ime_3dnr_nr_y_3d_th2,        6)
REGDEF_BIT(,        2)
REGDEF_BIT(ime_3dnr_nr_y_3d_th3,        6)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED142_OFS 0x07e4
REGDEF_BEGIN(IME_RESERVED142)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED142)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED143_OFS 0x07e8
REGDEF_BEGIN(IME_RESERVED143)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED143)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED144_OFS 0x07ec
REGDEF_BEGIN(IME_RESERVED144)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED144)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED145_OFS 0x07f0
REGDEF_BEGIN(IME_RESERVED145)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED145)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED146_OFS 0x07f4
REGDEF_BEGIN(IME_RESERVED146)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED146)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED147_OFS 0x07f8
REGDEF_BEGIN(IME_RESERVED147)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED147)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED148_OFS 0x07fc
REGDEF_BEGIN(IME_RESERVED148)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED148)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED149_OFS 0x0850
REGDEF_BEGIN(IME_RESERVED149)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED149)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED150_OFS 0x0854
REGDEF_BEGIN(IME_RESERVED150)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED150)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED151_OFS 0x0858
REGDEF_BEGIN(IME_RESERVED151)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED151)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED152_OFS 0x085c
REGDEF_BEGIN(IME_RESERVED152)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED152)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED153_OFS 0x0860
REGDEF_BEGIN(IME_RESERVED153)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED153)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED154_OFS 0x0864
REGDEF_BEGIN(IME_RESERVED154)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED154)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED155_OFS 0x0868
REGDEF_BEGIN(IME_RESERVED155)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED155)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED156_OFS 0x086c
REGDEF_BEGIN(IME_RESERVED156)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED156)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED157_OFS 0x0870
REGDEF_BEGIN(IME_RESERVED157)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED157)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED158_OFS 0x0874
REGDEF_BEGIN(IME_RESERVED158)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED158)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED159_OFS 0x0878
REGDEF_BEGIN(IME_RESERVED159)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED159)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED160_OFS 0x087c
REGDEF_BEGIN(IME_RESERVED160)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED160)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED161_OFS 0x0880
REGDEF_BEGIN(IME_RESERVED161)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED161)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED162_OFS 0x0884
REGDEF_BEGIN(IME_RESERVED162)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED162)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED163_OFS 0x0888
REGDEF_BEGIN(IME_RESERVED163)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED163)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED164_OFS 0x088c
REGDEF_BEGIN(IME_RESERVED164)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED164)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED165_OFS 0x0890
REGDEF_BEGIN(IME_RESERVED165)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED165)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED166_OFS 0x0894
REGDEF_BEGIN(IME_RESERVED166)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED166)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED167_OFS 0x0898
REGDEF_BEGIN(IME_RESERVED167)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED167)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED168_OFS 0x089c
REGDEF_BEGIN(IME_RESERVED168)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED168)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED169_OFS 0x08a0
REGDEF_BEGIN(IME_RESERVED169)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED169)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED170_OFS 0x08a4
REGDEF_BEGIN(IME_RESERVED170)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED170)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED171_OFS 0x08a8
REGDEF_BEGIN(IME_RESERVED171)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED171)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED172_OFS 0x08ac
REGDEF_BEGIN(IME_RESERVED172)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED172)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED173_OFS 0x08b0
REGDEF_BEGIN(IME_RESERVED173)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED173)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED174_OFS 0x08b4
REGDEF_BEGIN(IME_RESERVED174)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED174)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED175_OFS 0x08b8
REGDEF_BEGIN(IME_RESERVED175)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED175)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED176_OFS 0x08bc
REGDEF_BEGIN(IME_RESERVED176)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED176)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED177_OFS 0x08c0
REGDEF_BEGIN(IME_RESERVED177)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED177)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED178_OFS 0x08c4
REGDEF_BEGIN(IME_RESERVED178)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED178)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED179_OFS 0x08c8
REGDEF_BEGIN(IME_RESERVED179)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED179)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED180_OFS 0x08cc
REGDEF_BEGIN(IME_RESERVED180)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED180)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED181_OFS 0x08d0
REGDEF_BEGIN(IME_RESERVED181)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED181)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED182_OFS 0x08d4
REGDEF_BEGIN(IME_RESERVED182)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED182)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED183_OFS 0x08d8
REGDEF_BEGIN(IME_RESERVED183)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED183)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED184_OFS 0x08dc
REGDEF_BEGIN(IME_RESERVED184)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED184)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED185_OFS 0x08e0
REGDEF_BEGIN(IME_RESERVED185)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED185)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED186_OFS 0x08e4
REGDEF_BEGIN(IME_RESERVED186)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED186)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED187_OFS 0x08e8
REGDEF_BEGIN(IME_RESERVED187)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED187)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED188_OFS 0x08ec
REGDEF_BEGIN(IME_RESERVED188)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED188)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED189_OFS 0x08f0
REGDEF_BEGIN(IME_RESERVED189)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED189)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED190_OFS 0x08f4
REGDEF_BEGIN(IME_RESERVED190)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED190)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED191_OFS 0x08f8
REGDEF_BEGIN(IME_RESERVED191)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED191)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED192_OFS 0x08fc
REGDEF_BEGIN(IME_RESERVED192)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED192)
...
/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED193_OFS 0x0908
REGDEF_BEGIN(IME_RESERVED193)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED193)


/*
    reserved                :    [0x0, 0xffffffff],         bits : 31_0
*/
#define IME_RESERVED194_OFS 0x090c
REGDEF_BEGIN(IME_RESERVED194)
REGDEF_BIT(reserved,        32)
REGDEF_END(IME_RESERVED194)
...
typedef struct {
	...
	union {
		struct {
			...
			unsigned reserved                                  : 21;      // bits : 30_10
	...
	union {
		struct {
			...
			unsigned reserved                     : 31;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_4; // 0x0010
	...
	union {
		struct {
			...
			unsigned ime_intpe_tmnr_out_enc_ovfl         : 1;      // bits : 12
			unsigned ime_intpe_3dnr_ref_in_dec_err       : 1;      // bits : 13
			unsigned reserved                           : 15;     // bits : 28_14
			unsigned ime_intpe_frm_start                 : 1;      // bits : 29
			unsigned ime_intpe_strpend                  : 1;       // bits : 30
			unsigned ime_intpe_frmend                   : 1;       // bits : 31
		} bit;
		UINT32 word;
	} reg_6; // 0x0018
	...
	union {
		struct {
			...
			unsigned ime_intps_tmnr_out_enc_ovfl         : 1;      // bits : 12
	...
	union {
		struct {
			unsigned                        : 2;
			unsigned dram_y_ofsi                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_12; // 0x0030
	...
	union {
		struct {
			unsigned                         : 2;
			unsigned dram_uv_ofsi                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_13; // 0x0034
	...
	union {
		struct {
			unsigned                        : 2;
			unsigned dram_y_sai0                      : 30;       // bits : 31_2
		} bit;
		UINT32 word;
	} reg_14; // 0x0038
	...
	union {
		struct {
			unsigned                        : 2;
			unsigned dram_u_sai0                      : 30;       // bits : 31_2
		} bit;
		UINT32 word;
	} reg_15; // 0x003c
	...
	union {
		struct {
			unsigned                        : 2;
			unsigned dram_v_sai0                      : 30;       // bits : 31_2
		} bit;
		UINT32 word;
	} reg_16; // 0x0040
	...
	union {
		struct {
			unsigned                            : 2;
			unsigned dram_ofso_p1_y0                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_35; // 0x008c
	...
	union {
		struct {
			unsigned                             : 2;
			unsigned dram_ofso_p1_uv0                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_36; // 0x0090
	...
	union {
		struct {
			unsigned dram_sao_p1_y0                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_37; // 0x0094
	...
	union {
		struct {
			unsigned dram_sao_p1_u0                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_38; // 0x0098
	...
	union {
		struct {
			unsigned dram_sao_p1_v0                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_39; // 0x009c
	...
	union {
		struct {
			unsigned                            : 2;
			unsigned dram_ofso_p2_y0                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_69; // 0x0114
	...
	union {
		struct {
			unsigned                             : 2;
			unsigned dram_ofso_p2_uv0                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_70; // 0x0118
	...
	union {
		struct {
			unsigned dram_sao_p2_y0                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_71; // 0x011c
	...
	union {
		struct {
			unsigned dram_sao_p2_uv0                      : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_72; // 0x0120
	...
	union {
		struct {
			unsigned                            : 2;
			unsigned dram_ofso_p3_y0                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_101; // 0x0194
	...
	union {
		struct {
			unsigned                             : 2;
			unsigned dram_ofso_p3_uv0                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_102; // 0x0198
	...
	union {
		struct {
			unsigned dram_sao_p3_y0                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_103; // 0x019c
	...
	union {
		struct {
			unsigned dram_sao_p3_uv0                      : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_104; // 0x01a0
	...
	union {
		struct {
			unsigned                            : 2;
			unsigned dram_ofso_p1_y1                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_241; // 0x03c4
	...
	union {
		struct {
			unsigned                             : 2;
			unsigned dram_ofso_p1_uv1                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_242; // 0x03c8
	...
	union {
		struct {
			unsigned dram_sao_p1_y1                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_243; // 0x03cc
	...
	union {
		struct {
			unsigned dram_sao_p1_uv1                      : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_244; // 0x03d0
	...
	union {
		struct {
			unsigned                            : 2;
			unsigned dram_ofso_p2_y1                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_246; // 0x03d8
	...
	union {
		struct {
			unsigned                             : 2;
			unsigned dram_ofso_p2_uv1                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_247; // 0x03dc
	...
	union {
		struct {
			unsigned dram_sao_p2_y1                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_248; // 0x03e0
	...
	union {
		struct {
			unsigned dram_sao_p2_uv1                      : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_249; // 0x03e4
	...
	union {
		struct {
			unsigned                            : 2;
			unsigned dram_ofso_p3_y1                      : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_251; // 0x03ec
	...
	union {
		struct {
			unsigned                             : 2;
			unsigned dram_ofso_p3_uv1                     : 18;       // bits : 19_2
		} bit;
		UINT32 word;
	} reg_252; // 0x03f0
	...
	union {
		struct {
			unsigned dram_sao_p3_y1                       : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_253; // 0x03f4
	...
	union {
		struct {
			unsigned dram_sao_p3_uv1                      : 32;       // bits : 31_0
		} bit;
		UINT32 word;
	} reg_254; // 0x03f8
	...
	union {
		struct {
			...
			unsigned ime_3dnr_dbg_random0                : 1;     // bits : 17
			unsigned ime_3dnr_dbg_mv0                    : 1;     // bits : 18
			unsigned ime_3dnr_nr_type                    : 1;     // bits : 19
			unsigned                                     : 8;
	...
	union {
		struct {
			unsigned ime_3dnr_me_periodic_th        : 14;     // bits : 13_0
		} bit;
		UINT32 word;
	} reg_402; // 0x0648
	...
	union {
		struct {
			unsigned ime_3dnr_nr_residue_th_y        : 8;     // bits : 7_0
			unsigned ime_3dnr_nr_residue_th_c        : 8;     // bits : 15_8
		} bit;
		UINT32 word;
	} reg_475; // 0x076c
	...
	union {
		struct {
			unsigned ime_3dnr_nr_y_3d_th0        : 6;     // bits : 5_0
			unsigned                             : 2;
			unsigned ime_3dnr_nr_y_3d_th1        : 6;     // bits : 13_8
			unsigned                             : 2;
			unsigned ime_3dnr_nr_y_3d_th2        : 6;     // bits : 21_16
			unsigned                             : 2;
			unsigned ime_3dnr_nr_y_3d_th3        : 6;     // bits : 29_24
		} bit;
		UINT32 word;
	} reg_499; // 0x07cc
