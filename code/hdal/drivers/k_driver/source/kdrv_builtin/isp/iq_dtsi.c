...
static IQ_DTSI iq_dtsi[IQ_DTSI_ITEM_MAX_NUM] = {
	...
	{"iq_pfr",                  sizeof(IQ_PFR_PARAM)           },      // 10
	{"iq_wdr",                  sizeof(IQ_WDR_PARAM)           },
	{"iq_defog",                sizeof(IQ_DEFOG_PARAM)         },
	{"iq_shdr",                 sizeof(IQ_SHDR_PARAM)          },
	{"iq_rgbir",                sizeof(IQ_RGBIR_PARAM)         },
	{"iq_companding",           sizeof(IQ_COMPANDING_PARAM)    },      // 15
	{"iq_post_3dnr",            sizeof(IQ_POST_3DNR_PARAM)     },
	...
	{"iq_shading_inter",        sizeof(IQ_SHADING_INTER_PARAM) },      // 20
	{"iq_shading_ext",          sizeof(IQ_SHADING_EXT_PARAM)   },
	{"iq_ldc",                  sizeof(IQ_LDC_PARAM)           },
	// depend on module parameter
	{"iq_edge_region",          sizeof(IQ_EDGE_REGION_PARAM)   },
	{"iq_ccm_ext",              sizeof(IQ_CCM_EXT_PARAM)       },
	{"iq_gamma_ext",            sizeof(IQ_GAMMA_EXT_PARAM)     },      // 25
	{"iq_ccm_ext2",             sizeof(IQ_CCM_EXT2_PARAM)      },
};
...
void iq_dtsi_load(UINT32 id, void *param)
{
	...
	if(nvt_get_chip_id() == CHIP_NA51084){
		iq_dtsi_sub_load(node_path, (UINT8 *)iq_param->post_3dnr, IQ_DTSI_ITEM_POST_3DNR_PARAM);
	}
	...
	// NOTE: EDGE_REGION
	iq_dtsi_sub_load(node_path, (UINT8 *)iq_param->edge_region, IQ_DTSI_ITEM_EDGE_REGION_PARAM);

	// NOTE: CCM_EXT
	iq_dtsi_sub_load(node_path, (UINT8 *)iq_param->ccm_ext, IQ_DTSI_ITEM_CCM_EXT_PARAM);

	// NOTE: GAMMA_EXT
	iq_dtsi_sub_load(node_path, (UINT8 *)iq_param->gamma_ext, IQ_DTSI_ITEM_GAMMA_EXT_PARAM);

	// NOTE: CCM_EXT2
	iq_dtsi_sub_load(node_path, (UINT8 *)iq_param->ccm_ext2, IQ_DTSI_ITEM_CCM_EXT2_PARAM);
}
