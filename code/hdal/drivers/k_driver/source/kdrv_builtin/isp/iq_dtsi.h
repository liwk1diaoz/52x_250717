...
typedef enum _IQ_DTSI_ITEM {
	...
	IQ_DTSI_ITEM_PFR_PARAM              = 10,///< data_type: [Set/Get] IQ_PFR_PARAM
	IQ_DTSI_ITEM_WDR_PARAM,                  ///< data_type: [Set/Get] IQ_WDR_PARAM
	IQ_DTSI_ITEM_DEFOG_PARAM,                ///< data_type: [Set/Get] IQ_DEFOG_PARAM
	...
	IQ_DTSI_ITEM_COMPANDING_PARAM       = 15,///< data_type: [Set/Get] IQ_COMPANDING_PARAM
	IQ_DTSI_ITEM_POST_3DNR_PARAM,            ///< data_type: [Set/Get] IQ_POST_3DNR_PARAM
	...
	IQ_DTSI_ITEM_SHADING_INTER_PARAM    = 20,///< data_type: [Set/Get] IQ_SHADING_INTER_PARAM
	IQ_DTSI_ITEM_SHADING_EXT_PARAM,          ///< data_type: [Set/Get] IQ_SHADING_EXT_PARAM
	IQ_DTSI_ITEM_LDC_PARAM,                  ///< data_type: [Set/Get] IQ_LDC_PARAM
	IQ_DTSI_ITEM_EDGE_REGION_PARAM,          ///< data_type: [Set/Get] IQ_EDGE_REGION_PARAM
	IQ_DTSI_ITEM_CCM_EXT_PARAM,              ///< data_type: [Set/Get] IQ_CCM_EXT_PARAM
	IQ_DTSI_ITEM_GAMMA_EXT_PARAM        = 25,///< data_type: [Set/Get] IQ_GAMMA_EXT_PARAM
	IQ_DTSI_ITEM_CCM_EXT2_PARAM,             ///< data_type: [Set/Get] IQ_CCM_EXT2_PARAM
