...
// version
//=============================================================================
#define AE_BUILTIN_VERSION 0x01000800
...
typedef enum _AE_STITCH_ID {
	AE_STITCH_ID_LEFT_0 = 0,
	AE_STITCH_ID_LEFT_1,
	AE_STITCH_ID_RIGHT_0,
	AE_STITCH_ID_RIGHT_1,
	AE_STITCH_ID_MASTER,
	AE_STITCH_ID_SLAVE,
	AE_STITCH_ID_MAX
} AE_STITCH_ID;
...
/**
	 AE SHDR Auto EV mode sel.
*/
typedef enum _AE_SHDR_AUTOTM_MODE {
	AUTOTM_MODE_OFF = 0,
	AUTOTM_MODE_NORMAL,
	AUTOTM_MODE_ADV,
	ENUM_DUMMY4WORD(AE_SHDR_AUTOTM_MODE)
} AE_SHDR_AUTOTM_MODE;
...
typedef struct _AE_SHDR_AUTO_TM_INFO {
	AE_SHDR_AUTOTM_MODE mode_sel;
	UINT32 threshold;
	UINT32 ev_ratio;
	UINT32 adj_ratio[AEALG_DYNAMIC_LV_NUM];
	UINT32 weight;
	UINT32 hist_lum;
} AE_SHDR_AUTO_TM_INFO;

typedef struct _AE_SHDR_HBS_INFO {
	UINT32 hbs_en;
	UINT32 hbs_weight;
...
typedef struct _AE_FLOW_INFO {
	...
	AE_SHDR_AUTO_TM_INFO shdr_auto_tm_info;
	AE_SHDR_HBS_INFO shdr_hbs_info;
	UINT32 cal_cnt;
	BOOL first_in;
	UINT32 proc_cnt;
	UINT32 compensate_ratio[ISP_SEN_MFRAME_MAX_NUM];
...
INT32 ae_alg_op_intpl(INT32 idx, INT32 value_l, INT32 value_h, INT32 idx_l, INT32 idx_h);
UINT64 ae_uint64_div(UINT64 numerator, UINT64 denominator);
