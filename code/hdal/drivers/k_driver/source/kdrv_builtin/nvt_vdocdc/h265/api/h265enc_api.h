...
extern INT32 h265Enc_getResult(H26XENC_VAR *pVar, unsigned int enc_mode, H26XEncResultCfg *pResult, UINT32 uiHwInt, UINT32 retri, H265ENC_INFO *pInfo, UINT32 bsout_buf_addr_2);
...
extern int h265Enc_setSEIBsChksumen(H26XENC_VAR *pVar, UINT32 enable);
