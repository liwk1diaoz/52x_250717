...
extern UINT32 h26xEnc_getVersion(void);
#if H26X_MEM_USAGE
...
#endif
#if H26X_AUTO_RND
extern int h26xEnc_getAutoRndCond(void);
extern int h26xEnc_setAutoRndCond(int value);
extern INT32 H26XEnc_setAutoRnd(H26XENC_VAR *pVar, UINT8 ucSliceQP);
#endif
