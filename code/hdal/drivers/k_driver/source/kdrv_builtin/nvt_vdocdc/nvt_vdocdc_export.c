...
#if H26X_AUTO_RND
EXPORT_SYMBOL(h26xEnc_getAutoRndCond);
EXPORT_SYMBOL(h26xEnc_setAutoRndCond);
#endif
...
EXPORT_SYMBOL(h264Enc_getMaxDecFrameBuf);
EXPORT_SYMBOL(h264Enc_setMaxDecFrameBuf);
#endif
#if H264_FRO_IP_SYNC
...
EXPORT_SYMBOL(h26x_enableClk);
EXPORT_SYMBOL(h26x_disableClk);
EXPORT_SYMBOL(h26x_lock);
EXPORT_SYMBOL(h26x_unlock);
