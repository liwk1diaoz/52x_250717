...
/*
    ...
    ROIPOOLING_MODE           :    [0x0, 0x1],			bits : 7
...
/*
    DRAM_SAIROI:    [0x0, 0x3fffffff],			bits : 31_2
*/
#define DMA_TO_NUE_REGISTER5_OFS 0x0020
REGDEF_BEGIN(DMA_TO_NUE_REGISTER5)
    REGDEF_BIT(           ,        2)
    REGDEF_BIT(DRAM_SAIROI,        30)
REGDEF_END(DMA_TO_NUE_REGISTER5)
...
/*
    ROIPOOL_STANDARD_WH     :    [0x0, 0x3],			bits : 1_0
    ROIPOOL_PSROI_WH        :    [0x0, 0x7],			bits : 6_4
    ROIPOOL_RATIO_MUL       :    [0x0, 0xff],			bits : 15_8
    ROIPOOL_RATIO_SHIFT     :    [0x0, 0xf],			bits : 19_16
    ROIPOOL_SHIFT_SIGNEDNESS:    [0x0, 0x1],			bits : 20
    ROIPOOL_SHIFT           :    [0x0, 0xf],			bits : 27_24
*/
#define ROIPOOLING_REGISTER0_OFS 0x005c
REGDEF_BEGIN(ROIPOOLING_REGISTER0)
    REGDEF_BIT(ROIPOOL_STANDARD_WH     ,        2)
    REGDEF_BIT(                        ,        2)
    REGDEF_BIT(ROIPOOL_PSROI_WH        ,        3)
    REGDEF_BIT(                        ,        1)
    REGDEF_BIT(ROIPOOL_RATIO_MUL       ,        8)
    REGDEF_BIT(ROIPOOL_RATIO_SHIFT     ,        4)
    REGDEF_BIT(ROIPOOL_SHIFT_SIGNEDNESS,        1)
    REGDEF_BIT(                        ,        3)
    REGDEF_BIT(ROIPOOL_SHIFT           ,        4)
REGDEF_END(ROIPOOLING_REGISTER0)
...
/*
	...
	CYCLE_EN_528      :    [0x0, 0x1],			bits : 24
    CYCLE_EN_520      :    [0x0, 0x1],			bits : 29
...
REGDEF_BEGIN(DEBUG_DESIGN_REGISTER)
	...
	REGDEF_BIT(                  ,        18)
	REGDEF_BIT(CYCLE_EN_528      ,        1)
    REGDEF_BIT(                  ,        4)
    REGDEF_BIT(CYCLE_EN_520      ,        1)
...
/*
    CLAMP_THRES0:    [0x0, 0xffff],			bits : 15_0
*/
#define CLAMP_THRESHOLD_REGISTER0_OFS 0x0194
REGDEF_BEGIN(CLAMP_THRESHOLD_REGISTER0)
    REGDEF_BIT(CLAMP_THRES0,        16)
...
*/
#define CLAMP_THRESHOLD_REGISTER1_OFS 0x0198
...
*/
#define CLAMP_COUNTER_REGISTER0_OFS 0x019c
...
*/
#define CLAMP_COUNTER_REGISTER1_OFS 0x01a0
...
/*
    CLAMP_MAX_VAL0:    [0x0, 0xffff],			bits : 15_0
*/
#define MAX_VALUE_REGISTER0_OFS 0x01a4
REGDEF_BEGIN(MAX_VALUE_REGISTER0)
    REGDEF_BIT(CLAMP_MAX_VAL0,        16)
...
*/
#define MAX_VALUE_REGISTER1_OFS 0x01a8
...
*/
#define NUE_DMA_DISABLE_REGISTER0_OFS 0x01ac
REGDEF_BEGIN(NUE_DMA_DISABLE_REGISTER0)
    REGDEF_BIT(DMA_DISABLE,        1)
	REGDEF_BIT(           ,       14)
	REGDEF_BIT(NUE_IDLE   ,        1)
REGDEF_END(NUE_DMA_DISABLE_REGISTER0)


/*
    reserved:    [0x0, 0xffffffff],			bits : 31_0
*/
#define RESERVED_REGISTER1_OFS 0x01b0
...
/*
    reserved:    [0x0, 0xffffffff],			bits : 31_0
*/
#define RESERVED_REGISTER2_OFS 0x01b4
...
/*
    reserved:    [0x0, 0xffffffff],			bits : 31_0
*/
#define RESERVED_REGISTER3_OFS 0x01b8
...
/*
    reserved:    [0x0, 0xffffffff],			bits : 31_0
*/
#define RESERVED_REGISTER4_OFS 0x01bc
...
/*
    reserved:    [0x0, 0xffffffff],			bits : 31_0
*/
#define RESERVED_REGISTER5_OFS 0x01c0
...
*/
#define NUE_LL_TERMINATE_REGISTER_OFS 0x01c8
REGDEF_BEGIN(NUE_LL_TERMINATE_REGISTER)
    REGDEF_BIT(LL_TERMINATE,        1)
REGDEF_END(NUE_LL_TERMINATE_REGISTER)

/*
    LL_BASE_ADDR
*/
#define NUE_LL_BASE_ADDR_REGISTER_OFS 0x01cc
REGDEF_BEGIN(NUE_LL_BASE_ADDR_REGISTER)
    REGDEF_BIT(LL_BASE_ADDR,        32)
REGDEF_END(NUE_LL_BASE_ADDR_REGISTER)


/*
    LL_ERR_ADDR
*/
#define NUE_LL_ERR_ADDR_REGISTER_OFS 0x01fc
REGDEF_BEGIN(NUE_LL_TERMINATE_REGISTER)
    REGDEF_BIT(LL_ERR_ADDR,        32)
REGDEF_END(NUE_LL_ERR_ADDR_REGISTER)


/*
    LL_ERR_CNT
*/
#define NUE_LL_ERR_CNT_REGISTER_OFS 0x01f8
REGDEF_BEGIN(NUE_LL_TERMINATE_REGISTER)
    REGDEF_BIT(LL_ERR_CNT,        20)
REGDEF_END(NUE_LL_ERR_CNT_REGISTER)
...
typedef struct
{
	...
	//0x01c8
	T_NUE_LL_TERMINATE_REGISTER
	NUE_Register_01c8;

	// 0x01cc
	T_NUE_LL_BASE_ADDR_REGISTER
	NUE_Register_01cc;

	//0x01f8
	T_NUE_LL_ERR_CNT_REGISTER
	NUE_Register_01f8;
	
	//0x01fc
	T_NUE_LL_ERR_ADDR_REGISTER
	NUE_Register_01fc;

} NT98520_NUE_REG_STRUCT;
