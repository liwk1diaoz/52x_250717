...
extern INT32 kdrv_affine_open(UINT32 chip, UINT32 engine);
extern INT32 kdrv_affine_close(UINT32 chip, UINT32 engine);
extern INT32 kdrv_affine_trigger(UINT32 id, KDRV_AFFINE_TRIGGER_PARAM *p_param,
