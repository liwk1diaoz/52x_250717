...
#define MAIN(argc, argv) 		EXAMFUNC_ENTRY(hd_video_record_test, argc, argv)
...
MAIN(argc, argv)
{
	...
	if (argc == 1 || argc > 8) {
		printf("Usage: <enc-type> <cap_out_bind> <cap_out_fmt> <prc_out_bind> <prc_out_fmt> <shdr> <3dnr>.\r\n");
		printf("Help:\r\n");
