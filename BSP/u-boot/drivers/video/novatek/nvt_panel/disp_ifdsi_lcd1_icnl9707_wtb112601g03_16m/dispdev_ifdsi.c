...
//#endif
	...
	DSI_PIXEL_FORMATSEL     ui_pixel_fmt          = DSI_PIXEL_RGB_888;
...
//#endif
    ...
    gpio_set_value(L_GPIO(19),1);
    //DBG_DUMP("L_GPIO(19) HIGH\r\n");
    vos_util_delay_ms(20);
    gpio_set_value(L_GPIO(19),0);
    //DBG_DUMP("L_GPIO(19) LOW\r\n");
    vos_util_delay_ms(20);
    gpio_set_value(L_GPIO(19),1);
    vos_util_delay_ms(20);
	#endif
...
//#if _FPGA_EMULATION_
	...
	if (dsi_set_config(DSI_CONFIG_ID_MODE, DSI_MODE_MANUAL_MODE) != E_OK) {
		DSI_ERR_MSG("Configure manual mode fail\r\n");
         ...
         nvt_pllen(PLL_ID_11, TRUE); //enable PLL11 for DSI HS mode
