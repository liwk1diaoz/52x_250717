/*
    ...
    @file       ICNL9707_WTB112601G03_16M.c
    @ingroup
...
#define ICNL9707_WTB112601G03_16M_WRN_MSG(...)       debug_msg(__VA_ARGS__)
...
#define _IDE_FDCLK      48000000//((((DSI_TARGET_CLK / 8) * 4)/3)) // must > ((((DSI_TARGET_CLK / 8) * 2) / 3)) ->2: lane number
#else
...
#define VVALIDST    0x12  //uiVSyncBackPorchOdd/Even
#define HSYNCT      0x04
#define VSYNCT      0x04
...
const T_PANEL_CMD t_cmd_mode_dsi[] = {
    ...
    {DSICMD_CMD,0xD2},//63 4lane  61  2lane
    {DSICMD_DATA,0x63},
    {DSICMD_DATA,0x0B},
    {DSICMD_DATA,0x08},
    {DSICMD_DATA,0x88},
...
const T_LCD_PARAM t_mode_dsi[] = {
	/***********       MI Serial Format 1      *************/
	{
		// T_PANEL_PARAM
		{
			...
			_IDE_FDCLK,                             //!< fd_clk
			PANEL_WIDTH+58+58+4,//(HVALIDST+HVALIDST+HSYNCT+PANEL_WIDTH), //!< uiHSyncTotalPeriod
			PANEL_WIDTH,                            //!< ui_hsync_active_period
			58,//HVALIDST,                               //!< uiHSyncBackPorch
			PANEL_HEIGHT+16+16+4,//(VVALIDST+VVALIDST + VSYNCT+ PANEL_HEIGHT),//!< ui_vsync_total_period
			PANEL_HEIGHT,                           //!< ui_vsync_active_period
			16,//VVALIDST,                               //!< ui_vsync_back_porch_odd
			16,//VVALIDST,                               //!< ui_vsync_back_porch_even
			...
			4,                                 //!< ui_hsync_sync_width
			4                                  //!< ui_vsync_sync_width
		},
...
void dispdev_set_dsi_config(DSI_CONFIG *p_dsi_config)
{
	...
	if (div == 0) {
		ICNL9707_WTB112601G03_16M_WRN_MSG("div = 0 force ++\r\n");
		div++;
	}
...
int panel_init(void)
{
    ...
    DBG_DUMP("Hello, panel: ICNL9707_WTB112601G03_16M_WRN_MSG\n");
    return 0;
}

void panel_exit(void)
{
    DBG_DUMP("ICNL9707_WTB112601G03_16M_WRN_MSG, Goodbye\r\n");
}
...
static int panel_init(void)
{
	...
	p_disp_obj->dev_callback = &dispdev_get_lcd1_dev_obj;
    pr_info("Hello, panel: ICNL9707_WTB112601G03_16M_WRN_MSG\n");
    return 0;
}
...
MODULE_DESCRIPTION("ICNL9707_WTB112601G03_16M_WRN_MSG Panel");
