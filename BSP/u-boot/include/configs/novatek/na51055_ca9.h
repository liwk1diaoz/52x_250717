...
/* Validate CONFIG_LINUX_SDRAM_START */
#if CONFIG_UBOOT_SDRAM_BASE < CONFIG_NVT_UIMAGE_SIZE
#error "Invalid CONFIG_LINUX_SDRAM_START"
#endif
#define CONFIG_LINUX_SDRAM_START		(CONFIG_UBOOT_SDRAM_BASE - CONFIG_NVT_UIMAGE_SIZE)
#else
/* Validate CONFIG_LINUX_SDRAM_START */
#if (CONFIG_LINUX_SDRAM_BASE + CONFIG_LINUX_SDRAM_SIZE) < CONFIG_NVT_UIMAGE_SIZE
#error "Invalid CONFIG_LINUX_SDRAM_START"
#endif
#define CONFIG_LINUX_SDRAM_START		(CONFIG_LINUX_SDRAM_BASE + CONFIG_LINUX_SDRAM_SIZE - CONFIG_NVT_UIMAGE_SIZE)
#endif
/* Validate CONFIG_NVT_RUNFW_SDRAM_BASE */
#if CONFIG_LINUX_SDRAM_START < CONFIG_NVT_ALL_IN_ONE_IMG_SIZE
#error "Invalid CONFIG_NVT_RUNFW_SDRAM_BASE"
#endif
