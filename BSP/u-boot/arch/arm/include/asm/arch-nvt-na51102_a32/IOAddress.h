...
// SDRAM Controller
#define IOADDR_DRAM_REG_BASE        (IOADDR_GLOBAL_BASE+0x000D0000)
...
// ---------------------------------------------
// SDRAM Controller 2
#define IOADDR_DRAM2_REG_BASE       (IOADDR_GLOBAL_BASE+0x000D0000)
...
// ADC
#define IOADDR_ADC_REG_BASE         (IOADDR_GLOBAL_BASE+0x002A0000)
...
// SPI5
#define IOADDR_SPI5_REG_BASE        (IOADDR_GLOBAL_BASE+0x003D0000)
...
// I2C6
#define IOADDR_I2C6_REG_BASE        (IOADDR_GLOBAL_BASE+0x00200000)

// I2C7
#define IOADDR_I2C7_REG_BASE        (IOADDR_GLOBAL_BASE+0x002C0000)
...
// USB
#define IOADDR_USB_REG_BASE         (IOADDR_GLOBAL_BASE+0x00570000)
...
// Hash
#define IOADDR_HASH_REG_BASE        (IOADDR_GLOBAL_BASE+0x00670000)
