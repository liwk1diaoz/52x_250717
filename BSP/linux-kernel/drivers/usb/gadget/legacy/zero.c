...
module_param_named(int_interval, gzero_options.int_interval, uint, S_IRUGO|S_IWUSR);
MODULE_PARM_DESC(int_interval, "1 - 16");

module_param_named(int_maxpacket, gzero_options.int_maxpacket, uint, S_IRUGO|S_IWUSR);
...
module_param_named(int_maxburst, gzero_options.int_maxburst, uint, S_IRUGO|S_IWUSR);
...
static int zero_bind(struct usb_composite_dev *cdev)
{
	...
	ss_opts->int_maxburst = gzero_options.int_maxpacket;
