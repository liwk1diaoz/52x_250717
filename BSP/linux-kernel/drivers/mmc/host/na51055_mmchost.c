...
{
	if (host->id == SDIO_HOST_ID_1) {
		pad_set_pull_updown(PAD_PIN_CGPIO11, PAD_PULLDOWN);
		...
		{
			pad_set_pull_updown(PAD_PIN_SGPIO0, PAD_PULLDOWN);
		...
		{
			pad_set_pull_updown(PAD_PIN_DSIGPIO7, PAD_PULLDOWN);
