...
MODEL_BUILD_LIST=(
		"lunch rtos cfg_CARDV_1G_EVB gcc-6.5-newlib-2.4-2019.11-arm-ca9-eabihf"
		"lunch Linux cfg_CARDV_1G_EVB arm-ca9-linux-uclibcgnueabihf-6.5"
		"lunch Linux cfg_CARDV_ETHCAM_RX_EVB arm-ca9-linux-uclibcgnueabihf-6.5"
)
