...
MODEL_BUILD_LIST=(
		"lunch Linux cfg_IPCAM1_RAMDISK_KASAN_EVB arm-ca9-linux-gnueabihf-6.5"
		"lunch rtos cfg_RTOS_BOOT_LINUX_AI_EVB gcc-6.5-newlib-2.4-2019.11-arm-ca9-eabihf"
		"lunch Linux cfg_RTOS_BOOT_LINUX_AI_EVB arm-ca9-linux-uclibcgnueabihf-6.5"
)
