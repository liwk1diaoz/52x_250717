...
MODEL_BUILD_LIST=(
		...
		"lunch rtos cfg_RTOS_BOOT_LINUX_AI_NOR_EVB gcc-6.5-newlib-2.4-2019.11-arm-ca9-eabihf"
		"lunch Linux cfg_RTOS_BOOT_LINUX_AI_NOR_EVB arm-ca9-linux-uclibcgnueabihf-6.5"
)
